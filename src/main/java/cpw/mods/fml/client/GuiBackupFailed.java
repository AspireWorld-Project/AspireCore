...
public class GuiBackupFailed extends GuiScreen {
	...
	public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
		...
		drawCenteredString(fontRendererObj,
				String.format("There was an error saving the archive %s", zipName.getName()), width / 2, offset,
				0xFFFFFF);
		offset += 10;
		drawCenteredString(fontRendererObj, String.format("Please fix the problem and try again"), width / 2, offset,
				0xFFFFFF);
