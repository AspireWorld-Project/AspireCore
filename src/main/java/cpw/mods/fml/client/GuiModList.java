...
public class GuiModList extends GuiScreen {
	...
	public void initGui() {
		...
		configModButton = new GuiButton(20, 10, height - 60, listWidth, 20, "Config");
		disableModButton = new GuiButton(21, 10, height - 38, listWidth, 20, "Disable");
	...
	public void drawScreen(int p_571_1_, int p_571_2_, float p_571_3_) {
		...
		if (selectedMod != null) {
			...
			if (!selectedMod.getMetadata().autogenerated) {
				...
				if (!logoFile.isEmpty()) {
					...
					try {
						...
						if (cachedLogo != null) {
							...
							tess.addVertexWithUV(offset + cachedLogoDimensions.width, top + cachedLogoDimensions.height,
									zLevel, 1, 1);
				...
				shifty = drawLine(
						String.format("Version: %s (%s)", selectedMod.getDisplayVersion(), selectedMod.getVersion()),
						offset, shifty);
				...
				if (rightSide > 20) {
					getFontRenderer().drawSplitString(selectedMod.getMetadata().description, offset, shifty + 10,
							rightSide, 0xDDDDDD);
				}
				...
				drawCenteredString(fontRendererObj, String.format("Version: %s", selectedMod.getVersion()), offset, 45,
						0xFFFFFF);
				...
				drawCenteredString(fontRendererObj, "Ask your mod author to provide a mod mcmod.info file", offset, 75,
						0xDDDDDD);
