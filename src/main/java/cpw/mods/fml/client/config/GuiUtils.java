...
/**
 * This class provides several methods and constants used by the Config GUI
 * classes.
 *
 * @author bspkrs
 */
public class GuiUtils {
	...
	private static final int[] colorCodes = new int[] { 0, 170, 43520, 43690, 11141120, 11141290, 16755200, 11184810, 5592405,
	...
	public static void drawContinuousTexturedBox(int x, int y, int u, int v, int width, int height, int textureWidth,
		...
		drawContinuousTexturedBox(x, y, u, v, width, height, textureWidth, textureHeight, borderSize, borderSize,
				borderSize, borderSize, zLevel);
	}
	...
	public static void drawContinuousTexturedBox(ResourceLocation res, int x, int y, int u, int v, int width,
		...
		drawContinuousTexturedBox(res, x, y, u, v, width, height, textureWidth, textureHeight, borderSize, borderSize,
				borderSize, borderSize, zLevel);
	}
