...
public class RenderingRegistry {
	...
	/**
	 * Register an entity rendering handler. This will, after mod initialization, be
	 * inserted into the main render map for entities
	 *
	 * @param entityClass
	 * @param renderer
	 */
	 ...
	 * getRenderId on the passed in handler, instead using the supplied ID, so you
