...
/**
 * Classes annotated with this will have the named interface or method removed
 * from the runtime definition of the class if the modid specified is missing.
 *
 * @author cpw
 *
 */
public final class Optional {
	...
	public @interface Interface {
		 ...
		 * synthetic methods from scala f.e.)
		 *
