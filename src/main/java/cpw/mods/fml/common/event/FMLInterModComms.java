...
public class FMLInterModComms {
	...
	public static class IMCEvent extends FMLEvent {
		...
		public void applyModContainer(ModContainer activeContainer) {
			...
			currentList = null;
			FMLLog.finer("Attempting to deliver %d IMC messages to mod %s",
					modMessages.get(activeContainer.getModId()).size(), activeContainer.getModId());
		}
	...
	public static final class IMCMessage {
		...
		void setSender(ModContainer activeModContainer) {
			sender = activeModContainer.getModId();
		}
	 ...
	 *
	 * @param forMod
	 *            The {@link Instance} of the Mod to fetch messages for
