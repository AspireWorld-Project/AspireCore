...
public class ASMEventHandler implements IEventListener {
	...
	public Class<?> createWrapper(Method callback) {
		...
		/*
		 * System.out.println("Name:     " + name); System.out.println("Desc:     " +
		 * desc); System.out.println("InstType: " + instType);
	...
	private String getUniqueName(Method callback) {
		return String.format("%s_%d_%s_%s_%s", getClass().getName(), IDs++,
				callback.getDeclaringClass().getSimpleName(), callback.getName(),
