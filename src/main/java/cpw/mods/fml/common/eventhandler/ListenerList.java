...
public class ListenerList {
	...
	private class ListenerListInst {
		...
		/**
		 * Returns a ArrayList containing all listeners for this event, and all parent
		 * events for the specified priority.
		 *
		...
		/**
		 * Returns a full list of all listeners for all priority levels. Including all
		 * parent listeners.
		 *
		 * List is returned in proper priority order.
		 *
		 * Automatically rebuilds the internal Array cache if its information is out of
		 * date.
		 *
		...
		/**
		 * Rebuild the local Array of listeners, returns early if there is no work to
		 * do.
		 */
