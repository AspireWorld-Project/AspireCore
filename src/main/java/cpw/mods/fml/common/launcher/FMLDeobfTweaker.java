...
public class FMLDeobfTweaker implements ITweaker {
	...
	public void injectIntoClassLoader(LaunchClassLoader classLoader) {
		// Deobfuscation transformer, always last, and the access transformer tweaker as
		// well
		...
		try {
			...
			// Load in the Loader, make sure he's ready to roll - this will initialize most
			// of the rest of minecraft here
			System.out.println(
