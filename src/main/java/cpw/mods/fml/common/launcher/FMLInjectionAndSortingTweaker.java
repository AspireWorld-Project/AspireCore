...
/**
 * This class is to manage the injection of coremods as tweakers into the tweak
 * framework. It has to inject the coremod tweaks during construction, because
 * that is the only time the tweak list is writeable.
 *
 * @author cpw
 *
 */
