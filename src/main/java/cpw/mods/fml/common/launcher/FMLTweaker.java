...
public class FMLTweaker implements ITweaker {
	...
	public FMLTweaker() {
		System.setProperty("java.net.preferIPv4Stack", "true"); // Lets do this as early as possible. Vanilla does it in
																// Main.main
		try {
	...
	public void acceptOptions(List<String> args, File gameDir, File assetsDir, String profile) {
		...
		standaloneArgs = Lists.newArrayList();
		if (launchArgs == null) {
		...
		if (!launchArgs.containsKey("--assetsDir") && assetsDir != null) {
