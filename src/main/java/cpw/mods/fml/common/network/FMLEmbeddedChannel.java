 ...
 * methods associated with the specific needs of FML network handling.
 *
 * @author cpw
 *
 */
public class FMLEmbeddedChannel extends EmbeddedChannel {
	...
	/**
	 * Utility method to generate a regular packet from a custom packet. Basically,
	 * it writes the packet through the outbound side which should have a message to
	 * message codec present (such as {@link FMLIndexedMessageToMessageCodec},
	 * transforming from mod packets to standard {@link FMLProxyPacket}s.
	 *
	 * This is mostly useful in cases where vanilla expects a packet, such as the
