...
public class FMLOutboundHandler extends ChannelOutboundHandlerAdapter {
	...
	public enum OutboundTarget {
		/**
		 * The packet is sent nowhere. It will be on the
		 * {@link EmbeddedChannel#outboundMessages()} Queue.
		 *
		 * @author cpw
		 *
		 */
		...
		/**
		 * The packet is sent to the originator of the packet. This requires the inbound
		 * packet to have it's originator information set.
		 *
		 * @author cpw
		 *
		 */
		...
		/**
		 * The packet is sent to all players in the dimension identified by the integer
		 * argument.
		 *
		 * @author cpw
		 *
		...
		/**
		 * The packet is sent to all players within range of the {@link TargetPoint}
		 * argument supplied.
		 *
		 * @author cpw
		 *
