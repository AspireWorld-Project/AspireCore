...
class ItemStackHolderRef {
	...
	private static void makeWritable(Field f) {
		try {
			if (modifiersField == null) {
				...
				fieldAccessorSet = Class.forName("sun.reflect.FieldAccessor").getDeclaredMethod("set", Object.class,
						Object.class);
	...
	public void apply() {
		...
		try {
			...
			FMLLog.getLogger().log(Level.ERROR, "Caught exception processing itemstack {},{},{} in annotation at {}.{}",
					itemName, meta, serializednbt, field.getClass().getName(), field.getName());
			throw e;
		}
		try {
			...
			FMLLog.getLogger().log(Level.WARN, "Unable to set {} with value {},{},{}", field, itemName, meta,
					serializednbt);
		}
	}
}