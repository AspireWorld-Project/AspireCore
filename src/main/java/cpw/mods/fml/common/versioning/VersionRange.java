...
public class VersionRange {
	 ...
	 *
	 * @param restriction
	 *            the <code>VersionRange</code> that will be used to restrict this
	 *            version range.
	...
	public VersionRange restrict(VersionRange restriction) {
		List<Restriction> r1 = restrictions;
	...
	public boolean isUnboundedAbove() {
		return restrictions.size() == 1 && restrictions.get(0).getUpperBound() == null
				&& !restrictions.get(0).isUpperBoundInclusive();
	}
