...
public class BlockCactus extends Block implements IPlantable {
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
		if (p_149674_1_.isAirBlock(p_149674_2_, p_149674_3_ + 1, p_149674_4_)) {
			...
			if (l < 3) {
				...
				if (i1 == 15) {
					CraftEventFactory.handleBlockGrowEvent(p_149674_1_, p_149674_2_, p_149674_3_ + 1, p_149674_4_, this,
							0);
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World p_149668_1_, int p_149668_2_, int p_149668_3_,
			int p_149668_4_) {
		float f = 0.0625F;
		return AxisAlignedBB.getBoundingBox(p_149668_2_ + f, p_149668_3_, p_149668_4_ + f, p_149668_2_ + 1 - f,
				p_149668_3_ + 1 - f, p_149668_4_ + 1 - f);
	}
	...
	public AxisAlignedBB getSelectedBoundingBoxFromPool(World p_149633_1_, int p_149633_2_, int p_149633_3_,
			int p_149633_4_) {
		float f = 0.0625F;
		return AxisAlignedBB.getBoundingBox(p_149633_2_ + f, p_149633_3_, p_149633_4_ + f, p_149633_2_ + 1 - f,
				p_149633_3_ + 1, p_149633_4_ + 1 - f);
	}

	@Override
	@SideOnly(Side.CLIENT)
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return p_149691_1_ == 1 ? field_150041_a : p_149691_1_ == 0 ? field_150040_b : blockIcon;
	}
	...
	public boolean canBlockStay(World p_149718_1_, int p_149718_2_, int p_149718_3_, int p_149718_4_) {
		if (p_149718_1_.getBlock(p_149718_2_ - 1, p_149718_3_, p_149718_4_).getMaterial().isSolid())
			...
			return block.canSustainPlant(p_149718_1_, p_149718_2_, p_149718_3_ - 1, p_149718_4_, ForgeDirection.UP,
					this);
		}
	}
