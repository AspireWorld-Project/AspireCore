...
public class BlockDoublePlant extends BlockBush implements IGrowable, IShearable {
	...
	public boolean canBlockStay(World p_149718_1_, int p_149718_2_, int p_149718_3_, int p_149718_4_) {
		if (p_149718_1_.getBlock(p_149718_2_, p_149718_3_, p_149718_4_) != this)
			return super.canBlockStay(p_149718_1_, p_149718_2_, p_149718_3_, p_149718_4_); // Forge: This function is
																							// called during world gen
																							// and placement, before
																							// this block is set, so if
																							// we are not 'here' then
																							// assume it's the
																							// pre-check.
		int l = p_149718_1_.getBlockMetadata(p_149718_2_, p_149718_3_, p_149718_4_);
		return func_149887_c(l) ? p_149718_1_.getBlock(p_149718_2_, p_149718_3_ - 1, p_149718_4_) == this
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return func_149887_c(p_149691_2_) ? doublePlantBottomIcons[0] : doublePlantBottomIcons[p_149691_2_ & 7];
	}

	@SideOnly(Side.CLIENT)
	public IIcon func_149888_a(boolean p_149888_1_, int p_149888_2_) {
		return p_149888_1_ ? doublePlantTopIcons[p_149888_2_] : doublePlantBottomIcons[p_149888_2_];
	}

	@Override
	@SideOnly(Side.CLIENT)
	public int colorMultiplier(IBlockAccess p_149720_1_, int p_149720_2_, int p_149720_3_, int p_149720_4_) {
		int l = func_149885_e(p_149720_1_, p_149720_2_, p_149720_3_, p_149720_4_);
		return l != 2 && l != 3 ? 16777215
	...
	public void harvestBlock(World p_149636_1_, EntityPlayer p_149636_2_, int p_149636_3_, int p_149636_4_,
		...
		if (p_149636_1_.isRemote || p_149636_2_.getCurrentEquippedItem() == null
				|| p_149636_2_.getCurrentEquippedItem().getItem() != Items.shears || func_149887_c(p_149636_6_)
				|| !func_149886_b(p_149636_1_, p_149636_3_, p_149636_4_, p_149636_5_, p_149636_6_, p_149636_2_)) {
			...
			if (p_149681_1_.getBlock(p_149681_2_, p_149681_3_ - 1, p_149681_4_) == this) {
				if (!p_149681_6_.capabilities.isCreativeMode) {
					...
					if (j1 != 3 && j1 != 2) {
						...
						if (!p_149681_1_.isRemote && p_149681_6_.getCurrentEquippedItem() != null
								&& p_149681_6_.getCurrentEquippedItem().getItem() == Items.shears) {
							func_149886_b(p_149681_1_, p_149681_2_, p_149681_3_, p_149681_4_, i1, p_149681_6_);
						}
	...
	private boolean func_149886_b(World p_149886_1_, int p_149886_2_, int p_149886_3_, int p_149886_4_, int p_149886_5_,
		...
		if (i1 != 3 && i1 != 2)
			...
			this.dropBlockAsItem(p_149886_1_, p_149886_2_, p_149886_3_, p_149886_4_,
					new ItemStack(Blocks.tallgrass, 2, b0));
			return true;
		}
	}
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		doublePlantBottomIcons = new IIcon[field_149892_a.length];
		doublePlantTopIcons = new IIcon[field_149892_a.length];

		for (int i = 0; i < doublePlantBottomIcons.length; ++i) {
			doublePlantBottomIcons[i] = p_149651_1_.registerIcon("double_plant_" + field_149892_a[i] + "_bottom");
			doublePlantTopIcons[i] = p_149651_1_.registerIcon("double_plant_" + field_149892_a[i] + "_top");
		}

		sunflowerIcons = new IIcon[2];
		sunflowerIcons[0] = p_149651_1_.registerIcon("double_plant_sunflower_front");
	...
	public int getDamageValue(World p_149643_1_, int p_149643_2_, int p_149643_3_, int p_149643_4_) {
		...
		return func_149887_c(l) ? func_149890_d(p_149643_1_.getBlockMetadata(p_149643_2_, p_149643_3_ - 1, p_149643_4_))
				: func_149890_d(l);
	}
	...
	public boolean func_149851_a(World p_149851_1_, int p_149851_2_, int p_149851_3_, int p_149851_4_,
			boolean p_149851_5_) {
		int l = func_149885_e(p_149851_1_, p_149851_2_, p_149851_3_, p_149851_4_);
		return l != 2 && l != 3;
	}
	...
	public void func_149853_b(World p_149853_1_, Random p_149853_2_, int p_149853_3_, int p_149853_4_,
			int p_149853_5_) {
		int l = func_149885_e(p_149853_1_, p_149853_3_, p_149853_4_, p_149853_5_);
