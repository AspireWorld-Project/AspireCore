...
public class BlockFire extends Block {
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
		if (p_149674_1_.getGameRules().getGameRuleBooleanValue("doFireTick")) {
			boolean flag = p_149674_1_.getBlock(p_149674_2_, p_149674_3_ - 1, p_149674_4_).isFireSource(p_149674_1_,
					p_149674_2_, p_149674_3_ - 1, p_149674_4_, ForgeDirection.UP);
				...
				if (!flag && !canNeighborBurn(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_)) {
					if (!World.doesBlockHaveSolidTopSurface(p_149674_1_, p_149674_2_, p_149674_3_ - 1, p_149674_4_)
						...
						if (!CraftEventFactory.callBlockFadeEvent(
								p_149674_1_.getWorld().getBlockAt(p_149674_2_, p_149674_3_, p_149674_4_), Blocks.air)
								.isCancelled()) {
							p_149674_1_.setBlockToAir(p_149674_2_, p_149674_3_, p_149674_4_);
						}
				} else if (!flag
						&& !canCatchFire(p_149674_1_, p_149674_2_, p_149674_3_ - 1, p_149674_4_, ForgeDirection.UP)
						&& l == 15 && p_149674_5_.nextInt(4) == 0) {
					if (!CraftEventFactory.callBlockFadeEvent(
							p_149674_1_.getWorld().getBlockAt(p_149674_2_, p_149674_3_, p_149674_4_), Blocks.air)
							.isCancelled()) {
						p_149674_1_.setBlockToAir(p_149674_2_, p_149674_3_, p_149674_4_);
									...
									if (i2 > 0) {
										...
										if (j2 > 0 && p_149674_5_.nextInt(l1) <= j2
												&& (!p_149674_1_.isRaining()
														|| !p_149674_1_.canLightningStrikeAt(i1, k1, j1))
												&& !p_149674_1_.canLightningStrikeAt(i1 - 1, k1, p_149674_4_)
												&& !p_149674_1_.canLightningStrikeAt(i1 + 1, k1, j1)
											...
											if (p_149674_1_.getBlock(i1, k1, j1) != Blocks.fire) {
												if (CraftEventFactory.callBlockIgniteEvent(p_149674_1_, i1, k1, j1,
														p_149674_2_, p_149674_3_, p_149674_4_).isCancelled()) {
													continue;
												}
												org.bukkit.Server server = p_149674_1_.getServer();
												org.bukkit.World bworld = p_149674_1_.getWorld();
												org.bukkit.block.BlockState blockState = bworld.getBlockAt(i1, k1, j1)
														.getState();
												blockState.setTypeId(Block.getIdFromBlock(this));
												blockState.setData(new org.bukkit.material.MaterialData(
														Block.getIdFromBlock(this), (byte) k2));
												BlockSpreadEvent spreadEvent = new BlockSpreadEvent(
														blockState.getBlock(),
														bworld.getBlockAt(p_149674_2_, p_149674_3_, p_149674_4_),
														blockState);
												server.getPluginManager().callEvent(spreadEvent);
												if (!spreadEvent.isCancelled()) {
													p_149674_1_.setBlock(i1, k1, j1,
															((org.bukkit.craftbukkit.block.CraftBlock) blockState
																	.getBlock()).getNMSBlock(),
															blockState.getRawData(), 3); // KCauldron - DragonAPI uses
																							// this call
	...
	private void tryCatchFire(World p_149841_1_, int p_149841_2_, int p_149841_3_, int p_149841_4_, int p_149841_5_,
		...
		this.tryCatchFire(p_149841_1_, p_149841_2_, p_149841_3_, p_149841_4_, p_149841_5_, p_149841_6_, p_149841_7_,
				UP);
	}

	private void tryCatchFire(World p_149841_1_, int p_149841_2_, int p_149841_3_, int p_149841_4_, int p_149841_5_,
			Random p_149841_6_, int p_149841_7_, ForgeDirection face) {
		int j1 = p_149841_1_.getBlock(p_149841_2_, p_149841_3_, p_149841_4_).getFlammability(p_149841_1_, p_149841_2_,
	...
	private boolean canNeighborBurn(World p_149847_1_, int p_149847_2_, int p_149847_3_, int p_149847_4_) {
		return canCatchFire(p_149847_1_, p_149847_2_ + 1, p_149847_3_, p_149847_4_, WEST)
				|| canCatchFire(p_149847_1_, p_149847_2_ - 1, p_149847_3_, p_149847_4_, EAST)
				|| canCatchFire(p_149847_1_, p_149847_2_, p_149847_3_ - 1, p_149847_4_, UP)
				|| canCatchFire(p_149847_1_, p_149847_2_, p_149847_3_ + 1, p_149847_4_, DOWN)
				|| canCatchFire(p_149847_1_, p_149847_2_, p_149847_3_, p_149847_4_ - 1, SOUTH)
				|| canCatchFire(p_149847_1_, p_149847_2_, p_149847_3_, p_149847_4_ + 1, NORTH);
	}

	private int getChanceOfNeighborsEncouragingFire(World p_149845_1_, int p_149845_2_, int p_149845_3_,
			int p_149845_4_) {
		byte b0 = 0;
		...
		if (!p_149845_1_.isAirBlock(p_149845_2_, p_149845_3_, p_149845_4_))
			...
			int l = b0;
			l = getChanceToEncourageFire(p_149845_1_, p_149845_2_ + 1, p_149845_3_, p_149845_4_, l, WEST);
			l = getChanceToEncourageFire(p_149845_1_, p_149845_2_ - 1, p_149845_3_, p_149845_4_, l, EAST);
			l = getChanceToEncourageFire(p_149845_1_, p_149845_2_, p_149845_3_ - 1, p_149845_4_, l, UP);
			l = getChanceToEncourageFire(p_149845_1_, p_149845_2_, p_149845_3_ + 1, p_149845_4_, l, DOWN);
			l = getChanceToEncourageFire(p_149845_1_, p_149845_2_, p_149845_3_, p_149845_4_ - 1, l, SOUTH);
			l = getChanceToEncourageFire(p_149845_1_, p_149845_2_, p_149845_3_, p_149845_4_ + 1, l, NORTH);
			return l;
		}
	}
	...
	public boolean canPlaceBlockAt(World p_149742_1_, int p_149742_2_, int p_149742_3_, int p_149742_4_) {
		return World.doesBlockHaveSolidTopSurface(p_149742_1_, p_149742_2_, p_149742_3_ - 1, p_149742_4_)
				|| canNeighborBurn(p_149742_1_, p_149742_2_, p_149742_3_, p_149742_4_);
	}
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_,
		...
		if (!World.doesBlockHaveSolidTopSurface(p_149695_1_, p_149695_2_, p_149695_3_ - 1, p_149695_4_)
				&& !canNeighborBurn(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_)) {
			if (!CraftEventFactory
					.callBlockFadeEvent(p_149695_1_.getWorld().getBlockAt(p_149695_2_, p_149695_3_, p_149695_4_),
							Blocks.air)
					.isCancelled()) {
	...
	public void onBlockAdded(World p_149726_1_, int p_149726_2_, int p_149726_3_, int p_149726_4_) {
		if (!Blocks.portal.func_150000_e(p_149726_1_, p_149726_2_, p_149726_3_, p_149726_4_)) {
			if (!World.doesBlockHaveSolidTopSurface(p_149726_1_, p_149726_2_, p_149726_3_ - 1, p_149726_4_)
					&& !canNeighborBurn(p_149726_1_, p_149726_2_, p_149726_3_, p_149726_4_)) {
				if (!CraftEventFactory
						.callBlockFadeEvent(p_149726_1_.getWorld().getBlockAt(p_149726_2_, p_149726_3_, p_149726_4_),
								Blocks.air)
						.isCancelled()) {
				...
				p_149726_1_.scheduleBlockUpdate(p_149726_2_, p_149726_3_, p_149726_4_, this,
						tickRate(p_149726_1_) + p_149726_1_.rand.nextInt(10));
			}
		}
	}
	...
	public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_,
		...
		if (p_149734_5_.nextInt(24) == 0) {
			p_149734_1_.playSound(p_149734_2_ + 0.5F, p_149734_3_ + 0.5F, p_149734_4_ + 0.5F, "fire.fire",
					1.0F + p_149734_5_.nextFloat(), p_149734_5_.nextFloat() * 0.7F + 0.3F, false);
		}
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		field_149850_M = new IIcon[] { p_149651_1_.registerIcon(getTextureName() + "_layer_0"),
	...
	public void setFireInfo(Block block, int encouragement, int flammibility) {
		...
		field_149849_a[id] = encouragement;
		field_149848_b[id] = flammibility;
	...
	public void rebuildFireInfo() {
		for (int x = 0; x < 4096; x++) {
			// If we care.. we could detect changes in here and make sure we keep them,
			// however
			// it's my thinking that anyone who hacks into the private variables should DIAF
