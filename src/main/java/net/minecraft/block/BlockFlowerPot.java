...
public class BlockFlowerPot extends BlockContainer {
	...
	public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_,
		...
		if (itemstack != null && itemstack.getItem() instanceof ItemBlock) {
			TileEntityFlowerPot tileentityflowerpot = func_149929_e(p_149727_1_, p_149727_2_, p_149727_3_, p_149727_4_);
			...
			if (tileentityflowerpot != null) {
				if (tileentityflowerpot.getFlowerPotItem() != null)
					...
					if (!func_149928_a(block, itemstack.getItemDamage()))
						return false;
					else {
	...
	private boolean func_149928_a(Block p_149928_1_, int p_149928_2_) {
		return p_149928_1_ == Blocks.yellow_flower || p_149928_1_ == Blocks.red_flower || p_149928_1_ == Blocks.cactus
				...
				|| p_149928_1_ == Blocks.sapling || p_149928_1_ == Blocks.deadbush || p_149928_1_ == Blocks.tallgrass && p_149928_2_ == 2;
	}

	@Override
	@SideOnly(Side.CLIENT)
	public Item getItem(World p_149694_1_, int p_149694_2_, int p_149694_3_, int p_149694_4_) {
		TileEntityFlowerPot tileentityflowerpot = func_149929_e(p_149694_1_, p_149694_2_, p_149694_3_, p_149694_4_);
	...
	public int getDamageValue(World p_149643_1_, int p_149643_2_, int p_149643_3_, int p_149643_4_) {
		TileEntityFlowerPot tileentityflowerpot = func_149929_e(p_149643_1_, p_149643_2_, p_149643_3_, p_149643_4_);
		return tileentityflowerpot != null && tileentityflowerpot.getFlowerPotItem() != null
	...
	public void onBlockHarvested(World p_149681_1_, int p_149681_2_, int p_149681_3_, int p_149681_4_, int p_149681_5_,
		...
		if (p_149681_6_.capabilities.isCreativeMode) {
			TileEntityFlowerPot tileentityflowerpot = func_149929_e(p_149681_1_, p_149681_2_, p_149681_3_, p_149681_4_);
	...
	public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune) {
		...
		TileEntityFlowerPot te = func_149929_e(world, x, y, z);
