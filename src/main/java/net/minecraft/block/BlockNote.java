...
public class BlockNote extends BlockContainer {
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_,
		...
		TileEntityNote tileentitynote = (TileEntityNote) p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_,
				p_149695_4_);
	...
	public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_,
		...
		if (p_149727_1_.isRemote)
			...
			TileEntityNote tileentitynote = (TileEntityNote) p_149727_1_.getTileEntity(p_149727_2_, p_149727_3_,
					p_149727_4_);
	...
	public void onBlockClicked(World p_149699_1_, int p_149699_2_, int p_149699_3_, int p_149699_4_,
		...
		if (!p_149699_1_.isRemote) {
			TileEntityNote tileentitynote = (TileEntityNote) p_149699_1_.getTileEntity(p_149699_2_, p_149699_3_,
					p_149699_4_);
	...
	public boolean onBlockEventReceived(World p_149696_1_, int p_149696_2_, int p_149696_3_, int p_149696_4_,
		...
		net.minecraftforge.event.world.NoteBlockEvent.Play e = new net.minecraftforge.event.world.NoteBlockEvent.Play(
				p_149696_1_, p_149696_2_, p_149696_3_, p_149696_4_, meta, p_149696_6_, p_149696_5_);
		...
		float f = (float) Math.pow(2.0D, (p_149696_6_ - 12) / 12.0D);
		String s = "harp";
		...
		p_149696_1_.playSoundEffect(p_149696_2_ + 0.5D, p_149696_3_ + 0.5D, p_149696_4_ + 0.5D, "note." + s, 3.0F, f);
		p_149696_1_.spawnParticle("note", p_149696_2_ + 0.5D, p_149696_3_ + 1.2D, p_149696_4_ + 0.5D,
				p_149696_6_ / 24.0D, 0.0D, 0.0D);
		return true;
	}
}