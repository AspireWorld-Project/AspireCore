...
public abstract class BlockRedstoneDiode extends BlockDirectional {
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
		...
		if (!func_149910_g(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_, l)) {
			boolean flag = isGettingInput(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_, l);

			if (isRepeaterPowered && !flag) {
				p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, getBlockUnpowered(), l, 2);
			} else if (!isRepeaterPowered) {
				p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, getBlockPowered(), l, 2);

				if (!flag) {
					p_149674_1_.scheduleBlockUpdateWithPriority(p_149674_2_, p_149674_3_, p_149674_4_,
							getBlockPowered(), func_149899_k(l), -1);
				}
			}
		}
	}
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return p_149691_1_ == 0
				? isRepeaterPowered ? Blocks.redstone_torch.getBlockTextureFromSide(p_149691_1_)
						: Blocks.unlit_redstone_torch.getBlockTextureFromSide(p_149691_1_)
				: p_149691_1_ == 1 ? blockIcon : Blocks.double_stone_slab.getBlockTextureFromSide(1);
	}
	...
	public int isProvidingWeakPower(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_,
		...
		if (!func_149905_c(i1))
			...
			return j1 == 0 && p_149709_5_ == 3 ? func_149904_f(p_149709_1_, p_149709_2_, p_149709_3_, p_149709_4_, i1)
					: j1 == 1 && p_149709_5_ == 4
							? func_149904_f(p_149709_1_, p_149709_2_, p_149709_3_, p_149709_4_, i1)
							: j1 == 2 && p_149709_5_ == 2
									? func_149904_f(p_149709_1_, p_149709_2_, p_149709_3_, p_149709_4_, i1)
									: j1 == 3 && p_149709_5_ == 5
											? func_149904_f(p_149709_1_, p_149709_2_, p_149709_3_, p_149709_4_, i1)
	...
	protected void func_149897_b(World p_149897_1_, int p_149897_2_, int p_149897_3_, int p_149897_4_,
		...
		if (!func_149910_g(p_149897_1_, p_149897_2_, p_149897_3_, p_149897_4_, l)) {
			boolean flag = isGettingInput(p_149897_1_, p_149897_2_, p_149897_3_, p_149897_4_, l);
	...
	protected boolean isGettingInput(World p_149900_1_, int p_149900_2_, int p_149900_3_, int p_149900_4_,
			int p_149900_5_) {
		return getInputStrength(p_149900_1_, p_149900_2_, p_149900_3_, p_149900_4_, p_149900_5_) > 0;
	}
	...
	protected int getInputStrength(World p_149903_1_, int p_149903_2_, int p_149903_3_, int p_149903_4_,
		...
		return l1 >= 15 ? l1
				: Math.max(l1,
						p_149903_1_.getBlock(j1, p_149903_3_, k1) == Blocks.redstone_wire
								? p_149903_1_.getBlockMetadata(j1, p_149903_3_, k1)
								: 0);
	}
	...
	protected int func_149902_h(IBlockAccess p_149902_1_, int p_149902_2_, int p_149902_3_, int p_149902_4_,
		...
		case 0:
		case 2:
			return Math.max(func_149913_i(p_149902_1_, p_149902_2_ - 1, p_149902_3_, p_149902_4_, 4),
					func_149913_i(p_149902_1_, p_149902_2_ + 1, p_149902_3_, p_149902_4_, 5));
		case 1:
		case 3:
			return Math.max(func_149913_i(p_149902_1_, p_149902_2_, p_149902_3_, p_149902_4_ + 1, 3),
					func_149913_i(p_149902_1_, p_149902_2_, p_149902_3_, p_149902_4_ - 1, 2));
		default:
			return 0;
		}
	}
	...
	public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_,
		...
		boolean flag = isGettingInput(p_149689_1_, p_149689_2_, p_149689_3_, p_149689_4_, l);
	...
	public boolean func_149907_e(Block p_149907_1_) {
		return p_149907_1_ == getBlockPowered() || p_149907_1_ == getBlockUnpowered();
	}
