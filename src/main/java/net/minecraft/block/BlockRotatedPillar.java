...
public abstract class BlockRotatedPillar extends Block {
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		...
		int l = p_149691_2_ & 3;
		return k == 0 && (p_149691_1_ == 1 || p_149691_1_ == 0) ? getTopIcon(l)
				: k == 4 && (p_149691_1_ == 5 || p_149691_1_ == 4) ? getTopIcon(l)
						: k == 8 && (p_149691_1_ == 2 || p_149691_1_ == 3) ? getTopIcon(l) : getSideIcon(l);
	}
