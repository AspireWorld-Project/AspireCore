...
public class BlockTripWireHook extends Block {
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_,
		...
		if (p_149695_5_ != this) {
			if (func_150137_e(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_)) {
				...
				int i1 = l & 3;
				boolean flag = !p_149695_1_.isSideSolid(p_149695_2_ - 1, p_149695_3_, p_149695_4_, EAST) && i1 == 3;
	...
	public void func_150136_a(World p_150136_1_, int p_150136_2_, int p_150136_3_, int p_150136_4_, boolean p_150136_5_,
		...
		for (k2 = 1; k2 < 42; ++k2) {
			...
			if (block != Blocks.tripwire && k2 != p_150136_8_) {
				...
				if (k2 == p_150136_8_) {
					p_150136_1_.scheduleBlockUpdate(p_150136_2_, p_150136_3_, p_150136_4_, this, tickRate(p_150136_1_));
					flag4 &= flag7;
				}
			}
		}
		...
		if (j2 > 0) {
			...
			func_150134_a(p_150136_1_, l2, p_150136_3_, i3, k3);

			org.bukkit.block.Block block = p_150136_1_.getWorld().getBlockAt(l2, p_150136_3_, i3);
			BlockRedstoneEvent eventRedstone = new BlockRedstoneEvent(block, 15, 0);
			Bukkit.getPluginManager().callEvent(eventRedstone);
			if (eventRedstone.getNewCurrent() > 0)
				return;

			func_150135_a(p_150136_1_, l2, p_150136_3_, i3, flag4, flag5, flag2, flag3);
		}

		func_150135_a(p_150136_1_, p_150136_2_, p_150136_3_, p_150136_4_, flag4, flag5, flag2, flag3);

		if (!p_150136_5_) {
			p_150136_1_.setBlockMetadataWithNotify(p_150136_2_, p_150136_3_, p_150136_4_, p_150136_6_, 3);

			if (p_150136_7_) {
				func_150134_a(p_150136_1_, p_150136_2_, p_150136_3_, p_150136_4_, k1);
			}
		}
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
		func_150136_a(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_, false,
	...
	private void func_150135_a(World p_150135_1_, int p_150135_2_, int p_150135_3_, int p_150135_4_,
		...
		if (p_150135_6_ && !p_150135_8_) {
			p_150135_1_.playSoundEffect(p_150135_2_ + 0.5D, p_150135_3_ + 0.1D, p_150135_4_ + 0.5D, "random.click",
					0.4F, 0.6F);
			...
			p_150135_1_.playSoundEffect(p_150135_2_ + 0.5D, p_150135_3_ + 0.1D, p_150135_4_ + 0.5D, "random.bowhit",
					0.4F, 1.2F / (p_150135_1_.rand.nextFloat() * 0.2F + 0.9F));
		}
	}
	...
	public int isProvidingStrongPower(IBlockAccess p_149748_1_, int p_149748_2_, int p_149748_3_, int p_149748_4_,
		...
		if ((i1 & 8) != 8)
			...
			int j1 = i1 & 3;
			return j1 == 2 && p_149748_5_ == 2 ? 15
					: j1 == 0 && p_149748_5_ == 3 ? 15
							: j1 == 1 && p_149748_5_ == 4 ? 15 : j1 == 3 && p_149748_5_ == 5 ? 15 : 0;
		}
	}
