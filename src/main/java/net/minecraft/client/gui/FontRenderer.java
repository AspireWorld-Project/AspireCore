...
public class FontRenderer implements IResourceManagerReloadListener {
	...
	private void readFontTexture() {
		...
		try {
			bufferedimage = ImageIO.read(getResourceInputStream(locationFontTexture));
	...
	private ResourceLocation getUnicodePageLocation(int p_111271_1_) {
		if (unicodePageLocations[p_111271_1_] == null) {
			unicodePageLocations[p_111271_1_] = new ResourceLocation(String
					.format("textures/font/unicode_page_%02x.png", Integer.valueOf(p_111271_1_)));
		}
	...
	public int drawString(String p_85187_1_, int p_85187_2_, int p_85187_3_, int p_85187_4_, boolean p_85187_5_) {
		...
		if (p_85187_5_) {
			l = renderString(p_85187_1_, p_85187_2_ + 1, p_85187_3_ + 1, p_85187_4_, true);
			l = Math.max(l, renderString(p_85187_1_, p_85187_2_, p_85187_3_, p_85187_4_, false));
		} else {
			l = renderString(p_85187_1_, p_85187_2_, p_85187_3_, p_85187_4_, false);
		}
		...
		for (int i = 0; i < p_78255_1_.length(); ++i) {
			...
			if (c0 == 167 && i + 1 < p_78255_1_.length()) {
				...
				if (j < 16) {
					...
					k = colorCode[j];
					textColor = k;
					setColor((k >> 16) / 255.0F, (k >> 8 & 255) / 255.0F, (k & 255) / 255.0F, alpha);
				} else if (j == 16) {
					randomStyle = true;
				} else if (j == 17) {
					boldStyle = true;
				...
				boolean flag1 = (c0 == 0 || j == -1 || unicodeFlag) && p_78255_2_;
		...
		{
			{
				...
				if (strikethroughStyle) {
					...
					tessellator.addVertex(posX + f, posY + FONT_HEIGHT / 2, 0.0D);
					tessellator.addVertex(posX + f, posY + FONT_HEIGHT / 2 - 1.0F, 0.0D);
				...
				if (underlineStyle) {
					...
					tessellator.addVertex(posX + f, posY + FONT_HEIGHT, 0.0D);
					tessellator.addVertex(posX + f, posY + FONT_HEIGHT - 1.0F, 0.0D);
	...
	private int renderString(String p_78258_1_, int p_78258_2_, int p_78258_3_, int p_78258_4_, boolean p_78258_5_) {
		if (p_78258_1_ == null)
			...
			red = (p_78258_4_ >> 16 & 255) / 255.0F;
			blue = (p_78258_4_ >> 8 & 255) / 255.0F;
			green = (p_78258_4_ & 255) / 255.0F;
			alpha = (p_78258_4_ >> 24 & 255) / 255.0F;
			setColor(red, blue, green, alpha);
			posX = p_78258_2_;
			posY = p_78258_3_;
	...
	public int getCharWidth(char p_78263_1_) {
		if (p_78263_1_ == 167)
			...
			if (p_78263_1_ > 0 && i != -1 && !unicodeFlag)
				return charWidth[i];
	...
	private void renderSplitString(String p_78268_1_, int p_78268_2_, int p_78268_3_, int p_78268_4_,
		...
		for (Iterator iterator = list.iterator(); iterator.hasNext(); p_78268_3_ += FONT_HEIGHT) {
			String s1 = (String) iterator.next();
			renderStringAligned(s1, p_78268_2_, p_78268_3_, p_78268_4_, textColor, p_78268_5_);
		}
	}
	...
	private static boolean isFormatSpecial(char p_78270_0_) {
		return p_78270_0_ >= 107 && p_78270_0_ <= 111 || p_78270_0_ >= 75 && p_78270_0_ <= 79 || p_78270_0_ == 114
				|| p_78270_0_ == 82;
	}
