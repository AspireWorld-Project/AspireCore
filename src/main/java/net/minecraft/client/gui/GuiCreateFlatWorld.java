...
public class GuiCreateFlatWorld extends GuiScreen {
	...
	public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
		...
		createFlatWorldListSlotGui.drawScreen(p_73863_1_, p_73863_2_, p_73863_3_);
		drawCenteredString(fontRendererObj, field_146393_h, width / 2, 8, 16777215);
		int k = width / 2 - 92 - 16;
		drawString(fontRendererObj, field_146394_i, k, 32, 16777215);
		drawString(fontRendererObj, field_146391_r, k + 2 + 213 - fontRendererObj.getStringWidth(field_146391_r), 32,
				16777215);
	...
	class Details extends GuiSlot {
		...
		private void func_148225_a(int p_148225_1_, int p_148225_2_, ItemStack p_148225_3_) {
			...
			if (p_148225_3_ != null) {
				...
				GuiCreateFlatWorld.field_146392_a.renderItemIntoGUI(GuiCreateFlatWorld.this.fontRendererObj,
		...
		private void func_148224_c(int p_148224_1_, int p_148224_2_, int p_148224_3_, int p_148224_4_) {
			...
			tessellator.addVertexWithUV(p_148224_1_ + 0, p_148224_2_ + 18, GuiCreateFlatWorld.this.zLevel,
					(p_148224_3_ + 0) * 0.0078125F, (p_148224_4_ + 18) * 0.0078125F);
			tessellator.addVertexWithUV(p_148224_1_ + 18, p_148224_2_ + 18, GuiCreateFlatWorld.this.zLevel,
					(p_148224_3_ + 18) * 0.0078125F, (p_148224_4_ + 18) * 0.0078125F);
			tessellator.addVertexWithUV(p_148224_1_ + 18, p_148224_2_ + 0, GuiCreateFlatWorld.this.zLevel,
					(p_148224_3_ + 18) * 0.0078125F, (p_148224_4_ + 0) * 0.0078125F);
			tessellator.addVertexWithUV(p_148224_1_ + 0, p_148224_2_ + 0, GuiCreateFlatWorld.this.zLevel,
		...
		protected void drawSlot(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_,
			...
			FlatLayerInfo flatlayerinfo = (FlatLayerInfo) theFlatGeneratorInfo.getFlatLayers()
					.get(theFlatGeneratorInfo.getFlatLayers().size() - p_148126_1_ - 1);
			Item item = Item.getItemFromBlock(flatlayerinfo.func_151536_b());
			ItemStack itemstack = flatlayerinfo.func_151536_b() == Blocks.air ? null
					: new ItemStack(item, 1, flatlayerinfo.getFillBlockMeta());
			String s = itemstack != null && item != null ? item.getItemStackDisplayName(itemstack) : "Air";
			func_148225_a(p_148126_2_, p_148126_3_, itemstack);
			...
			GuiCreateFlatWorld.this.fontRendererObj.drawString(s1,
					p_148126_2_ + 2 + 213 - GuiCreateFlatWorld.this.fontRendererObj.getStringWidth(s1), p_148126_3_ + 3,
					16777215);
		}
