...
public class ServerListEntryLanScan implements GuiListExtended.IGuiListEntry {
	...
	public void drawEntry(int p_148279_1_, int p_148279_2_, int p_148279_3_, int p_148279_4_, int p_148279_5_,
		...
		field_148288_a.fontRenderer.drawString(I18n.format("lanServer.scanning", new Object[0]),
				field_148288_a.currentScreen.width / 2
						- field_148288_a.fontRenderer.getStringWidth(I18n.format("lanServer.scanning", new Object[0]))
								/ 2,
				l1, 16777215);
		String s;
