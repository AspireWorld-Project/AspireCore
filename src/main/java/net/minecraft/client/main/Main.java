...
public class Main {
	...
	public static void main(String[] p_main_0_) {
		...
		ArgumentAcceptingOptionSpec argumentacceptingoptionspec6 = optionparser.accepts("proxyPort").withRequiredArg()
		...
		Iterator iterator = ((Map) new Gson().fromJson((String) optionset.valueOf(argumentacceptingoptionspec15),
		...
		File file3 = optionset.has(argumentacceptingoptionspec3)
				? (File) optionset.valueOf(argumentacceptingoptionspec3)
				: new File(file2, "assets/");
		File file1 = optionset.has(argumentacceptingoptionspec4)
				? (File) optionset.valueOf(argumentacceptingoptionspec4)
				: new File(file2, "resourcepacks/");
		String s4 = optionset.has(argumentacceptingoptionspec10)
				? (String) argumentacceptingoptionspec10.value(optionset)
				: (String) argumentacceptingoptionspec9.value(optionset);
		String s5 = optionset.has(argumentacceptingoptionspec16)
				? (String) argumentacceptingoptionspec16.value(optionset)
				: null;
		Session session = new Session((String) argumentacceptingoptionspec9.value(optionset), s4,
				(String) argumentacceptingoptionspec11.value(optionset),
				(String) argumentacceptingoptionspec17.value(optionset));
		Minecraft minecraft = new Minecraft(session, i, j, flag, flag1, file2, file3, file1, proxy, s3, hashmultimap,
				s5);
