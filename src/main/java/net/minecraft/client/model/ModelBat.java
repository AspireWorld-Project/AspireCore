...
public class ModelBat extends ModelBase {
	...
	public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_,
		...
		if (entitybat.getIsBatHanging()) {
			...
			batHead.rotateAngleY = (float) Math.PI - p_78088_5_ / (180F / (float) Math.PI);
			...
			batBody.rotateAngleX = (float) Math.PI / 4F + MathHelper.cos(p_78088_4_ * 0.1F) * 0.15F;
			batBody.rotateAngleY = 0.0F;
			batRightWing.rotateAngleY = MathHelper.cos(p_78088_4_ * 1.3F) * (float) Math.PI * 0.25F;
			batLeftWing.rotateAngleY = -batRightWing.rotateAngleY;
