...
public class ModelWitch extends ModelVillager {
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_,
		...
		villagerNose.rotateAngleX = MathHelper.sin(p_78087_7_.ticksExisted * f6) * 4.5F * (float) Math.PI / 180.0F;
		villagerNose.rotateAngleY = 0.0F;
		villagerNose.rotateAngleZ = MathHelper.cos(p_78087_7_.ticksExisted * f6) * 2.5F * (float) Math.PI / 180.0F;
