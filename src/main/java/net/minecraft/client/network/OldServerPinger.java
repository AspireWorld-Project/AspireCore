...
public class OldServerPinger {
	...
	public void func_147224_a(final ServerData p_147224_1_) throws UnknownHostException {
		...
		final NetworkManager networkmanager = NetworkManager
				.provideLanClient(InetAddress.getByName(serveraddress.getIP()), serveraddress.getPort());
		field_147229_c.add(networkmanager);
			...
			public void handleServerInfo(S00PacketServerInfo p_147397_1_) {
				...
				if (serverstatusresponse.func_151318_b() != null) {
					p_147224_1_.populationInfo = EnumChatFormatting.GRAY + ""
							+ serverstatusresponse.func_151318_b().func_151333_b() + "" + EnumChatFormatting.DARK_GRAY
							+ "/" + EnumChatFormatting.GRAY + serverstatusresponse.func_151318_b().func_151332_a();
					...
					if (ArrayUtils.isNotEmpty(serverstatusresponse.func_151318_b().func_151331_c())) {
						...
						if (serverstatusresponse.func_151318_b().func_151331_c().length < serverstatusresponse
							...
							stringbuilder.append("... and ")
									.append(serverstatusresponse.func_151318_b().func_151333_b()
											- serverstatusresponse.func_151318_b().func_151331_c().length)
									.append(" more ...");
						}
					...
					protected void channelRead0(ChannelHandlerContext p_channelRead0_1_, ByteBuf p_channelRead0_2_) {
						...
						if (short1 == 255) {
							String s = new String(
									...
									Charsets.UTF_16BE);
							String[] astring = Iterables.toArray(OldServerPinger.field_147230_a.split(s), String.class);

							if ("\u00a71".equals(astring[0])) {
								MathHelper.parseIntWithDefault(astring[1], 0);
								String s1 = astring[2];
								String s2 = astring[3];
								...
								p_147225_1_.populationInfo = EnumChatFormatting.GRAY + "" + j + ""
										+ EnumChatFormatting.DARK_GRAY + "/" + EnumChatFormatting.GRAY + k;
							}
						}
	...
	public void func_147223_a() {
		synchronized (field_147229_c) {
			Iterator iterator = field_147229_c.iterator();
