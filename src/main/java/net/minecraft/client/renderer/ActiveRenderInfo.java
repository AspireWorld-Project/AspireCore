...
public class ActiveRenderInfo {
	...
	public static Vec3 projectViewFromEntity(EntityLivingBase p_74585_0_, double p_74585_1_) {
		...
		double d2 = p_74585_0_.prevPosY + (p_74585_0_.posY - p_74585_0_.prevPosY) * p_74585_1_
				+ p_74585_0_.getEyeHeight();
		double d3 = p_74585_0_.prevPosZ + (p_74585_0_.posZ - p_74585_0_.prevPosZ) * p_74585_1_;
		double d4 = d1 + objectX * 1.0F;
		double d5 = d2 + objectY * 1.0F;
		double d6 = d3 + objectZ * 1.0F;
	...
	public static Block getBlockAtEntityViewpoint(World p_151460_0_, EntityLivingBase p_151460_1_, float p_151460_2_) {
		Vec3 vec3 = projectViewFromEntity(p_151460_1_, p_151460_2_);
		...
		if (block.getMaterial().isLiquid()) {
			float f1 = BlockLiquid.getLiquidHeightPercent(p_151460_0_.getBlockMetadata(chunkposition.chunkPosX,
					chunkposition.chunkPosY, chunkposition.chunkPosZ)) - 0.11111111F;
			float f2 = chunkposition.chunkPosY + 1 - f1;

			if (vec3.yCoord >= f2) {
				block = p_151460_0_.getBlock(chunkposition.chunkPosX, chunkposition.chunkPosY + 1,
