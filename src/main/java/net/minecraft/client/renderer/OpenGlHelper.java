...
public class OpenGlHelper {
	...
	public static void initializeTextures() {
		...
		if (framebufferSupported) {
			...
			field_153196_B = field_153196_B + "OpenGL 1.4 is " + (contextcapabilities.OpenGL14 ? "" : "not ")
					+ "supported, ";
			field_153196_B = field_153196_B + "EXT_blend_func_separate is "
					+ (contextcapabilities.GL_EXT_blend_func_separate ? "" : "not ") + "supported, ";
			field_153196_B = field_153196_B + "OpenGL 3.0 is " + (contextcapabilities.OpenGL30 ? "" : "not ")
					+ "supported, ";
		...
		field_153213_x = openGL21 || contextcapabilities.GL_ARB_vertex_shader
		...
		if (field_153213_x) {
			...
			field_153196_B = field_153196_B + "OpenGL 2.1 is " + (contextcapabilities.OpenGL21 ? "" : "not ")
					+ "supported, ";
			field_153196_B = field_153196_B + "ARB_shader_objects is "
					+ (contextcapabilities.GL_ARB_shader_objects ? "" : "not ") + "supported, ";
			field_153196_B = field_153196_B + "ARB_vertex_shader is "
					+ (contextcapabilities.GL_ARB_vertex_shader ? "" : "not ") + "supported, and ";
			field_153196_B = field_153196_B + "ARB_fragment_shader is "
					+ (contextcapabilities.GL_ARB_fragment_shader ? "" : "not ") + "supported.\n";
		}
