...
public class RenderFish extends Render {
	...
	public void doRender(EntityFishHook p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		if (p_76986_1_.field_146042_b != null) {
			...
			vec3.rotateAroundX(-(p_76986_1_.field_146042_b.prevRotationPitch
					+ (p_76986_1_.field_146042_b.rotationPitch - p_76986_1_.field_146042_b.prevRotationPitch)
							* p_76986_9_)
					* (float) Math.PI / 180.0F);
			vec3.rotateAroundY(-(p_76986_1_.field_146042_b.prevRotationYaw
			...
			double d3 = p_76986_1_.field_146042_b.prevPosX
					+ (p_76986_1_.field_146042_b.posX - p_76986_1_.field_146042_b.prevPosX) * p_76986_9_ + vec3.xCoord;
			double d4 = p_76986_1_.field_146042_b.prevPosY
					+ (p_76986_1_.field_146042_b.posY - p_76986_1_.field_146042_b.prevPosY) * p_76986_9_ + vec3.yCoord;
			double d5 = p_76986_1_.field_146042_b.prevPosZ
					+ (p_76986_1_.field_146042_b.posZ - p_76986_1_.field_146042_b.prevPosZ) * p_76986_9_ + vec3.zCoord;
			...
			if (renderManager.options.thirdPersonView > 0
				...
				d3 = p_76986_1_.field_146042_b.prevPosX
						+ (p_76986_1_.field_146042_b.posX - p_76986_1_.field_146042_b.prevPosX) * p_76986_9_
						- d9 * 0.35D - d7 * 0.85D;
				d4 = p_76986_1_.field_146042_b.prevPosY + d6
						+ (p_76986_1_.field_146042_b.posY - p_76986_1_.field_146042_b.prevPosY) * p_76986_9_ - 0.45D;
				d5 = p_76986_1_.field_146042_b.prevPosZ
						+ (p_76986_1_.field_146042_b.posZ - p_76986_1_.field_146042_b.prevPosZ) * p_76986_9_
						- d7 * 0.35D + d9 * 0.85D;
			}

			double d14 = p_76986_1_.prevPosX + (p_76986_1_.posX - p_76986_1_.prevPosX) * p_76986_9_;
			double d8 = p_76986_1_.prevPosY + (p_76986_1_.posY - p_76986_1_.prevPosY) * p_76986_9_ + 0.25D;
			double d10 = p_76986_1_.prevPosZ + (p_76986_1_.posZ - p_76986_1_.prevPosZ) * p_76986_9_;
			...
			for (int i = 0; i <= b2; ++i) {
				...
				tessellator.addVertex(p_76986_2_ + d11 * f12, p_76986_4_ + d12 * (f12 * f12 + f12) * 0.5D + 0.25D,
						p_76986_6_ + d13 * f12);
			}
