...
public class RenderItem extends Render {
	...
	public void doRender(EntityItem p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		if (itemstack.getItem() != null) {
			...
			GL11.glPushMatrix();
			float f2 = shouldBob()
					? MathHelper.sin((p_76986_1_.age + p_76986_9_) / 10.0F + p_76986_1_.hoverStart) * 0.1F + 0.1F
					: 0F;
			float f3 = ((p_76986_1_.age + p_76986_9_) / 20.0F + p_76986_1_.hoverStart) * (180F / (float) Math.PI);
			byte b0 = 1;
	...
	protected ResourceLocation getEntityTexture(EntityItem p_110775_1_) {
		return renderManager.renderEngine.getResourceLocation(p_110775_1_.getEntityItem().getItemSpriteNumber());
	}
	...
	private void renderDroppedItem(EntityItem p_77020_1_, IIcon p_77020_2_, int p_77020_3_, float p_77020_4_,
			float p_77020_5_, float p_77020_6_, float p_77020_7_, int pass) {
		Tessellator tessellator = Tessellator.instance;

		if (p_77020_2_ == null) {
			TextureManager texturemanager = Minecraft.getMinecraft().getTextureManager();
			ResourceLocation resourcelocation = texturemanager
					.getResourceLocation(p_77020_1_.getEntityItem().getItemSpriteNumber());
		...
		if (renderManager.options.fancyGraphics) {
			...
			if (renderInFrame) {
				...
				GL11.glRotatef(
						((p_77020_1_.age + p_77020_4_) / 20.0F + p_77020_1_.hoverStart) * (180F / (float) Math.PI),
						0.0F, 1.0F, 0.0F);
			}
			...
			for (int k = 0; k < b0; ++k) {
				...
				ItemRenderer.renderItemIn2D(tessellator, f15, f4, f14, f5, p_77020_2_.getIconWidth(),
						p_77020_2_.getIconHeight(), f9);
	...
	public void renderItemIntoGUI(FontRenderer p_77015_1_, TextureManager p_77015_2_, ItemStack p_77015_3_,
		...
		if (p_77015_3_.getItemSpriteNumber() == 0
			...
			for (l = 0; l < item.getRenderPasses(k); ++l) {
				OpenGlHelper.glBlendFunc(770, 771, 1, 0);
				p_77015_2_.bindTexture(item.getSpriteNumber() == 0 ? TextureMap.locationBlocksTexture
	...
	public void renderItemAndEffectIntoGUI(FontRenderer p_82406_1_, TextureManager p_82406_2_,
		...
		if (p_82406_3_ != null) {
			...
			try {
				if (!ForgeHooksClient.renderInventoryItem(field_147909_c, p_82406_2_, p_82406_3_, renderWithColor,
						zLevel, p_82406_4_, p_82406_5_)) {
			...
			if (false && p_82406_3_.hasEffect()) {
				...
				renderGlint(p_82406_4_ * 431278612 + p_82406_5_ * 32178161, p_82406_4_ - 2, p_82406_5_ - 2, 20, 20);
				OpenGlHelper.glBlendFunc(770, 771, 1, 0);
	...
	private void renderGlint(int p_77018_1_, int p_77018_2_, int p_77018_3_, int p_77018_4_, int p_77018_5_) {
		for (int j1 = 0; j1 < 2; ++j1) {
			...
			tessellator.startDrawingQuads();
			tessellator.addVertexWithUV(p_77018_2_ + 0, p_77018_3_ + p_77018_5_, zLevel, (f2 + p_77018_5_ * f4) * f,
					(f3 + p_77018_5_) * f1);
			tessellator.addVertexWithUV(p_77018_2_ + p_77018_4_, p_77018_3_ + p_77018_5_, zLevel,
					(f2 + p_77018_4_ + p_77018_5_ * f4) * f, (f3 + p_77018_5_) * f1);
			tessellator.addVertexWithUV(p_77018_2_ + p_77018_4_, p_77018_3_ + 0, zLevel, (f2 + p_77018_4_) * f,
					(f3 + 0.0F) * f1);
			tessellator.addVertexWithUV(p_77018_2_ + 0, p_77018_3_ + 0, zLevel, (f2 + 0.0F) * f, (f3 + 0.0F) * f1);
			tessellator.draw();
		}
	}
	...
	public void renderItemOverlayIntoGUI(FontRenderer p_94148_1_, TextureManager p_94148_2_, ItemStack p_94148_3_,
		...
		if (p_94148_3_ != null) {
			if (p_94148_3_.stackSize > 1 || p_94148_6_ != null) {
				...
				GL11.glDisable(GL11.GL_BLEND);
				p_94148_1_.drawStringWithShadow(s1, p_94148_4_ + 19 - 2 - p_94148_1_.getStringWidth(s1),
			...
			if (p_94148_3_.getItem().showDurabilityBar(p_94148_3_)) {
				...
				// GL11.glEnable(GL11.GL_BLEND); // Forge: Disable Bled because it screws with a
	...
	public void renderIcon(int p_94149_1_, int p_94149_2_, IIcon p_94149_3_, int p_94149_4_, int p_94149_5_) {
		Tessellator tessellator = Tessellator.instance;
		tessellator.startDrawingQuads();
		tessellator.addVertexWithUV(p_94149_1_ + 0, p_94149_2_ + p_94149_5_, zLevel, p_94149_3_.getMinU(),
				p_94149_3_.getMaxV());
		tessellator.addVertexWithUV(p_94149_1_ + p_94149_4_, p_94149_2_ + p_94149_5_, zLevel, p_94149_3_.getMaxU(),
				p_94149_3_.getMaxV());
		tessellator.addVertexWithUV(p_94149_1_ + p_94149_4_, p_94149_2_ + 0, zLevel, p_94149_3_.getMaxU(),
				p_94149_3_.getMinV());
		tessellator.addVertexWithUV(p_94149_1_ + 0, p_94149_2_ + 0, zLevel, p_94149_3_.getMinU(), p_94149_3_.getMinV());
		tessellator.draw();
	}
	...
	/**
	 * Allows for a subclass to override how many rendered items appear in a "mini
	 * item 3d stack"
	 *
	 * @param stack
	 *            The item stack
	 * @param original
	 *            The default amount vanilla would use
	 * @return
	 */
