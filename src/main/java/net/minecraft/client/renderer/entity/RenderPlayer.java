...
public class RenderPlayer extends RendererLivingEntity {
	...
	protected int shouldRenderPass(AbstractClientPlayer p_77032_1_, int p_77032_2_, float p_77032_3_) {
		...
		net.minecraftforge.client.event.RenderPlayerEvent.SetArmorModel event = new net.minecraftforge.client.event.RenderPlayerEvent.SetArmorModel(
				p_77032_1_, this, 3 - p_77032_2_, p_77032_3_, itemstack);
	...
	public void doRender(AbstractClientPlayer p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		if (net.minecraftforge.common.MinecraftForge.EVENT_BUS
				.post(new net.minecraftforge.client.event.RenderPlayerEvent.Pre(p_76986_1_, this, p_76986_9_)))
			return;
		GL11.glColor3f(1.0F, 1.0F, 1.0F);
		...
		net.minecraftforge.common.MinecraftForge.EVENT_BUS
				.post(new net.minecraftforge.client.event.RenderPlayerEvent.Post(p_76986_1_, this, p_76986_9_));
	}
	...
	protected void renderEquippedItems(AbstractClientPlayer p_77029_1_, float p_77029_2_) {
		...
		if (flag && !p_77029_1_.isInvisible() && !p_77029_1_.getHideCape()) {
			...
			double d3 = p_77029_1_.field_71091_bM + (p_77029_1_.field_71094_bP - p_77029_1_.field_71091_bM) * p_77029_2_
					- (p_77029_1_.prevPosX + (p_77029_1_.posX - p_77029_1_.prevPosX) * p_77029_2_);
			double d4 = p_77029_1_.field_71096_bN + (p_77029_1_.field_71095_bQ - p_77029_1_.field_71096_bN) * p_77029_2_
					- (p_77029_1_.prevPosY + (p_77029_1_.posY - p_77029_1_.prevPosY) * p_77029_2_);
			double d0 = p_77029_1_.field_71097_bO + (p_77029_1_.field_71085_bR - p_77029_1_.field_71097_bO) * p_77029_2_
					- (p_77029_1_.prevPosZ + (p_77029_1_.posZ - p_77029_1_.prevPosZ) * p_77029_2_);
			f4 = p_77029_1_.prevRenderYawOffset
					+ (p_77029_1_.renderYawOffset - p_77029_1_.prevRenderYawOffset) * p_77029_2_;
			...
			f5 += MathHelper.sin((p_77029_1_.prevDistanceWalkedModified
		...
		net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(
				new net.minecraftforge.client.event.RenderPlayerEvent.Specials.Post(p_77029_1_, this, p_77029_2_));
	}
		...
		if (p_96449_10_ < 100.0D) {
			...
			if (scoreobjective != null) {
				...
				if (p_96449_1_.isPlayerSleeping()) {
					func_147906_a(p_96449_1_, score.getScorePoints() + " " + scoreobjective.getDisplayName(),
							p_96449_2_, p_96449_4_ - 1.5D, p_96449_6_, 64);
				} else {
					func_147906_a(p_96449_1_, score.getScorePoints() + " " + scoreobjective.getDisplayName(),
