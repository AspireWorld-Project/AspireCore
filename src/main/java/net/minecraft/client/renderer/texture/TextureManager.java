...
public class TextureManager implements ITickable, IResourceManagerReloadListener {
	...
	public void bindTexture(ResourceLocation p_110577_1_) {
		Object object = mapTextureObjects.get(p_110577_1_);

		if (object == null) {
			object = new SimpleTexture(p_110577_1_);
			loadTexture(p_110577_1_, (ITextureObject) object);
		}
	...
	public boolean loadTextureMap(ResourceLocation p_130088_1_, TextureMap p_130088_2_) {
		if (loadTickableTexture(p_130088_1_, p_130088_2_)) {
			mapResourceLocations.put(Integer.valueOf(p_130088_2_.getTextureType()), p_130088_1_);
			return true;
		} else
			return false;
	}
	...
	public ResourceLocation getDynamicTextureLocation(String p_110578_1_, DynamicTexture p_110578_2_) {
		...
		mapTextureCounters.put(p_110578_1_, integer);
		ResourceLocation resourcelocation = new ResourceLocation(
				String.format("dynamic/%s_%d", new Object[] { p_110578_1_, integer }));
		loadTexture(resourcelocation, p_110578_2_);
		return resourcelocation;
	}

	@Override
	public void tick() {
		Iterator iterator = listTickables.iterator();
	...
	public void onResourceManagerReload(IResourceManager p_110549_1_) {
		cpw.mods.fml.common.ProgressManager.ProgressBar bar = cpw.mods.fml.common.ProgressManager
				.push("Reloading Texture Manager", mapTextureObjects.keySet().size(), true);
