...
public class TextureUtil {
				...
				if (p_147949_2_[k] != null) {
					...
					for (int k1 = 0; k1 < l; ++k1) {
						for (int l1 = 0; l1 < i1; ++l1) {
							int i2 = 2 * (k1 + l1 * j1);
							aint3[k1 + l1 * l] = func_147943_a(aint2[i2 + 0], aint2[i2 + 1], aint2[i2 + 0 + j1],
									aint2[i2 + 1 + j1], flag);
						}
					}
		...
		if (!p_147943_4_) {
			...
			for (i1 = 0; i1 < 4; ++i1) {
				if (field_147957_g[i1] >> 24 != 0) {
					...
					f3 += (float) Math.pow((field_147957_g[i1] >> 0 & 255) / 255.0F, 2.2D);
				}
			}
	...
	public static void uploadTextureMipmap(int[][] p_147955_0_, int p_147955_1_, int p_147955_2_, int p_147955_3_,
		...
		for (int i1 = 0; i1 < p_147955_0_.length; ++i1) {
			...
			uploadTextureSub(i1, aint1, p_147955_1_ >> i1, p_147955_2_ >> i1, p_147955_3_ >> i1, p_147955_4_ >> i1,
	...
	private static void uploadTextureSub(int p_147947_0_, int[] p_147947_1_, int p_147947_2_, int p_147947_3_,
		...
		for (int k1 = 0; k1 < p_147947_2_ * p_147947_3_; k1 += p_147947_2_ * i2) {
			...
			GL11.glTexSubImage2D(GL11.GL_TEXTURE_2D, p_147947_0_, p_147947_4_, p_147947_5_ + l1, p_147947_2_, i2,
	...
	public static void allocateTextureImpl(int p_147946_0_, int p_147946_1_, int p_147946_2_, int p_147946_3_,
		...
		for (int i1 = 0; i1 <= p_147946_1_; ++i1) {
			GL11.glTexImage2D(GL11.GL_TEXTURE_2D, i1, GL11.GL_RGBA, p_147946_2_ >> i1, p_147946_3_ >> i1, 0,
	...
	private static void uploadTextureImageSubImpl(BufferedImage p_110993_0_, int p_110993_1_, int p_110993_2_,
		...
		for (int j1 = 0; j1 < k * l; j1 += k * i1) {
			...
			GL11.glTexSubImage2D(GL11.GL_TEXTURE_2D, 0, p_110993_1_, p_110993_2_ + k1, k, l1, GL12.GL_BGRA,
	...
	public static int[] prepareAnisotropicData(int[] p_147948_0_, int p_147948_1_, int p_147948_2_, int p_147948_3_) {
		...
		for (i1 = p_147948_2_ - 1; i1 >= 0; --i1) {
			...
			for (l1 = 0; l1 < p_147948_3_; l1 += p_147948_1_) {
				System.arraycopy(p_147948_0_, j1, p_147948_0_, k1 + p_147948_1_ + l1,
		...
		for (i1 = 0; i1 < p_147948_3_; i1 += p_147948_2_) {
			...
			System.arraycopy(p_147948_0_, (p_147948_3_ + p_147948_2_ - j1) * l, p_147948_0_,
					(p_147948_3_ - i1 - j1) * l, l * j1);
		}
	...
	public static void func_147953_a(int[] p_147953_0_, int p_147953_1_, int p_147953_2_) {
		...
		for (int l = 0; l < k; ++l) {
			...
			System.arraycopy(p_147953_0_, (p_147953_2_ - 1 - l) * p_147953_1_, p_147953_0_, l * p_147953_1_,
					p_147953_1_);
