	...
	public FontMetadataSection deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
		...
		if (jsonobject.has("characters")) {
			...
			if (jsonobject1.has("default")) {
				...
				Validate.inclusiveBetween(Float.valueOf(0.0F), Float.valueOf(Float.MAX_VALUE), Float.valueOf(f),
						"Invalid default width", new Object[0]);
				f1 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(jsonobject2, "spacing", f1);
				Validate.inclusiveBetween(Float.valueOf(0.0F), Float.valueOf(Float.MAX_VALUE), Float.valueOf(f1),
						"Invalid default spacing", new Object[0]);
				f2 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(jsonobject2, "left", f1);
				Validate.inclusiveBetween(Float.valueOf(0.0F), Float.valueOf(Float.MAX_VALUE), Float.valueOf(f2),
			...
			for (int i = 0; i < 256; ++i) {
				...
				if (jsonelement1 != null) {
					JsonObject jsonobject3 = JsonUtils.getJsonElementAsJsonObject(jsonelement1,
							"characters[" + i + "]");
					f3 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(jsonobject3, "width", f);
					Validate.inclusiveBetween(Float.valueOf(0.0F), Float.valueOf(Float.MAX_VALUE), Float.valueOf(f3),
							"Invalid width", new Object[0]);
					f4 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(jsonobject3, "spacing", f1);
					Validate.inclusiveBetween(Float.valueOf(0.0F), Float.valueOf(Float.MAX_VALUE), Float.valueOf(f4),
							"Invalid spacing", new Object[0]);
					f5 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(jsonobject3, "left", f2);
					Validate.inclusiveBetween(Float.valueOf(0.0F), Float.valueOf(Float.MAX_VALUE), Float.valueOf(f5),
