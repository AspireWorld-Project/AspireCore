...
public class JsonBlendingMode {
	...
	public void func_148109_a() {
		if (!equals(field_148118_a)) {
			...
			if (field_148113_g) {
				GL14.glBlendFuncSeparate(field_148116_b, field_148114_d, field_148117_c, field_148115_e);
			} else {
	...
	private static int func_148108_a(String p_148108_0_) {
		...
		return s1.equals("add") ? 32774
				: s1.equals("subtract") ? 32778
						: s1.equals("reversesubtract") ? 32779
								: s1.equals("reverse_subtract") ? 32779
										: s1.equals("min") ? 32775 : s1.equals("max") ? 32776 : 32774;
	}
	...
	private static int func_148107_b(String p_148107_0_) {
		...
		return s1.equals("0") ? 0
				: s1.equals("1") ? 1
						: s1.equals("srccolor") ? 768
								: s1.equals("1-srccolor") ? 769
										: s1.equals("dstcolor") ? 774
												: s1.equals("1-dstcolor") ? 775
														: s1.equals("srcalpha") ? 770
																: s1.equals("1-srcalpha") ? 771
																		: s1.equals("dstalpha") ? 772
																				: s1.equals("1-dstalpha") ? 773 : -1;
	}
}