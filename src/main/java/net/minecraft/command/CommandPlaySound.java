...
public class CommandPlaySound extends CommandBase {
	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_2_.length < 2)
			...
			double d0 = entityplayermp.getPlayerCoordinates().posX;
			double d1 = entityplayermp.getPlayerCoordinates().posY;
			double d2 = entityplayermp.getPlayerCoordinates().posZ;
			double d3 = 1.0D;
			double d4 = 1.0D;
			double d5 = 0.0D;
			...
			if (d7 > d6) {
				...
				entityplayermp.playerNetServerHandler
						.sendPacket(new S29PacketSoundEffect(s, d12, d13, d14, (float) d5, (float) d4));
			} else {
				entityplayermp.playerNetServerHandler
