...
public class CommandSpreadPlayers extends CommandBase {
	...
	private void func_110669_a(ICommandSender p_110669_1_, List p_110669_2_, CommandSpreadPlayers.Position p_110669_3_,
		...
		CommandSpreadPlayers.Position[] aposition = func_110670_a(random,
				p_110669_9_ ? func_110667_a(p_110669_2_) : p_110669_2_.size(), d2, d3, d4, d5);
	...
	private int func_110668_a(CommandSpreadPlayers.Position p_110668_1_, double p_110668_2_, World p_110668_4_,
		...
		for (i = 0; i < 10000 && flag1; ++i) {
			...
			for (int j = 0; j < p_110668_14_.length; ++j) {
				...
				if (k > 0) {
					position1.field_111101_a /= k;
					position1.field_111100_b /= k;
					double d7 = position1.func_111096_b();
	...
	private double func_110671_a(List p_110671_1_, World p_110671_2_, CommandSpreadPlayers.Position[] p_110671_3_,
		...
		for (int j = 0; j < p_110671_1_.size(); ++j) {
			...
			entitylivingbase.setPositionAndUpdate(MathHelper.floor_double(position.field_111101_a) + 0.5F,
					position.func_111092_a(p_110671_2_), MathHelper.floor_double(position.field_111100_b) + 0.5D);
	...
	static class Position {
		...
		public int func_111092_a(World p_111092_1_) {
			int i = MathHelper.floor_double(field_111101_a);
			int j = MathHelper.floor_double(field_111100_b);
