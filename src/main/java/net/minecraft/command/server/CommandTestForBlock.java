...
public class CommandTestForBlock extends CommandBase {
	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_2_.length >= 4) {
			...
			i = MathHelper.floor_double(func_110666_a(p_71515_1_, i, p_71515_2_[0]));
			j = MathHelper.floor_double(func_110666_a(p_71515_1_, j, p_71515_2_[1]));
			k = MathHelper.floor_double(func_110666_a(p_71515_1_, k, p_71515_2_[2]));
	...
	public boolean func_147181_a(NBTBase p_147181_1_, NBTBase p_147181_2_) {
		if (p_147181_1_ == p_147181_2_)
			...
			} while (func_147181_a(nbtbase2, nbttagcompound1.getTag(s)));
