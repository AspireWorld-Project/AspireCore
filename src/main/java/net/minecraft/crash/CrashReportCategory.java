...
public class CrashReportCategory {
	...
	public void addCrashSectionCallable(String p_71500_1_, Callable p_71500_2_) {
		try {
			...
			addCrashSectionThrowable(p_71500_1_, throwable);
		}
	}

	public void addCrashSection(String p_71507_1_, Object p_71507_2_) {
		field_85077_c.add(new CrashReportCategory.Entry(p_71507_1_, p_71507_2_));
	}
	...
	public int getPrunedStackTrace(int p_85073_1_) {
		...
		if (astacktraceelement.length <= 0)
			...
			stackTrace = new StackTraceElement[len];
			System.arraycopy(astacktraceelement, astacktraceelement.length - len, stackTrace, 0, stackTrace.length);
	...
	public boolean firstTwoElementsOfStackTraceMatch(StackTraceElement p_85069_1_, StackTraceElement p_85069_2_) {
		if (stackTrace.length != 0 && p_85069_1_ != null) {
			...
			if (stacktraceelement2.isNativeMethod() == p_85069_1_.isNativeMethod()
					&& stacktraceelement2.getClassName().equals(p_85069_1_.getClassName())
					&& stacktraceelement2.getFileName().equals(p_85069_1_.getFileName())
					&& stacktraceelement2.getMethodName().equals(p_85069_1_.getMethodName())) {
				if (p_85069_2_ != null != stackTrace.length > 1)
					return false;
				else if (p_85069_2_ != null && !stackTrace[1].equals(p_85069_2_))
					return false;
				else {
	...
	public void trimStackTraceEntriesFromBottom(int p_85070_1_) {
		StackTraceElement[] astacktraceelement = new StackTraceElement[stackTrace.length - p_85070_1_];
	...
	public void appendToStringBuilder(StringBuilder p_85072_1_) {
		...
		Iterator iterator = field_85077_c.iterator();
	...
	static class Entry {
		...
		public Entry(String p_i1352_1_, Object p_i1352_2_) {
			...
			if (p_i1352_2_ == null) {
				...
				field_85091_b = "~~ERROR~~ " + throwable.getClass().getSimpleName() + ": " + throwable.getMessage();
			} else {
