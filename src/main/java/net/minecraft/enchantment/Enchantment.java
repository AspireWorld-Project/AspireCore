...
public abstract class Enchantment {
	...
	protected Enchantment(int p_i1926_1_, int p_i1926_2_, EnumEnchantmentType p_i1926_3_) {
		...
		if (enchantmentsList[p_i1926_1_] != null)
			throw new IllegalArgumentException("Duplicate enchantment id! " + this.getClass() + " and "
					+ enchantmentsList[p_i1926_1_].getClass() + " Enchantment ID:" + p_i1926_1_);
		else {
			enchantmentsList[p_i1926_1_] = this;
		}
		org.bukkit.enchantments.Enchantment
				.registerEnchantment(new org.bukkit.craftbukkit.enchantments.CraftEnchantment(this));
	}
	 ...
	 * method {@link #canApply(ItemStack)} applies for <i>all possible</i>
	 * enchantments.
	 *
	 * @param stack
	 * @return
