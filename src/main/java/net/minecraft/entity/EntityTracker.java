...
public class EntityTracker {
	...
	public EntityTracker(WorldServer p_i1516_1_) {
		theWorld = p_i1516_1_;
		entityViewDistance = p_i1516_1_.func_73046_m().getConfigurationManager().getEntityViewDistance();
	}
	...
	public void addEntityToTracker(Entity p_72785_1_, int p_72785_2_, final int p_72785_3_, boolean p_72785_4_) {
		...
		try {
			if (trackedEntityIDs.containsItem(p_72785_1_.getEntityId()))
				throw new IllegalStateException("Entity is already tracked! Entity: " + p_72785_1_ + ", Class: "
						+ p_72785_1_.getClass() + ", ID: " + p_72785_1_.getEntityId());

			EntityTrackerEntry entitytrackerentry = new EntityTrackerEntry(p_72785_1_, p_72785_2_, p_72785_3_,
					p_72785_4_);
			trackedEntities.add(entitytrackerentry);
			trackedEntityIDs.addKey(p_72785_1_.getEntityId(), entitytrackerentry);
			...
			((EntityTrackerEntry) trackedEntityIDs.lookup(p_72785_1_.getEntityId())).myEntity
	...
	public void removeEntityFromAllTrackingPlayers(Entity p_72790_1_) {
		...
		EntityTrackerEntry entitytrackerentry1 = (EntityTrackerEntry) trackedEntityIDs
	...
	public void updateTrackedEntities() {
		...
		for (int i = 0; i < arraylist.size(); ++i) {
			...
			Iterator iterator1 = trackedEntities.iterator();
	...
	public void func_151247_a(Entity p_151247_1_, Packet p_151247_2_) {
		EntityTrackerEntry entitytrackerentry = (EntityTrackerEntry) trackedEntityIDs.lookup(p_151247_1_.getEntityId());
	...
	public void func_151248_b(Entity p_151248_1_, Packet p_151248_2_) {
		EntityTrackerEntry entitytrackerentry = (EntityTrackerEntry) trackedEntityIDs.lookup(p_151248_1_.getEntityId());
	...
	// don't expose the EntityTrackerEntry directly so mods can't mess with the data
	// in there as easily
	/**
