...
public class ContainerRepair extends Container {
	...
	public ContainerRepair(InventoryPlayer p_i1800_1_, final World p_i1800_2_, final int p_i1800_3_,
		...
		addSlotToContainer(new Slot(outputSlot, 2, 134, 47) {
			...
			public void onPickupFromSlot(EntityPlayer p_82870_1_, ItemStack p_82870_2_) {
				...
				if (!p_82870_1_.capabilities.isCreativeMode && !p_i1800_2_.isRemote
		...
		for (i = 0; i < 3; ++i) {
			for (int j = 0; j < 9; ++j) {
				addSlotToContainer(new Slot(p_i1800_1_, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
			}
		}

		for (i = 0; i < 9; ++i) {
			addSlotToContainer(new Slot(p_i1800_1_, i, 8 + i * 18, 142));
		}
	}
	...
	public void updateRepairOutput() {
		...
		if (itemstack == null) {
			...
			if (itemstack2 != null) {
				if (!ForgeHooks.onAnvilChange(this, itemstack, itemstack2, outputSlot, repairedItemName, k2))
					return;
