...
public class Slot {
	...
	/**
	 * Position within background texture file, normally -1 which causes no
	 * background to be drawn.
	 */
	protected IIcon backgroundIcon = null;

	/**
	 * Background texture file assigned to this slot, if any. Vanilla
	 * "/gui/items.png" is used if this is null.
	 */
	 ...
	 */
	/**
	 * Gets the path of the texture file to use for the background image of this
	 * slot when drawing the GUI.
	 *
	 * @return String: The texture file that will be used in
	 *         GuiContainer.drawSlotInventory for the slot background.
	 */
	@SideOnly(Side.CLIENT)
	...
	/**
	 * Sets which icon index to use as the background image of the slot when it's
	 * empty.
	 *
	 * @param icon
	...
	/**
	 * Sets the texture file to use for the background image of the slot when it's
	 * empty.
	 *
	 * @param textureFilename
	 *            String: Path of texture file to use, or null to use
	 *            "/gui/items.png"
	 */
	@SideOnly(Side.CLIENT)
