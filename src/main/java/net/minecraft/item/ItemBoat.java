...
public class ItemBoat extends Item {
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
		...
		if (movingobjectposition == null)
			...
			boolean flag = false;
			float f9 = 1.0F;
			List list = p_77659_2_.getEntitiesWithinAABBExcludingEntity(p_77659_3_, p_77659_3_.boundingBox
			...
			if (flag)
				...
				if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
					...
					PlayerInteractEvent event = CraftEventFactory.callPlayerInteractEvent(p_77659_3_, org.bukkit.event.block.Action.RIGHT_CLICK_BLOCK, i, j, k, movingobjectposition.sideHit, p_77659_1_);
					...
					EntityBoat entityboat = new EntityBoat(p_77659_2_, i + 0.5F, j + 1.0F, k + 0.5F);
					entityboat.rotationYaw = ((MathHelper.floor_double(p_77659_3_.rotationYaw * 4.0F / 360.0F + 0.5D)
							& 3) - 1) * 90;

					if (!p_77659_2_
							.getCollidingBoundingBoxes(entityboat, entityboat.boundingBox.expand(-0.1D, -0.1D, -0.1D))
							.isEmpty())
						return p_77659_1_;
