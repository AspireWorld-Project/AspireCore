...
public class ItemDye extends Item {
			...
			if (p_77648_1_.getItemDamage() == 15) {
				...
				if (block == Blocks.log && BlockLog.func_150165_c(i1) == 3) {
					...
					if (p_77648_3_.isAirBlock(p_77648_4_, p_77648_5_, p_77648_6_)) {
						int j1 = Blocks.cocoa.onBlockPlaced(p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_,
	...
	public static boolean func_150919_a(ItemStack p_150919_0_, World p_150919_1_, int p_150919_2_, int p_150919_3_,
		...
		if (p_150919_1_ instanceof WorldServer)
			return applyBonemeal(p_150919_0_, p_150919_1_, p_150919_2_, p_150919_3_, p_150919_4_,
	...
	public static void func_150918_a(World p_150918_0_, int p_150918_1_, int p_150918_2_, int p_150918_3_,
		...
		if (block.getMaterial() != Material.air) {
			...
			for (int i1 = 0; i1 < p_150918_4_; ++i1) {
				...
				p_150918_0_.spawnParticle("happyVillager", p_150918_1_ + itemRand.nextFloat(),
						p_150918_2_ + itemRand.nextFloat() * block.getBlockBoundsMaxY(),
						p_150918_3_ + itemRand.nextFloat(), d0, d1, d2);
			}
		} else {
			for (int i1 = 0; i1 < p_150918_4_; ++i1) {
				double d0 = itemRand.nextGaussian() * 0.02D;
				...
				double d2 = itemRand.nextGaussian() * 0.02D;
				p_150918_0_.spawnParticle("happyVillager", p_150918_1_ + itemRand.nextFloat(),
						p_150918_2_ + (double) itemRand.nextFloat() * 1.0f, p_150918_3_ + itemRand.nextFloat(), d0, d1,
						d2);
			}
		}
	}
	...
	public void registerIcons(IIconRegister p_94581_1_) {
		...
		for (int i = 0; i < field_150921_b.length; ++i) {
			field_150920_d[i] = p_94581_1_.registerIcon(getIconString() + "_" + field_150921_b[i]);
		}
	}
}