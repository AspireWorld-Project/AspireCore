...
public class ItemFirework extends Item {
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_,
		...
		if (!p_77648_3_.isRemote) {
			EntityFireworkRocket entityfireworkrocket = new EntityFireworkRocket(p_77648_3_, p_77648_4_ + p_77648_8_,
					p_77648_5_ + p_77648_9_, p_77648_6_ + p_77648_10_, p_77648_1_);
		...
		if (p_77624_1_.hasTagCompound()) {
			...
			if (nbttagcompound != null) {
				if (nbttagcompound.hasKey("Flight", 99)) {
					p_77624_3_.add(StatCollector.translateToLocal("item.fireworks.flight") + " "
