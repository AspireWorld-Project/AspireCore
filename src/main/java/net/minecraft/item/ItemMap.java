...
public class ItemMap extends ItemMapBase {
	...
	public MapData getMapData(ItemStack p_77873_1_, World p_77873_2_) {
		...
		if (mapdata == null && !p_77873_2_.isRemote) {
			...
			mapdata.zCenter = Math.round(p_77873_2_.getWorldInfo().getSpawnZ() / i) * i;
	...
	public void updateMapData(World p_77872_1_, Entity p_77872_2_, MapData p_77872_3_) {
		if (p_77872_1_.provider.dimensionId == p_77872_3_.dimension && p_77872_2_ instanceof EntityPlayer) {
			...
			int l = MathHelper.floor_double(p_77872_2_.posX - j) / i + 64;
			int i1 = MathHelper.floor_double(p_77872_2_.posZ - k) / i + 64;
			int j1 = 128 / i;
					...
					for (int j2 = i1 - j1 - 1; j2 < i1 + j1; ++j2) {
						if (k1 >= 0 && j2 >= -1 && k1 < 128 && j2 < 128) {
							...
							if (!chunk.isEmpty()) {
								...
								MapColor mapcolor = Iterables.getFirst(Multisets.copyHighestCountFirst(hashmultiset),
										MapColor.airColor);
	...
	public void onUpdate(ItemStack p_77663_1_, World p_77663_2_, Entity p_77663_3_, int p_77663_4_,
		...
		if (!p_77663_2_.isRemote) {
			...
			if (p_77663_5_) {
				updateMapData(p_77663_2_, p_77663_3_, mapdata);
			}
		}
	}
	...
	public Packet func_150911_c(ItemStack p_150911_1_, World p_150911_2_, EntityPlayer p_150911_3_) {
		byte[] abyte = getMapData(p_150911_1_, p_150911_2_).getUpdatePacketData(p_150911_1_, p_150911_2_, p_150911_3_);
	...
	public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
		MapData mapdata = getMapData(p_77624_1_, p_77624_2_.worldObj);
