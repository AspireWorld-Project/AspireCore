...
public class ItemMonsterPlacer extends Item {
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_,
		...
		if (p_77648_3_.isRemote)
			...
			Entity entity = spawnCreature(p_77648_3_, p_77648_1_.getItemDamage(), p_77648_4_ + 0.5D, p_77648_5_ + d0,
					p_77648_6_ + 0.5D);
		...
		if (!EntityList.entityEggs.containsKey(Integer.valueOf(p_77840_1_)))
			...
			for (int j = 0; j < 1; ++j) {
				...
				if (entity != null && entity instanceof EntityLivingBase) {
					...
					entity.setLocationAndAngles(p_77840_2_, p_77840_4_, p_77840_6_,
