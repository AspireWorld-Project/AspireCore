...
public class ItemPotion extends Item {
	...
	public List getEffects(ItemStack p_77832_1_) {
		if (p_77832_1_.hasTagCompound() && p_77832_1_.getTagCompound().hasKey("CustomPotionEffects", 9)) {
			...
			List list = (List) effectCache.get(Integer.valueOf(p_77832_1_.getItemDamage()));

			if (list == null) {
				list = PotionHelper.getPotionEffects(p_77832_1_.getItemDamage(), false);
				effectCache.put(Integer.valueOf(p_77832_1_.getItemDamage()), list);
			}
	...
	public List getEffects(int p_77834_1_) {
		List list = (List) effectCache.get(Integer.valueOf(p_77834_1_));

		if (list == null) {
			list = PotionHelper.getPotionEffects(p_77834_1_, false);
			effectCache.put(Integer.valueOf(p_77834_1_), list);
		}
	...
	public IIcon getIconFromDamageForRenderPass(int p_77618_1_, int p_77618_2_) {
		return p_77618_2_ == 0 ? field_94592_ct : super.getIconFromDamageForRenderPass(p_77618_1_, p_77618_2_);
	}
	...
	public int getColorFromItemStack(ItemStack p_82790_1_, int p_82790_2_) {
		return p_82790_2_ > 0 ? 16777215 : getColorFromDamage(p_82790_1_.getItemDamage());
	}
	...
	public void registerIcons(IIconRegister p_94581_1_) {
		field_94590_d = p_94581_1_.registerIcon(getIconString() + "_" + "bottle_drinkable");
		field_94591_c = p_94581_1_.registerIcon(getIconString() + "_" + "bottle_splash");
		field_94592_ct = p_94581_1_.registerIcon(getIconString() + "_" + "overlay");
	}
