...
public class ItemRecord extends Item {
	...
	protected ItemRecord(String p_i45350_1_) {
		...
		field_150928_b.put("records." + p_i45350_1_, this); // Forge Bug Fix: RenderGlobal adds a "records." when
															// looking up below.
	}
		...
		if (p_77648_3_.getBlock(p_77648_4_, p_77648_5_, p_77648_6_) == Blocks.jukebox
			...
			if (p_77648_3_.isRemote)
				...
				((BlockJukebox) Blocks.jukebox).func_149926_b(p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_,
						p_77648_1_);
				p_77648_3_.playAuxSFXAtEntity(null, 1005, p_77648_4_, p_77648_5_, p_77648_6_,
