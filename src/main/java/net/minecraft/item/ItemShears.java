...
public class ItemShears extends Item {
	...
	public boolean onBlockDestroyed(ItemStack p_150894_1_, World p_150894_2_, Block p_150894_3_, int p_150894_4_,
		...
		if (p_150894_3_.getMaterial() != Material.leaves && p_150894_3_ != Blocks.web && p_150894_3_ != Blocks.tallgrass
				&& p_150894_3_ != Blocks.vine && p_150894_3_ != Blocks.tripwire && !(p_150894_3_ instanceof IShearable))
	...
	public boolean itemInteractionForEntity(ItemStack itemstack, EntityPlayer player, EntityLivingBase entity) {
		...
		if (entity instanceof IShearable) {
			...
			if (target.isShearable(itemstack, entity.worldObj, (int) entity.posX, (int) entity.posY,
					(int) entity.posZ)) {
				PlayerShearEntityEvent event = new PlayerShearEntityEvent((Player) player.getBukkitEntity(),
