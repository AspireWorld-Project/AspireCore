...
public class ItemSkull extends Item {
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_,
		...
		if (p_77648_3_.getBlock(p_77648_4_, p_77648_5_, p_77648_6_).isReplaceable(p_77648_3_, p_77648_4_, p_77648_5_,
				p_77648_6_) && p_77648_7_ != 0) {
			p_77648_7_ = 1;
			p_77648_5_--;
		}
		if (p_77648_7_ == 0)
			return false;
				...
				&& !p_77648_3_.isSideSolid(p_77648_4_, p_77648_5_, p_77648_6_,
						net.minecraftforge.common.util.ForgeDirection.getOrientation(p_77648_7_)))
			return false;
		else {
			if (p_77648_7_ == 1) {
				++p_77648_5_;
		...
		}
		{
			if (!p_77648_3_.isRemote) {
				if (!Blocks.skull.canPlaceBlockOnSide(p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_))
					return false;
	...
	public void registerIcons(IIconRegister p_94581_1_) {
		...
		for (int i = 0; i < field_94587_a.length; ++i) {
			field_94586_c[i] = p_94581_1_.registerIcon(getIconString() + "_" + field_94587_a[i]);
		}
	}
}