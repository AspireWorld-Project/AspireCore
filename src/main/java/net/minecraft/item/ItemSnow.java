	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_,
		...
		if (p_77648_1_.stackSize == 0)
			...
			if (block == Blocks.snow_layer) {
				...
				if (j1 <= 6
						&& p_77648_3_.checkNoEntityCollision(field_150939_a.getCollisionBoundingBoxFromPool(p_77648_3_,
								p_77648_4_, p_77648_5_, p_77648_6_))
						&& p_77648_3_.setBlockMetadataWithNotify(p_77648_4_, p_77648_5_, p_77648_6_, j1 + 1 | i1 & -8,
								2)) {
