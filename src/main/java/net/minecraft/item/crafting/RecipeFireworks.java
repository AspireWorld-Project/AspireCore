	...
	public boolean matches(InventoryCrafting p_77569_1_, World p_77569_2_) {
		...
		if (j <= 3 && i <= 1) {
			...
			if (j >= 1 && i == 1 && i1 == 0) {
				...
				field_92102_a.setTagCompound(nbttagcompound); // Forge BugFix: NPE Protection
				...
				if (field_92102_a != null && field_92102_a.hasTagCompound()) {
					NBTTagCompound nbttagcompound2 = field_92102_a.getTagCompound().getCompoundTag("Explosion");
