...
public class NetworkStatistics {
	...
	static class PacketStatData {
		...
		public NetworkStatistics.PacketStatData func_152494_a(long p_152494_1_) {
			return new NetworkStatistics.PacketStatData(p_152494_1_ + field_152496_a, field_152497_b + 1,
		...
		@Override
		public String toString() {
			return "{totalBytes=" + field_152496_a + ", count=" + field_152497_b + ", averageBytes=" + field_152498_c
					+ '}';
		}
	...
	static class Tracker {
		...
		public Tracker() {
			for (int i = 0; i < 100; ++i) {
				field_152490_a[i] = new AtomicReference(new NetworkStatistics.PacketStatData(0L, 0, 0.0D, null));
			}
		}
		...
		public void func_152488_a(int p_152488_1_, long p_152488_2_) {
			try {
				...
				do {
					packetstatdata = (NetworkStatistics.PacketStatData) field_152490_a[p_152488_1_].get();
					packetstatdata1 = packetstatdata.func_152494_a(p_152488_2_);
				} while (!field_152490_a[p_152488_1_].compareAndSet(packetstatdata, packetstatdata1));
				...
				if (NetworkStatistics.field_152478_a.isDebugEnabled()) {
					NetworkStatistics.field_152478_a.debug(NetworkStatistics.field_152479_b,
							"NetStat failed with packetId: " + p_152488_1_, exception);
				}
			}
		}
		...
		public long func_152485_a() {
			...
			for (int j = 0; j < 100; ++j) {
				i += ((NetworkStatistics.PacketStatData) field_152490_a[j].get()).func_152493_a();
			}
		...
		public long func_152489_b() {
			...
			for (int j = 0; j < 100; ++j) {
				i += ((NetworkStatistics.PacketStatData) field_152490_a[j].get()).func_152495_b();
			}
		...
		public NetworkStatistics.PacketStat func_152484_c() {
			...
			for (int j = 0; j < 100; ++j) {
				NetworkStatistics.PacketStatData packetstatdata1 = (NetworkStatistics.PacketStatData) field_152490_a[j]
						.get();
		...
		public NetworkStatistics.PacketStat func_152487_a(int p_152487_1_) {
			return p_152487_1_ >= 0 && p_152487_1_ < 100
					? new NetworkStatistics.PacketStat(p_152487_1_,
							(NetworkStatistics.PacketStatData) field_152490_a[p_152487_1_].get())
					: null;
		}
	}
}