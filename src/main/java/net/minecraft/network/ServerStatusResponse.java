		...
		public static class Serializer implements JsonDeserializer, JsonSerializer {
			...
			public ServerStatusResponse.MinecraftProtocolVersionIdentifier deserialize(JsonElement p_deserialize_1_,
				...
				return new ServerStatusResponse.MinecraftProtocolVersionIdentifier(
						JsonUtils.getJsonObjectStringFieldValue(jsonobject, "name"),
						JsonUtils.getJsonObjectIntegerFieldValue(jsonobject, "protocol"));
			}
	...
	public static class PlayerCountData {
		...
		public static class Serializer implements JsonDeserializer, JsonSerializer {
			...
			public ServerStatusResponse.PlayerCountData deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
				...
				ServerStatusResponse.PlayerCountData playercountdata = new ServerStatusResponse.PlayerCountData(
						JsonUtils.getJsonObjectIntegerFieldValue(jsonobject, "max"),
						JsonUtils.getJsonObjectIntegerFieldValue(jsonobject, "online"));
				...
				if (JsonUtils.jsonObjectFieldTypeIsArray(jsonobject, "sample")) {
					...
					if (jsonarray.size() > 0) {
						...
						for (int i = 0; i < agameprofile.length; ++i) {
							JsonObject jsonobject1 = JsonUtils.getJsonElementAsJsonObject(jsonarray.get(i),
									"player[" + i + "]");
