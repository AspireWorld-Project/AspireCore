...
public class RealmsScreen {
	...
	public static void blit(int p_blit_0_, int p_blit_1_, float p_blit_2_, float p_blit_3_, int p_blit_4_,
		...
		Gui.func_152125_a(p_blit_0_, p_blit_1_, p_blit_2_, p_blit_3_, p_blit_4_, p_blit_5_, p_blit_6_, p_blit_7_,
				p_blit_8_, p_blit_9_);
	}
	...
	public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
		for (int k = 0; k < proxy.func_154320_j().size(); ++k) {
			((RealmsButton) proxy.func_154320_j().get(k)).render(p_render_1_, p_render_2_);
		}
	}
	...
	public void renderTooltip(List p_renderTooltip_1_, int p_renderTooltip_2_, int p_renderTooltip_3_) {
		proxy.func_146283_a(p_renderTooltip_1_, p_renderTooltip_2_, p_renderTooltip_3_);
	}
	...
	public RealmsEditBox newEditBox(int p_newEditBox_1_, int p_newEditBox_2_, int p_newEditBox_3_,
			int p_newEditBox_4_) {
