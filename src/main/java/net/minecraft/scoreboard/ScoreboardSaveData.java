...
public class ScoreboardSaveData extends WorldSavedData {
	...
	protected void func_96498_a(NBTTagList p_96498_1_) {
		for (int i = 0; i < p_96498_1_.tagCount(); ++i) {
			...
			ScorePlayerTeam scoreplayerteam = theScoreboard.createTeam(nbttagcompound.getString("Name"));
	...
	protected void func_96502_a(ScorePlayerTeam p_96502_1_, NBTTagList p_96502_2_) {
		for (int i = 0; i < p_96502_2_.tagCount(); ++i) {
			theScoreboard.func_151392_a(p_96502_2_.getStringTagAt(i), p_96502_1_.getRegisteredName());
		}
	}
	...
	protected void func_96504_c(NBTTagCompound p_96504_1_) {
		for (int i = 0; i < 3; ++i) {
			if (p_96504_1_.hasKey("slot_" + i, 8)) {
				...
				theScoreboard.func_96530_a(i, scoreobjective);
			}
		}
	}
	...
	protected void func_96501_b(NBTTagList p_96501_1_) {
		for (int i = 0; i < p_96501_1_.tagCount(); ++i) {
			...
			ScoreObjective scoreobjective = theScoreboard.addScoreObjective(nbttagcompound.getString("Name"),
	...
	protected void func_96500_c(NBTTagList p_96500_1_) {
		for (int i = 0; i < p_96500_1_.tagCount(); ++i) {
			...
			Score score = theScoreboard.func_96529_a(nbttagcompound.getString("Name"), scoreobjective);
	...
	protected NBTTagList func_96496_a() {
		...
		Collection collection = theScoreboard.getTeams();
	...
	protected void func_96497_d(NBTTagCompound p_96497_1_) {
		...
		for (int i = 0; i < 3; ++i) {
			ScoreObjective scoreobjective = theScoreboard.func_96539_a(i);
	...
	protected NBTTagList func_96505_b() {
		NBTTagList nbttaglist = new NBTTagList();
		Collection collection = theScoreboard.getScoreObjectives();
		Iterator iterator = collection.iterator();
	...
	protected NBTTagList func_96503_e() {
		NBTTagList nbttaglist = new NBTTagList();
		Collection collection = theScoreboard.func_96528_e();
		Iterator iterator = collection.iterator();
