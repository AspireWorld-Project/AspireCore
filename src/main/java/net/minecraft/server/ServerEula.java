...
public class ServerEula {
	...
	public ServerEula(File p_i1227_1_) {
		field_154350_b = p_i1227_1_;
		field_154351_c = func_154347_a(p_i1227_1_);
	}
	...
	public void func_154348_b() {
		...
		try {
			Properties properties = new Properties();
			fileoutputstream = new FileOutputStream(field_154350_b);
			properties.setProperty("eula", "false");
			properties.store(fileoutputstream,
					"By changing the setting below to TRUE you are indicating your agreement to our EULA (https://account.mojang.com/documents/minecraft_eula).");
		} catch (Exception exception) {
			field_154349_a.warn("Failed to save " + field_154350_b, exception);
		} finally {
