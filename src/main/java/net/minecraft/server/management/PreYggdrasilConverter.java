				...
				ProfileLookupCallback profilelookupcallback = new ProfileLookupCallback() {
					...
					public void onProfileLookupSucceeded(GameProfile p_onProfileLookupSucceeded_1_) {
						...
						String[] astring = (String[]) hashmap
								.get(p_onProfileLookupSucceeded_1_.getName().toLowerCase(Locale.ROOT));

						if (astring == null) {
							PreYggdrasilConverter.field_152732_e.warn("Could not convert user banlist entry for "
							...
							userlistbans.func_152687_a(
									new UserListBansEntry(p_onProfileLookupSucceeded_1_, date, s, date1, s1));
						}
					}
					...
					public void onProfileLookupFailed(GameProfile p_onProfileLookupFailed_1_,
							Exception p_onProfileLookupFailed_2_) {
						PreYggdrasilConverter.field_152732_e.warn(
								"Could not lookup user banlist entry for " + p_onProfileLookupFailed_1_.getName(),
								p_onProfileLookupFailed_2_);

						if (!(p_onProfileLookupFailed_2_ instanceof ProfileNotFoundException))
							throw new PreYggdrasilConverter.ConversionError("Could not request user "
									+ p_onProfileLookupFailed_1_.getName() + " from backend systems",
									p_onProfileLookupFailed_2_, null);
					}
				};
			...
			try {
				...
				ProfileLookupCallback profilelookupcallback = new ProfileLookupCallback() {
					...
					public void onProfileLookupSucceeded(GameProfile p_onProfileLookupSucceeded_1_) {
						...
						userlistops.func_152687_a(new UserListOpsEntry(p_onProfileLookupSucceeded_1_,
								p_152718_0_.getOpPermissionLevel()));
					}
					...
					public void onProfileLookupFailed(GameProfile p_onProfileLookupFailed_1_,
							Exception p_onProfileLookupFailed_2_) {
						PreYggdrasilConverter.field_152732_e.warn(
								"Could not lookup oplist entry for " + p_onProfileLookupFailed_1_.getName(),
								p_onProfileLookupFailed_2_);
			...
			try {
				...
				ProfileLookupCallback profilelookupcallback = new ProfileLookupCallback() {
					...
					public void onProfileLookupSucceeded(GameProfile p_onProfileLookupSucceeded_1_) {
						...
						if (uuid == null)
							throw new PreYggdrasilConverter.ConversionError(
									"Missing UUID for user profile " + p_onProfileLookupSucceeded_1_.getName(), null);
						else {
							func_152743_a(file2, func_152744_a(p_onProfileLookupSucceeded_1_), uuid.toString());
						}
					}
					...
					public void onProfileLookupFailed(GameProfile p_onProfileLookupFailed_1_,
							Exception p_onProfileLookupFailed_2_) {
						PreYggdrasilConverter.field_152732_e.warn(
								"Could not lookup user uuid for " + p_onProfileLookupFailed_1_.getName(),
								p_onProfileLookupFailed_2_);

						if (p_onProfileLookupFailed_2_ instanceof ProfileNotFoundException) {
							String s2 = func_152744_a(p_onProfileLookupFailed_1_);
							func_152743_a(file3, s2, s2);
						} else
							throw new PreYggdrasilConverter.ConversionError("Could not request user "
									+ p_onProfileLookupFailed_1_.getName() + " from backend systems",
									p_onProfileLookupFailed_2_, null);
					...
					private String func_152744_a(GameProfile p_152744_1_) {
						...
						if (s2 == null)
							throw new PreYggdrasilConverter.ConversionError(
									"Could not find the filename for " + p_152744_1_.getName() + " anymore", null);
						else
							return s2;
					}
				};
