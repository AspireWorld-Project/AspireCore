...
public class UserListBansEntry extends BanEntry {
	...
	protected void func_152641_a(JsonObject p_152641_1_) {
		if (func_152640_f() != null) {
			p_152641_1_.addProperty("uuid", ((GameProfile) func_152640_f()).getId() == null ? ""
					: ((GameProfile) func_152640_f()).getId().toString());
			p_152641_1_.addProperty("name", ((GameProfile) func_152640_f()).getName());
