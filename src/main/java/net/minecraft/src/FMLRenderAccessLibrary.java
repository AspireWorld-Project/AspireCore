...
/**
 *
 * A static hook library for optifine and other basemod editing code to access
 * FML functions
 *
 * @author cpw
 *
...
public class FMLRenderAccessLibrary {
	...
	// public static void doTextureCopy(Texture atlas, Texture source, int targetX,
	// int targetY)
	// {
	// TextureFXManager.instance().getHelper().doTextureCopy(atlas, source, targetX,
	// targetY);
	// }
}