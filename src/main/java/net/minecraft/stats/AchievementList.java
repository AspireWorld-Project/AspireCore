...
public class AchievementList {
	...
	public static Achievement portal = new Achievement("achievement.portal", "portal", -1, 7, Blocks.obsidian, diamonds)
			.registerStat();
	...
	public static Achievement blazeRod = new Achievement("achievement.blazeRod", "blazeRod", 0, 9, Items.blaze_rod,
			portal).registerStat();
	public static Achievement potion = new Achievement("achievement.potion", "potion", 2, 8, Items.potionitem, blazeRod)
			.registerStat();
	public static Achievement theEnd = new Achievement("achievement.theEnd", "theEnd", 3, 10, Items.ender_eye, blazeRod)
			.setSpecial().registerStat();
	...
	public static Achievement overkill = new Achievement("achievement.overkill", "overkill", -4, 1, Items.diamond_sword,
