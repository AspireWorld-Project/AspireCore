		...
		Thread thread = new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					float f = 0.0F;
					float f1 = p_151223_3_.entrySet().size();
					...
					if (p_151223_4_ > 0 && f1 > p_151223_4_) {
						if (p_151223_5_ != null) {
							p_151223_5_.func_146586_a();
						}

						throw new IOException("Filesize is bigger than maximum allowed (file is " + f + ", limit is "
								+ p_151223_4_ + ")");
					}
					...
					while ((k = inputstream.read(abyte)) >= 0) {
						...
						if (p_151223_4_ > 0 && f > p_151223_4_) {
							if (p_151223_5_ != null) {
								p_151223_5_.func_146586_a();
							}
