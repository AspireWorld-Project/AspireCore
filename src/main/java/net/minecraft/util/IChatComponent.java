			...
			if (p_deserialize_1_.isJsonPrimitive())
				...
				if (p_deserialize_1_.isJsonArray()) {
					...
					while (iterator.hasNext()) {
						...
						IChatComponent ichatcomponent1 = deserialize(jsonelement1, jsonelement1.getClass(),
								p_deserialize_3_);
				...
				if (jsonobject.has("extra")) {
					...
					for (int j = 0; j < jsonarray2.size(); ++j) {
						((IChatComponent) object)
								.appendSibling(deserialize(jsonarray2.get(j), p_deserialize_2_, p_deserialize_3_));
					}
				}
		...
		public JsonElement serialize(IChatComponent p_serialize_1_, Type p_serialize_2_,
			...
			if (p_serialize_1_ instanceof ChatComponentText && p_serialize_1_.getChatStyle().isEmpty()
				...
				if (!p_serialize_1_.getChatStyle().isEmpty()) {
					func_150695_a(p_serialize_1_.getChatStyle(), jsonobject, p_serialize_3_);
				}
