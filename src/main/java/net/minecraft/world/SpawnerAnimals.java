...
public final class SpawnerAnimals {
				...
				if ((!enumcreaturetype.getPeacefulCreature() || p_77192_3_)
					...
					while (iterator.hasNext()) {
						...
						if (!((Boolean) eligibleChunksForSpawning.get(chunkcoordintpair1)).booleanValue()) {
							...
							if (!p_77192_1_.getBlock(j1, k1, l1).isNormalCube() && p_77192_1_.getBlock(j1, k1, l1)
									...
									while (true) {
										if (j3 < 4) {
											label103: {
												...
												if (canCreatureTypeSpawnAtLocation(enumcreaturetype, p_77192_1_, k2, l2,
														i3)) {
													float f = k2 + 0.5F;
													float f1 = l2;
													float f2 = i3 + 0.5F;
	...
	public static boolean canCreatureTypeSpawnAtLocation(EnumCreatureType p_77190_0_, World p_77190_1_, int p_77190_2_,
		...
		if (!p_77190_1_.blockExists(p_77190_2_, p_77190_3_, p_77190_4_))
			return false;
		...
		if (!list.isEmpty()) {
			while (p_77191_6_.nextFloat() < p_77191_1_.getSpawningChance()) {
				...
				int i1 = spawnlistentry.minGroupCount
						+ p_77191_6_.nextInt(1 + spawnlistentry.maxGroupCount - spawnlistentry.minGroupCount);
				...
				for (int j2 = 0; j2 < i1; ++j2) {
					...
					for (int k2 = 0; !flag && k2 < 4; ++k2) {
						...
						for (k1 += p_77191_6_.nextInt(5) - p_77191_6_.nextInt(5); j1 < p_77191_2_
								|| j1 >= p_77191_2_ + p_77191_4_ || k1 < p_77191_3_
								|| k1 >= p_77191_3_ + p_77191_4_; k1 = i2 + p_77191_6_.nextInt(5)
