...
public abstract class WorldProvider {
	...
	public float calculateCelestialAngle(long p_76563_1_, float p_76563_3_) {
		...
		float f1 = (j + p_76563_3_) / 24000.0F - 0.25F;
	...
	public float getCloudHeight() {
		return terrainType.getCloudHeight();
	}
	...
	public int getAverageGroundLevel() {
		return terrainType.getMinimumSpawnHeight(worldObj);
	}
	...
	/**
	 * The dimensions movement factor. Relative to normal overworld. It is applied
	 * to the players position when they transfer dimensions. Exa: Nether movement
	 * is 8.0
	 *
	...
	/**
	 * Determine if the cusor on the map should 'spin' when rendered, like it does
	 * for the player in the nether.
	 *
	 * @param entity
	 ...
	 * all, and 1.0f means maximum sunlight. This will be used for the
	...
	/**
	 * Calculates the current moon phase factor. This factor is effective for
	 * slimes. (This method do not affect the moon rendering)
	 */
