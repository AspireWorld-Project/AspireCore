...
public abstract class BiomeGenBase {
	...
	public static final BiomeGenBase taiga = new BiomeGenTaiga(5, 0).setColor(747097).setBiomeName("Taiga")
			.func_76733_a(5159473).setTemperatureRainfall(0.25F, 0.8F).setHeight(height_MidPlains);
	public static final BiomeGenBase swampland = new BiomeGenSwamp(6).setColor(522674).setBiomeName("Swampland")
			.func_76733_a(9154376).setHeight(height_PartiallySubmerged).setTemperatureRainfall(0.8F, 0.9F);
	...
	public static final BiomeGenBase frozenRiver = new BiomeGenRiver(11).setColor(10526975).setBiomeName("FrozenRiver")
			.setEnableSnow().setHeight(height_ShallowWaters).setTemperatureRainfall(0.0F, 0.5F);
	...
	public static final BiomeGenBase desertHills = new BiomeGenDesert(17).setColor(13786898).setBiomeName("DesertHills")
			.setDisableRain().setTemperatureRainfall(2.0F, 0.0F).setHeight(height_LowHills);
	...
	public static final BiomeGenBase taigaHills = new BiomeGenTaiga(19, 0).setColor(1456435).setBiomeName("TaigaHills")
			.func_76733_a(5159473).setTemperatureRainfall(0.25F, 0.8F).setHeight(height_LowHills);
	...
	public static final BiomeGenBase coldTaiga = new BiomeGenTaiga(30, 0).setColor(3233098).setBiomeName("Cold Taiga")
			.func_76733_a(5159473).setEnableSnow().setTemperatureRainfall(-0.5F, 0.4F).setHeight(height_MidPlains)
	...
	public static final BiomeGenBase megaTaiga = new BiomeGenTaiga(32, 1).setColor(5858897).setBiomeName("Mega Taiga")
			.func_76733_a(5159473).setTemperatureRainfall(0.3F, 0.8F).setHeight(height_MidPlains);
	...
	public BiomeGenBase(int p_i1971_1_, boolean register) {
		...
		rootHeight = height_Default.rootHeight;
		heightVariation = height_Default.variation;
		temperature = 0.5F;
		rainfall = 0.5F;
	...
	public final BiomeGenBase setHeight(BiomeGenBase.Height p_150570_1_) {
		rootHeight = p_150570_1_.rootHeight;
		heightVariation = p_150570_1_.variation;
		return this;
	}
		...
		return p_76747_1_ == EnumCreatureType.monster ? spawnableMonsterList
				: p_76747_1_ == EnumCreatureType.creature ? spawnableCreatureList
						: p_76747_1_ == EnumCreatureType.waterCreature ? spawnableWaterCreatureList
								: p_76747_1_ == EnumCreatureType.ambient ? spawnableCaveCreatureList : null;
	}
	...
	public final float getFloatTemperature(int p_150564_1_, int p_150564_2_, int p_150564_3_) {
		if (p_150564_2_ > 64) {
			float f = (float) temperatureNoise.func_151601_a(p_150564_1_ * 1.0D / 8.0D, p_150564_3_ * 1.0D / 8.0D)
					* 4.0F;
			return temperature - (f + p_150564_2_ - 64.0F) * 0.05F / 30.0F;
		} else
			return temperature;
	}
	...
	public int getBiomeGrassColor(int p_150558_1_, int p_150558_2_, int p_150558_3_) {
		double d0 = MathHelper.clamp_float(getFloatTemperature(p_150558_1_, p_150558_2_, p_150558_3_), 0.0F, 1.0F);
	...
	public int getBiomeFoliageColor(int p_150571_1_, int p_150571_2_, int p_150571_3_) {
		double d0 = MathHelper.clamp_float(getFloatTemperature(p_150571_1_, p_150571_2_, p_150571_3_), 0.0F, 1.0F);
		double d1 = MathHelper.clamp_float(getFloatRainfall(), 0.0F, 1.0F);
	...
	public BiomeGenBase.TempCategory getTempCategory() {
		return temperature < 0.2D ? BiomeGenBase.TempCategory.COLD
				: temperature < 1.0D ? BiomeGenBase.TempCategory.MEDIUM : BiomeGenBase.TempCategory.WARM;
	}
	...
	/**
	 * Weighted random holder class used to hold possible flowers that can spawn in
	 * this biome when bonemeal is used on grass.
	 */
	...
	/**
	 * Adds the default flowers, as of 1.7, it is 2 yellow, and 1 red. I chose 10 to
	 * allow some wiggle room in the numbers.
	 */
	...
	public void addFlower(Block block, int metadata, int weight) {
		flowers.add(new FlowerEntry(block, metadata, weight));
	}

	public void plantFlower(World world, Random rand, int x, int y, int z) {
		BiomeGenBase biome = world.getBiomeGenForCoords(x, z);
		biome.func_150572_a(rand, x, y, z);
