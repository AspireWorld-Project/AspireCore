...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public ChunkProviderGenerate(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_) {
		...
		noiseGens = TerrainGen.getModdedNoiseGenerators(p_i2006_1_, rand, noiseGens);
	...
	public void replaceBlocksForBiome(int p_147422_1_, int p_147422_2_, Block[] p_147422_3_, byte[] p_147422_4_,
		...
		ChunkProviderEvent.ReplaceBiomeBlocks event = new ChunkProviderEvent.ReplaceBiomeBlocks(this, p_147422_1_,
				p_147422_2_, p_147422_3_, p_147422_4_, p_147422_5_, worldObj);
		...
		for (int k = 0; k < 16; ++k) {
			for (int l = 0; l < 16; ++l) {
				...
				biomegenbase.genTerrainBlocks(worldObj, rand, p_147422_3_, p_147422_4_, p_147422_1_ * 16 + k,
	...
	public Chunk provideChunk(int p_73154_1_, int p_73154_2_) {
		...
		func_147424_a(p_73154_1_, p_73154_2_, ablock);
	...
	public List getPossibleCreatures(EnumCreatureType p_73155_1_, int p_73155_2_, int p_73155_3_, int p_73155_4_) {
		...
		return p_73155_1_ == EnumCreatureType.monster
				&& scatteredFeatureGenerator.func_143030_a(p_73155_2_, p_73155_3_, p_73155_4_)
	...
	public ChunkPosition func_147416_a(World p_147416_1_, String p_147416_2_, int p_147416_3_, int p_147416_4_,
			int p_147416_5_) {
		return "Stronghold".equals(p_147416_2_) && strongholdGenerator != null
				? strongholdGenerator.func_151545_a(p_147416_1_, p_147416_3_, p_147416_4_, p_147416_5_)
				: null;
	}
