...
public class NoiseGeneratorOctaves extends NoiseGenerator {
	...
	public NoiseGeneratorOctaves(Random p_i2111_1_, int p_i2111_2_) {
		...
		for (int j = 0; j < p_i2111_2_; ++j) {
			generatorCollection[j] = new NoiseGeneratorImproved(p_i2111_1_);
		}
	}
	...
	public double[] generateNoiseOctaves(double[] p_76304_1_, int p_76304_2_, int p_76304_3_, int p_76304_4_,
		...
		for (int l1 = 0; l1 < octaves; ++l1) {
			...
			d3 += i2;
			d5 += j2;
			generatorCollection[l1].populateNoiseArray(p_76304_1_, d3, d4, d5, p_76304_5_, p_76304_6_, p_76304_7_,
					p_76304_8_ * d6, p_76304_10_ * d6, p_76304_12_ * d6, d6);
			d6 /= 2.0D;
		}
