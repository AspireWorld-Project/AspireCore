...
public class NoiseGeneratorPerlin extends NoiseGenerator {
	...
	public NoiseGeneratorPerlin(Random p_i45470_1_, int p_i45470_2_) {
		...
		for (int j = 0; j < p_i45470_2_; ++j) {
			field_151603_a[j] = new NoiseGeneratorSimplex(p_i45470_1_);
		}
	}
	...
	public double func_151601_a(double p_151601_1_, double p_151601_3_) {
		...
		for (int i = 0; i < field_151602_b; ++i) {
			d2 += field_151603_a[i].func_151605_a(p_151601_1_ * d3, p_151601_3_ * d3) / d3;
			d3 /= 2.0D;
		}
	...
	public double[] func_151600_a(double[] p_151600_1_, double p_151600_2_, double p_151600_4_, int p_151600_6_,
		...
		for (int l = 0; l < field_151602_b; ++l) {
			field_151603_a[l].func_151606_a(p_151600_1_, p_151600_2_, p_151600_4_, p_151600_6_, p_151600_7_,
					p_151600_8_ * d6 * d7, p_151600_10_ * d6 * d7, 0.55D / d7);
			d6 *= p_151600_12_;
			d7 *= p_151600_14_;
		}
