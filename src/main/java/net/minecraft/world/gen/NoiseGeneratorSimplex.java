...
public class NoiseGeneratorSimplex {
	...
	public NoiseGeneratorSimplex(Random p_i45471_1_) {
		...
		for (i = 0; i < 256; field_151608_f[i] = i++) {
        }

		for (i = 0; i < 256; ++i) {
			int j = p_i45471_1_.nextInt(256 - i) + i;
			int k = field_151608_f[i];
			field_151608_f[i] = field_151608_f[j];
			field_151608_f[j] = k;
			field_151608_f[i + 256] = field_151608_f[i];
		}
	}
	...
	public double func_151605_a(double p_151605_1_, double p_151605_3_) {
		...
		int k = i & 255;
		int l = j & 255;
		int i1 = field_151608_f[k + field_151608_f[l]] % 12;
		int j1 = field_151608_f[k + b0 + field_151608_f[l + b1]] % 12;
		int k1 = field_151608_f[k + 1 + field_151608_f[l + 1]] % 12;
	...
	public void func_151606_a(double[] p_151606_1_, double p_151606_2_, double p_151606_4_, int p_151606_6_,
		...
		for (int l = 0; l < p_151606_7_; ++l) {
			double d5 = (p_151606_4_ + l) * p_151606_10_ + field_151613_c;

			for (int i1 = 0; i1 < p_151606_6_; ++i1) {
				double d6 = (p_151606_2_ + i1) * p_151606_8_ + field_151612_b;
				...
				int k2 = field_151608_f[l1 + b0 + field_151608_f[i2 + b1]] % 12;
