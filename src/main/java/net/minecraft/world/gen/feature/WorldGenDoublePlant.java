...
public class WorldGenDoublePlant extends WorldGenerator {
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
		...
		for (int l = 0; l < 64; ++l) {
			...
			if (p_76484_1_.isAirBlock(i1, j1, k1) && (!p_76484_1_.provider.hasNoSky || j1 < 254)
					&& Blocks.double_plant.canPlaceBlockAt(p_76484_1_, i1, j1, k1)) {
				Blocks.double_plant.func_149889_c(p_76484_1_, i1, j1, k1, field_150549_a, 2);
				flag = true;
			}
		}
