		...
		if (p_76484_1_.isAirBlock(p_76484_3_, p_76484_4_, p_76484_5_)
			...
			for (j1 = p_76484_3_ - i1; j1 <= p_76484_3_ + i1; ++j1) {
				for (k1 = p_76484_5_ - i1; k1 <= p_76484_5_ + i1; ++k1) {
					...
					if (l1 * l1 + i2 * i2 <= i1 * i1 + 1
							&& p_76484_1_.getBlock(j1, p_76484_4_ - 1, k1) != field_150520_a)
						return false;
				}
			}
			...
			entityendercrystal.setLocationAndAngles(p_76484_3_ + 0.5F, p_76484_4_ + l, p_76484_5_ + 0.5F,
					p_76484_2_.nextFloat() * 360.0F, 0.0F);
