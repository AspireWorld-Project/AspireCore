...
public class WorldGenSwamp extends WorldGenAbstractTree {
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
		...
		if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256) {
			...
			if (!flag)
				...
				boolean isSoil = block1.canSustainPlant(p_76484_1_, p_76484_3_, p_76484_4_ - 1, p_76484_5_,
						ForgeDirection.UP, (BlockSapling) Blocks.sapling);
				if (isSoil && p_76484_4_ < 256 - l - 1) {
					block1.onPlantGrow(p_76484_1_, p_76484_3_, p_76484_4_ - 1, p_76484_5_, p_76484_3_, p_76484_4_,
							p_76484_5_);
					int l1;
					int k2;
					int l2;
						...
						for (l2 = p_76484_3_ - k1; l2 <= p_76484_3_ + k1; ++l2) {
							...
							for (int i2 = p_76484_5_ - k1; i2 <= p_76484_5_ + k1; ++i2) {
								...
								if ((Math.abs(l1) != k1 || Math.abs(j2) != k1 || p_76484_2_.nextInt(2) != 0 && j1 != 0)
										&& p_76484_1_.getBlock(l2, k2, i2).canBeReplacedByLeaves(p_76484_1_, l2, k2,
												i2)) {
									func_150515_a(p_76484_1_, l2, k2, i2, Blocks.leaves);
								}
							}
						}
					}
					...
					for (k2 = 0; k2 < l; ++k2) {
						...
						if (block2.isAir(p_76484_1_, p_76484_3_, p_76484_4_ + k2, p_76484_5_)
							...
							func_150515_a(p_76484_1_, p_76484_3_, p_76484_4_ + k2, p_76484_5_, Blocks.log);
						}
					}
							...
							for (l1 = p_76484_5_ - k1; l1 <= p_76484_5_ + k1; ++l1) {
								if (p_76484_1_.getBlock(l2, k2, l1).isLeaves(p_76484_1_, l2, k2, l1)) {
									if (p_76484_2_.nextInt(4) == 0
											&& p_76484_1_.getBlock(l2 - 1, k2, l1).isAir(p_76484_1_, l2 - 1, k2, l1)) {
										generateVines(p_76484_1_, l2 - 1, k2, l1, 8);
									}

									if (p_76484_2_.nextInt(4) == 0
											&& p_76484_1_.getBlock(l2 + 1, k2, l1).isAir(p_76484_1_, l2 + 1, k2, l1)) {
										generateVines(p_76484_1_, l2 + 1, k2, l1, 2);
									}

									if (p_76484_2_.nextInt(4) == 0
											&& p_76484_1_.getBlock(l2, k2, l1 - 1).isAir(p_76484_1_, l2, k2, l1 - 1)) {
										generateVines(p_76484_1_, l2, k2, l1 - 1, 1);
									}

									if (p_76484_2_.nextInt(4) == 0
											&& p_76484_1_.getBlock(l2, k2, l1 + 1).isAir(p_76484_1_, l2, k2, l1 + 1)) {
										generateVines(p_76484_1_, l2, k2, l1 + 1, 4);
									}
								}
							}
						}
	...
	private void generateVines(World p_76536_1_, int p_76536_2_, int p_76536_3_, int p_76536_4_, int p_76536_5_) {
		setBlockAndNotifyAdequately(p_76536_1_, p_76536_2_, p_76536_3_, p_76536_4_, Blocks.vine, p_76536_5_);
		int i1 = 4;

		while (true) {
			--p_76536_3_;

			if (!p_76536_1_.getBlock(p_76536_2_, p_76536_3_, p_76536_4_).isAir(p_76536_1_, p_76536_2_, p_76536_3_,
					p_76536_4_) || i1 <= 0)
				return;
