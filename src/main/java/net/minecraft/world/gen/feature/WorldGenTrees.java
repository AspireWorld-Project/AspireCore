				...
				if (isSoil && p_76484_4_ < 256 - l - 1) {
							...
							for (int k2 = p_76484_5_ - l1; k2 <= p_76484_5_ + l1; ++k2) {
								...
								if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || p_76484_2_.nextInt(2) != 0 && i3 != 0) {
									...
									if (block1.isAir(p_76484_1_, i2, k1, k2)
										...
										setBlockAndNotifyAdequately(p_76484_1_, i2, k1, k2, Blocks.leaves, metaLeaves);
									}
								}
							}
						}
					...
					for (k1 = 0; k1 < l; ++k1) {
						...
						if (block.isAir(p_76484_1_, p_76484_3_, p_76484_4_ + k1, p_76484_5_)
							...
							setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + k1, p_76484_5_, Blocks.log,
									metaWood);

							if (vinesGrow && k1 > 0) {
								if (p_76484_2_.nextInt(3) > 0
										&& p_76484_1_.isAirBlock(p_76484_3_ - 1, p_76484_4_ + k1, p_76484_5_)) {
									setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_ - 1, p_76484_4_ + k1, p_76484_5_,
											Blocks.vine, 8);
								}
								...
								if (p_76484_2_.nextInt(3) > 0
									...
									setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + k1, p_76484_5_ - 1,
											Blocks.vine, 1);
								}
							...
							for (k1 = 0; k1 < 2; ++k1) {
								for (i3 = 0; i3 < 4; ++i3) {
									if (p_76484_2_.nextInt(4 - k1) == 0) {
										...
										setBlockAndNotifyAdequately(p_76484_1_,
