...
public class WorldGeneratorBonusChest extends WorldGenerator {
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
		...
		do {
			...
			if (!block.isAir(p_76484_1_, p_76484_3_, p_76484_4_, p_76484_5_)
					&& !block.isLeaves(p_76484_1_, p_76484_3_, p_76484_4_, p_76484_5_)) {
				break;
			}
			p_76484_4_--;
		} while (p_76484_4_ > 1);
		...
		if (p_76484_4_ < 1)
			...
			for (int l = 0; l < 4; ++l) {
				...
				if (p_76484_1_.isAirBlock(i1, j1, k1)
						&& World.doesBlockHaveSolidTopSurface(p_76484_1_, i1, j1 - 1, k1)) {
					...
					if (tileentitychest != null && tileentitychest != null) {
						WeightedRandomChestContent.generateChestContents(p_76484_2_, theBonusChestGenerator,
								tileentitychest, itemsToGenerateInBonusChest);
					}

					if (p_76484_1_.isAirBlock(i1 - 1, j1, k1)
							&& World.doesBlockHaveSolidTopSurface(p_76484_1_, i1 - 1, j1 - 1, k1)) {
					...
					if (p_76484_1_.isAirBlock(i1, j1, k1 - 1)
							&& World.doesBlockHaveSolidTopSurface(p_76484_1_, i1 - 1, j1 - 1, k1)) {
