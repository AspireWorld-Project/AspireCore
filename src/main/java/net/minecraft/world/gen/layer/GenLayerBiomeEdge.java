...
public class GenLayerBiomeEdge extends GenLayer {
	...
	public int[] getInts(int p_75904_1_, int p_75904_2_, int p_75904_3_, int p_75904_4_) {
		...
		for (int i1 = 0; i1 < p_75904_4_; ++i1) {
			for (int j1 = 0; j1 < p_75904_3_; ++j1) {
				...
				if (!func_151636_a(aint, aint1, j1, i1, p_75904_3_, k1, BiomeGenBase.extremeHills.biomeID,
						BiomeGenBase.extremeHillsEdge.biomeID)
						&& !func_151635_b(aint, aint1, j1, i1, p_75904_3_, k1, BiomeGenBase.mesaPlateau_F.biomeID,
								BiomeGenBase.mesa.biomeID)
						&& !func_151635_b(aint, aint1, j1, i1, p_75904_3_, k1, BiomeGenBase.mesaPlateau.biomeID,
								BiomeGenBase.mesa.biomeID)
						&& !func_151635_b(aint, aint1, j1, i1, p_75904_3_, k1, BiomeGenBase.megaTaiga.biomeID,
	...
	private boolean func_151636_a(int[] p_151636_1_, int[] p_151636_2_, int p_151636_3_, int p_151636_4_,
		...
		if (!compareBiomesById(p_151636_6_, p_151636_7_))
			...
			if (func_151634_b(k1, p_151636_7_) && func_151634_b(l1, p_151636_7_) && func_151634_b(i2, p_151636_7_)
					&& func_151634_b(j2, p_151636_7_)) {
	...
	private boolean func_151635_b(int[] p_151635_1_, int[] p_151635_2_, int p_151635_3_, int p_151635_4_,
		...
		if (p_151635_6_ != p_151635_7_)
			...
			if (compareBiomesById(k1, p_151635_7_) && compareBiomesById(l1, p_151635_7_)
					&& compareBiomesById(i2, p_151635_7_) && compareBiomesById(j2, p_151635_7_)) {
