...
public interface Fishing {
	...
	/**
	 * Remove WeightedRandomFishables from the 'fish' results table. Modifications
	 * to the Fishable objects will not be kept.
	 *
	 * @param test
	 *            a Predicate giving the removal condition
	 */
	public void removeMatchingFish(Predicate<WeightedRandomFishable> test);

	/**
	 * Remove WeightedRandomFishables from the 'junk' results table. Modifications
	 * to the Fishable objects will not be kept.
	 *
	 * @param test
	 *            a Predicate giving the removal condition
	 ...
	 * @param baseChance
	 *            roughly, a percentage chance (0-1) to get a fish
	 * @param fishingLuckEnchantmentLevel
	 *            the value of {@link org.bukkit.enchantments.Enchantment#LUCK} on
	 *            the fishing rod
	 * @param fishingSpeedEnchantmentLevel
	 *            the value of {@link org.bukkit.enchantments.Enchantment#LURE} on
	 *            the fishing rod
