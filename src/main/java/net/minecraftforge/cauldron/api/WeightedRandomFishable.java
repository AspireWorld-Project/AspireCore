...
public class WeightedRandomFishable {
	...
	/**
	 * Setting this value results in fished items having random damage when fished.
	 * The damage is in a triangular random distribution (think about rolling 2
	 * dice), with the wide end at 100% and the narrow end at (100% -
	 * damageFraction).
	 * <p>
	 * For use in a chaining constructor.
	 *
	 * @param damageFraction
	 *            low boundary for random distribution
	...
	/**
	 * Set whether this WeightedRandomFishable receives random enchantments. (Use
	 * this method if loading from another source, such as a config file.)
	 *
	 * @return this WeightedRandomFishable, for chaining
	 */
