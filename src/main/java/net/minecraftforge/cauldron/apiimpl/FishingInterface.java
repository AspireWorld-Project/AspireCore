...
public class FishingInterface implements Fishing {
	private static net.minecraft.util.WeightedRandomFishable toNms(WeightedRandomFishable bukkit) {
		net.minecraft.util.WeightedRandomFishable ret = new net.minecraft.util.WeightedRandomFishable(
				CraftItemStack.asNMSCopy(bukkit.getItemStack()), bukkit.getWeight())
						.func_150709_a(bukkit.getDamageFraction());
	...
	private static WeightedRandomFishable toBukkit(net.minecraft.util.WeightedRandomFishable nms) {
		return new WeightedRandomFishable(CraftItemStack.asBukkitCopy(nms.getField_150711_b()), nms.itemWeight)
				.withDamageFraction(nms.getField_150712_c()).withRandomEnchantments(nms.getField_150710_d());
	}
	...
	@Override
	public ItemStack getRandomFishable(Random rand, float baseChance, int fishingLuckEnchantmentLevel,
			int fishingSpeedEnchantmentLevel) {
		return CraftItemStack.asCraftMirror(FishingHooks.getRandomFishable(rand, baseChance,
				fishingLuckEnchantmentLevel, fishingSpeedEnchantmentLevel));
	}
}
