...
public class ClientCommandHandler extends CommandHandler {
	...
	/**
	 * @return 1 if successfully executed, -1 if no permission or wrong usage, 0 if
	 *         it doesn't exist or it was canceled (it's sent to the server)
	 */
	@Override
	public int executeCommand(ICommandSender sender, String message) {
		...
		try {
			...
			sender.addChatMessage(
					format(RED, "commands.generic.usage", format(RED, wue.getMessage(), wue.getErrorOjbects())));
