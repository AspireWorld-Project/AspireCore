...
public class MinecraftForgeClient {
	 ...
	 * the item in-world as an EntityItem, when the item is equipped, or when the
	 * item is in an inventory slot.
	 *
	 * @param itemID
	 *            The item ID (shifted index) to handle rendering.
	 * @param renderer
	 *            The IItemRenderer interface that handles rendering for this item.
	 */
	 ...
	 *
	 * @param bit
	 *            The bit from {@link #reserveStencilBit()}
	 */
