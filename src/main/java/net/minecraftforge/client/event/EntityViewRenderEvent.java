...
/**
 * Event that hooks into EntityRenderer, allowing any feature to customize
 * visual attributes of fog the player sees.
 */
public abstract class EntityViewRenderEvent extends Event {
	...
	public EntityViewRenderEvent(EntityRenderer renderer, EntityLivingBase entity, Block block,
	...
	public static class FogDensity extends EntityViewRenderEvent {
		...
		public FogDensity(EntityRenderer renderer, EntityLivingBase entity, Block block, double renderPartialTicks,
				float density) {
	...
	public static class RenderFogEvent extends EntityViewRenderEvent {
		...
		public RenderFogEvent(EntityRenderer renderer, EntityLivingBase entity, Block block, double renderPartialTicks,
	 ...
	 * NOTE: Any change made to one of the color variables will affect the result
	 * seen in-game.
	 */
	public static class FogColors extends EntityViewRenderEvent {
		...
		public FogColors(EntityRenderer renderer, EntityLivingBase entity, Block block, double renderPartialTicks,
