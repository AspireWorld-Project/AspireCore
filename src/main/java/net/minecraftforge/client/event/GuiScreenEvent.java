...
public class GuiScreenEvent extends Event {
	...
	public static class InitGuiEvent extends GuiScreenEvent {
		...
		/**
		 * This event fires just after initializing {@code GuiScreen.mc},
		 * {@code GuiScreen.fontRendererObj}, {@code GuiScreen.width}, and
		 * {@code GuiScreen.height}, and just before calling
		 * {@code GuiScreen.buttonList.clear()} and {@code GuiScreen.initGui()}. To skip
		 * or override a screen's initGui() method cancel the event.<br/>
		 * <br/>
		 *
		 * If canceled the following lines are skipped in
		 * {@code GuiScreen.setWorldAndResolution()}:<br/>
		...
		/**
		 * This event fires right after {@code GuiScreen.initGui()}. This is a good
	...
	public static class DrawScreenEvent extends GuiScreenEvent {
		...
		/**
		 * This event fires just before {@code GuiScreen.drawScreen()} is called. Cancel
		 * this event to skip {@code GuiScreen.drawScreen()}.
		 *
		 * @author bspkrs
		 */
		@Cancelable
	...
	public static class ActionPerformedEvent extends GuiScreenEvent {
		...
		/**
		 * This event fires once it has been determined that a GuiButton object has been
		 * clicked. Cancel this event to bypass {@code GuiScreen.actionPerformed()}.
		 * Replace button with a different button from buttonList to have that button's
		 * action executed.
		 *
		 * @author bspkrs
		 */
		...
		/**
		 * This event fires after {@code GuiScreen.actionPerformed()} provided that the
		 * active screen has not been changed as a result of
		 * {@code GuiScreen.actionPerformed()}.
		 *
		 * @author bspkrs
		 */
