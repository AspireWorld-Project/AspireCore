...
public class DungeonHooks {
	 ...
	 *
	 * @param name
	 *            The name of the monster, use the same name used when registering
	 *            the entity.
	 * @param rarity
	 *            The rarity of selecting this mob over others. Must be greater then
	 *            0. Vanilla Minecraft has the following mobs: Spider 100 Skeleton
	 *            100 Zombie 200 Meaning, Zombies are twice as common as spiders or
	 *            skeletons.
