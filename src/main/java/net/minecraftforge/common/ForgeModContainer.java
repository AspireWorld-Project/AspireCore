...
public class ForgeModContainer extends DummyModContainer implements WorldAccessContainer {
	...
	private static void syncConfig(boolean load) {
		...
		// Language keys are a good idea to implement if you are using config GUIs. This
		// allows you to use a .lang file that will hold the
		// "pretty" version of the property name as well as allow others to provide
		// their own localizations.
		// This language key is also used to get the tooltip for a property. The tooltip
		// language key is langKey + ".tooltip".
		// If no tooltip language key is defined in your .lang file, the tooltip will
		// default to the property comment field.
		...
		// "disableStitchedFileSaving", true);
		// prop.comment = "Set this to just disable the texture stitcher from writing
		// the 'debug.stitched_{name}.png file to disc. Just a small performance tweak.
		// Default: true";
		...
		prop = config.get(Configuration.CATEGORY_GENERAL, "biomeSkyBlendRange",
		...
		prop = config.get(Configuration.CATEGORY_GENERAL, "zombieBabyChance", 0.05,
				"Chance that a zombie (or subclass) is a baby. Allows changing the zombie spawning mechanic.", 0.0D,
				1.0D);
	...
	/**
	 * By subscribing to the OnConfigChangedEvent we are able to execute code when
	 * our config screens are closed. This implementation uses the optional configID
	 * string to handle multiple Configurations using one event handler.
	 */
	@SubscribeEvent
	...
	public List<String> getOwnedPackages() {
		// All the packages which are part of forge. Only needs updating if new logic is
		// added
		// that requires event handlers
		return ImmutableList.of("net.minecraftforge.classloading", "net.minecraftforge.client",
				"net.minecraftforge.client.event", "net.minecraftforge.client.event.sound",
				"net.minecraftforge.client.model", "net.minecraftforge.client.model.obj",
				"net.minecraftforge.client.model.techne", "net.minecraftforge.common",
				"net.minecraftforge.common.config", "net.minecraftforge.common.network",
				"net.minecraftforge.common.util", "net.minecraftforge.event", "net.minecraftforge.event.brewing",
				"net.minecraftforge.event.entity", "net.minecraftforge.event.entity.item",
				"net.minecraftforge.event.entity.living", "net.minecraftforge.event.entity.minecart",
				"net.minecraftforge.event.entity.player", "net.minecraftforge.event.terraingen",
				"net.minecraftforge.event.world", "net.minecraftforge.fluids", "net.minecraftforge.oredict",
				"net.minecraftforge.server", "net.minecraftforge.server.command", "net.minecraftforge.transformers");
	}
