...
public class ForgeVersion {
	...
	// This number is incremented every time a interface changes or new major
	// feature is added, and reset every Minecraft version
	public static final int revisionVersion = 4;
	// This number is incremented every time Jenkins builds Forge, and never reset.
	// Should always be 0 in the repo code.
