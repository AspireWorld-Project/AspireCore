 ...
 * Only one handler can be registered at a time. It it registered with
 * EntityMinecart.registerCollisionHandler(). If you use this, make it a
...
public interface IMinecartCollisionHandler {
	...
	/**
	 * This basically replaces the function of the same name in EnityMinecart. Code
	 * in IMinecartHooks.applyEntityCollisionHook is still run.
	 *
	 * @param cart
	 *            The cart that called the collision.
	 * @param other
	 ...
	 * used to define whether minecarts collide with specific entities, for example
	 * items.
	 *
	 * @param cart
	 ...
	 * collisions. It is generally bigger that the normal collision box.
	 *
	 * @param cart
	 *            The cart for which the collision box was requested.
	 ...
	 * defines whether minecarts are solid to the player.
	 *
	 * @param cart
