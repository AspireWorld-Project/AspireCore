...
public final class UsernameCache {
	...
	private static final File saveFile = new File( /* The minecraft dir */(File) FMLInjectionData.data()[6],
			"usernamecache.json");
	 ...
	 * @param uuid
	 *            the player's {@link java.util.UUID UUID}
	 * @return the player's last known username, or <code>null</code> if the cache
	 *         doesn't have a record of the last username
	 */
	@Nullable
