...
class ChunkIOProvider implements
		AsynchronousExecutor.CallBackProvider<QueuedChunk, net.minecraft.world.chunk.Chunk, IChunkLoadCallback, RuntimeException> {
	...
	@Override
	public void callStage3(QueuedChunk queuedChunk, net.minecraft.world.chunk.Chunk chunk, IChunkLoadCallback callback)
			throws RuntimeException {
		if (queuedChunk.provider.isWorldUnloaded())
			return;
		callback.onChunkLoaded(
				chunk != null ? chunk : queuedChunk.provider.getChunkIfExists(queuedChunk.x, queuedChunk.z));
	}
