...
public class Configuration {
	...
	/**
	 * Create a configuration file for the file given in parameter with the provided
	 ...
	 *            the Property key value
	 * @param defaultValues
	 *            an array containing the default values
	 * @return a boolean array Property without a comment using these defaults:
	 ...
	 * @param comment
	 *            a String comment
	 * @return a boolean array Property with a comment using these defaults:
	 *         isListLengthFixed = false, maxListLength = -1
	 */
	 ...
	 *            boolean for whether this array is required to be a specific length
	 *            (defined by the default value array length or maxListLength)
	 * @param maxListLength
	 *            the maximum length of this array, use -1 for no max length
	 ...
	 * @param defaultValue
	 *            the default value
	 * @return an integer Property object with default bounds of Integer.MIN_VALUE
	...
	/**
	 * Gets an integer Property object with the defined comment, minimum and maximum
	 * bounds.
	 *
	 * @param category
	 *            the config category
	 ...
	 * @param maxValue
	 *            maximum boundary
	 * @return an integer Property object with the defined comment, minimum and
	 *         maximum bounds
	 */
	...
	/**
	 * Gets an integer array Property object without a comment using default
	 * settings.
	 *
	 * @param category
	 *            the config category
	 ...
	 * @param defaultValues
	 *            an array containing the default values
	 * @return an integer array Property object with default bounds of
	 *         Integer.MIN_VALUE and Integer.MAX_VALUE, isListLengthFixed = false,
	 *         maxListLength = -1
	 */
	...
	/**
	 * Gets an integer array Property object with the defined comment, minimum and
	 * maximum bounds.
	 *
	 * @param category
	 *            the config category
	 ...
	 * @param maxValue
	 *            maximum boundary
	 * @return an integer array Property object with the defined comment, minimum
	 *         and maximum bounds, isListLengthFixed = false, maxListLength = -1
	 */
	 ...
	 * @param defaultValue
	 *            the default value
	 * @return a double Property object with default bounds of Double.MIN_VALUE and
	 *         Double.MAX_VALUE
	 */
	...
	/**
	 * Gets a double Property object with the defined comment, minimum and maximum
	 * bounds
	 *
	 * @param category
	 *            the config category
	 ...
	 * @param maxValue
	 *            maximum boundary
	 * @return a double Property object with the defined comment, minimum and
	 *         maximum bounds
	 */
	 ...
	 * @param defaultValues
	 *            an array containing the default values
	 * @return a double array Property object with default bounds of
	 *         Double.MIN_VALUE and Double.MAX_VALUE, isListLengthFixed = false,
	 *         maxListLength = -1
	 */
	...
	/**
	 * Gets a double array Property object with the defined comment, minimum and
	 * maximum bounds.
	 *
	 * @param category
	 *            the config category
	 ...
	 * @param maxValue
	 *            maximum boundary
	 * @return a double array Property object with the defined comment, minimum and
	 *         maximum bounds, isListLengthFixed = false, maxListLength = -1
	 */
	...
	/**
	 * Gets a string Property with a comment using the defined validationPattern and
	 ...
	 *            a Pattern object for input validation
	 * @return a string Property with the defined validationPattern, validValues =
	 *         null
	 */
	...
	/**
	 * Gets a string Property with a comment using the defined validValues array and
	 * otherwise default settings.
	 *
	 * @param category
	 *            the config category
	 ...
	 *            a String comment
	 * @param validValues
	 *            an array of valid values that this Property can be set to. If an
	 *            array is provided the Config GUI control will be a value cycle
	 *            button.
	 * @return a string Property with the defined validValues array,
	 ...
	 * @param defaultValues
	 *            an array containing the default values
	 * @return a string array Property with validationPattern = null,
	 *         isListLengthFixed = false, maxListLength = -1
	 */
	...
	/**
	 * Gets a string array Property with a comment using the defined
	 * validationPattern and otherwise default settings.
	 *
	 * @param category
	 *            the config category
	 * @param key
	 ...
	 * @param validationPattern
	 *            a Pattern object for input validation
	 * @return a string array Property with the defined validationPattern,
	 *         isListLengthFixed = false, maxListLength = -1
	 */
	public Property get(String category, String key, String[] defaultValues, String comment,
	...
	/**
	 * Gets a list (array) Property object of the specified type using default
	 * settings.
	 *
	 * @param category
	 *            the config category
	 ...
	 * @param type
	 *            a Property.Type enum value
	 * @return a list (array) Property object of the specified type using default
	 *         settings
	 */
							...
							case '}':
								...
								if (currentCat == null)
									throw new RuntimeException(String.format(
											"Config file corrupt, attepted to close to many categories '%s:%d'",
											fileName, lineNum));
	...
	public void addCustomCategoryComment(String category, String comment) {
		setCategoryComment(category, comment);
	}
	 ...
	 *            the config category
	 * @param langKey
	 *            a language key string such as configcategory.general
	 */
	...
	/**
	 * Sets the custom IConfigEntry class that should be used in place of the
	 * standard entry class (which is just a button that navigates into the
	 * category). This class MUST provide a constructor with the following parameter
	 * types: {@code GuiConfig} (the parent GuiConfig screen will be provided),
	 * {@code GuiPropertyList} (the parent GuiPropertyList will be provided),
	...
	/**
	 * Sets the order that direct child properties of this config category will be
	 * written to the config file and will be displayed in config GUIs.
	 */
	 ...
	 * @param newCategory
	 *            the category the property should be moved to
	...
	/**
	 * Copies property objects from another Configuration object to this one using
	 * the list of category names. Properties that only exist in the "from" object
	 * are ignored. Pass null for the ctgys array to include all categories.
	 */
	public void copyCategoryProps(Configuration fromConfig, String[] ctgys) {
		if (ctgys == null) {
			ctgys = getCategoryNames().toArray(new String[getCategoryNames().size()]);
		}

		for (String ctgy : ctgys)
			if (fromConfig.hasCategory(ctgy) && hasCategory(ctgy)) {
				ConfigCategory thiscc = getCategory(ctgy);
	 ...
	 *            A brief description what the property does.
	 * @param langKey
	 *            A language key used for localization of GUIs
	 * @return The value of the new string property.
	 */
	 ...
	 *            A brief description what the property does.
	 * @param validValues
	 *            A list of valid values that this property can be set to.
	 * @return The value of the new string property.
	 */
