...
public class Property {
	...
	Property(String name, String[] values, Type type, boolean read, String[] validValues, String langKey) {
		...
		defaultValues = Arrays.copyOf(values, values.length);
		this.validValues = validValues;
		isListLengthFixed = false;
		maxListLength = -1;
		minValue = String.valueOf(Integer.MIN_VALUE);
	 ...
	 *
	 * @return true if the current value(s) is(are) deeply equal to the default
	 *         value(s)
	 */
	...
	public Property setToDefault() {
		value = defaultValue;
		values = Arrays.copyOf(defaultValues, defaultValues.length);
		return this;
	}

	/**
	 * Gets the raw String default value of this Property. Check for isList() ==
	 * false first.
	 *
	...
	/**
	 * Gets the raw String[] default values of this Property. Check for isList() ==
	 * true first.
	 *
	...
	public Property setRequiresMcRestart(boolean requiresMcRestart) {
		this.requiresMcRestart = requiresWorldRestart = requiresMcRestart;
		return this;
	}
	 ...
	 * and setIsListLengthFixed(true), this method should be called afterwards (but
	 * is not required).
	 */
	public Property setMaxListLength(int max) {
		...
		if (maxListLength != -1) {
			if (values != null && values.length != maxListLength)
				if (isListLengthFixed || values.length > maxListLength) {
					values = Arrays.copyOf(values, maxListLength);
				}

			if (defaultValues != null && defaultValues.length != maxListLength)
				if (isListLengthFixed || defaultValues.length > maxListLength) {
	...
	/**
	 * Gets the maximum length of this list/array Property. Only important if
	 * isList() == true.
	 */
	...
	/**
	 * Sets the flag for whether this list/array Property has a fixed length. Only
	 * important if isList() == true. If calling both this method and
	 * setMaxListLength(), this method should be called first (but is not required).
	 */
	...
	/**
	 * Returns whether or not this list/array has a fixed length. Only important if
	 * isList() == true.
	 */
	public boolean isListLengthFixed() {
		return isListLengthFixed;
	}

	/**
	 * Sets a custom IConfigEntry class that should be used in place of the standard
	 * entry class for this Property type. This class MUST provide a constructor
	 * with the following parameter types: {@code GuiConfig} (the owning GuiConfig
	 * screen will be provided), {@code GuiConfigEntries} (the owning
	...
	/**
	 * Gets the custom IConfigEntry class that should be used in place of the
	 * standard entry class for this Property type, or null if none has been set.
	 *
	...
	/**
	 * Sets a custom IGuiEditListEntry class that should be used in place of the
	 * standard entry class for this Property type. This class MUST provide a
	 * constructor with the following parameter types: {@code GuiEditList} (the
	 * owning GuiEditList screen will be provided), {@code GuiPropertyList} (the
	 * parent GuiPropertyList will be provided), {@code IConfigProperty} (the
	 * IConfigProperty for this Property will be provided).
	 *
	 * @param clazz
	...
	/**
	 * Gets the custom IArrayEntry class that should be used in place of the
	 * standard entry class for this Property type, or null if none has been set.
	 *
	...
	/**
	 * Sets a regex Pattern object used to validate user input for formatted String
	 * or String[] properties.
	 *
	 ...
	 *
	 * @param langKey
	 *            a string language key such as myawesomemod.config.myPropName
	 */
	...
	/**
	 * Sets the array of valid values that this String Property can be set to. When
	 * an array of valid values is defined for a Property the GUI control for that
	 * property will be a value cycle button.
	 *
	 * @param validValues
	...
	/**
	 * Gets the array of valid values that this String Property can be set to, or
	 * null if not defined.
	 *
	...
	/**
	 * Returns the value in this property as an integer, if the value is not a valid
	 * integer, it will return the initially provided default.
	 *
	 * @return The value
	 */
	public int getInt() {
	...
	/**
	 * Returns the value in this property as an integer, if the value is not a valid
	 * integer, it will return the provided default.
	 *
	 * @param _default
	...
	/**
	 * Checks if the current value stored in this property can be converted to an
	 * integer.
	 *
	...
	/**
	 * Returns the value in this property as a boolean, if the value is not a valid
	 * boolean, it will return the provided default.
	 *
	 * @param _default
	 ...
	 * double, it will return the provided default.
	 *
	 * @param _default
	 *            The default to provide if the current value is not a valid double
	 * @return The value
	 */
	...
	/**
	 * Checks if all of the current values stored in this property can be converted
	 * to an integer.
	 *
	...
	/**
	 * Checks if all of current values stored in this property can be converted to a
	 * boolean.
	 *
	 * @return True if it is a boolean value
	 */
	...
	/**
	 * Determines if this config value was just created, or if it was read from the
	 * config file. This is useful for mods who auto-assign their blocks to
