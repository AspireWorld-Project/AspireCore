...
public class FakePlayerFactory {
	...
	/**
	 * Get a fake player with a given username, Mods should either hold weak
	 * references to the return value, or listen for a WorldEvent.Unload and kill
	 * all references to prevent worlds staying in memory.
	 */
