...
public class EntityEvent extends Event {
	 ...
	 * <br>
	 * <br>
	 * {@link CanUpdate#canUpdate} contains the boolean value of whether this entity
	 * can update.<br>
	 * If the modder decides that this Entity can be updated, they may change
	 * canUpdate to true, <br>
