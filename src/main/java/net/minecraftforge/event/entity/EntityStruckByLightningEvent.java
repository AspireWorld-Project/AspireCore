...
/**
 * EntityStruckByLightningEvent is fired when an Entity is about to be struck by
 * lightening.<br>
 * This event is fired whenever an EntityLightningBolt is updated to strike an
 * Entity in EntityLightningBolt#onUpdate() via
 * {@link ForgeEventFactory#onEntityStruckByLightning(Entity, EntityLightningBolt)}.<br>
 * <br>
 * {@link #lightning} contains the instance of EntityLightningBolt attempting to
 * strike an entity.<br>
 * <br>
