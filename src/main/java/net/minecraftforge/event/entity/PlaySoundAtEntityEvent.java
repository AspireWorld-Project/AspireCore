 ...
 * This event is fired whenever a sound is set to be played at an Entity such as
 * in EntityPlayerSP#playSound(String, float, float),
 * World#playSoundAtEntity(Entity, String, float, float), and
 * World#playerSoundToNearExcept(EntityPlayer, String, float, float).<br>
 * <br>
 ...
 * Changing the {@link #name} field will cause the sound of this name to be
 * played instead of the originally intended sound.<br>
 * <br>
