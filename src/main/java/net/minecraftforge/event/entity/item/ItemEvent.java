...
/**
 * Base class for all EntityItem events. Contains a reference to the EntityItem
 * of interest. For most EntityItem events, there's little to no additional
 * useful data from the firing method that isn't already contained within the
 * EntityItem instance.
 */
