 ...
 * EntityLivingBase#onDeath(DamageSource), EntityPlayer#onDeath(DamageSource),
 * and EntityPlayerMP#onDeath(DamageSource). <br>
 * <br>
 * This event is fired via the
 * {@link ForgeHooks#onLivingDeath(EntityLivingBase, DamageSource)}.<br>
 * <br>
