 ...
 * <br>
 * This event is fired via the {@link ForgeHooks#onLivingDrops(EntityLivingBase,
 * DamageSource, ArrayList<EntityItem>, int, boolean, int)}.<br>
 * <br>
 * {@link #source} contains the DamageSource that caused the drop to occur.<br>
 * {@link #drops} contains the ArrayList of EntityItems that will be
 * dropped.<br>
 * {@link #lootingLevel} contains the amount of loot that will be dropped.<br>
 * {@link #recentlyHit} determines whether the Entity doing the drop has
 * recently been damaged.<br>
...
public class LivingDropsEvent extends LivingEvent {
	...
	public LivingDropsEvent(EntityLivingBase entity, DamageSource source, ArrayList<EntityItem> drops, int lootingLevel,
