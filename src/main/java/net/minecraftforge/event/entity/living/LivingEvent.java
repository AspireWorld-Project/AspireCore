...
public class LivingEvent extends EntityEvent {
	 ...
	 * {@link ForgeHooks#onLivingUpdate(EntityLivingBase)}.<br>
	 * <br>
	 ...
	 * This event is fired whenever an Entity jumps in EntityLivingBase#jump(),
	 * EntityMagmaCube#jump(), and EntityHorse#jump().<br>
	 * <br>
	 * This event is fired via the
	 * {@link ForgeHooks#onLivingJump(EntityLivingBase)}.<br>
	 * <br>
