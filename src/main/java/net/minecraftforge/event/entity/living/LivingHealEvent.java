 ...
 * This event is fired whenever an Entity is healed in
 * EntityLivingBase#heal(float)<br>
 * <br>
 * This event is fired via the
 * {@link ForgeHooks#onLivingHeal(EntityLivingBase, float)}.<br>
 * <br>
 * {@link #amount} contains the amount of healing done to the Entity that was
 * healed. <br>
 * <br>
