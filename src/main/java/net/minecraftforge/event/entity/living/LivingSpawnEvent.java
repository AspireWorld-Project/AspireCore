 ...
 * <br>
 * {@link #world} contains the world in which this living Entity is being
 * spawned.<br>
...
public class LivingSpawnEvent extends LivingEvent {
	 ...
	 *
	 * Result is significant: DEFAULT: use vanilla spawn rules ALLOW: allow the
	 * spawn DENY: deny the spawn
	 *
	 */
	@HasResult
	 ...
	 * {@link ForgeHooks#doSpecialSpawn(EntityLiving, World, float, float, float)}.<br>
	 * <br>
	 ...
	 * {@link Result#ALLOW} will force the mob to despawn. {@link Result#DENY} will
	 * force the mob to remain. This is fired every tick for every despawnable
	 * entity. Be efficient in your handlers.
	 *
	 * Note: this is not fired <em>if</em> the mob is definitely going to otherwise
	 * despawn. It is fired to check if the mob can be allowed to despawn. See
