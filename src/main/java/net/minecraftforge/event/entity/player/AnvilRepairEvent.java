...
public class AnvilRepairEvent extends PlayerEvent {
	 ...
	 *
	 * breakChance specifies as a percentage the chance that the anvil will be
	 * "damaged" when used.
	 *
	...
	public float breakChance; // Anvil's chance to break (reduced by 1 durability) when this is complete.
								// Default is 12% (0.12f)
