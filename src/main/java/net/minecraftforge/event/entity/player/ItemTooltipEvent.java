...
public class ItemTooltipEvent extends PlayerEvent {
	/**
	 * Whether the advanced information on item tooltips is being shown, toggled by
	 * F3+H.
	 */
	...
	/**
	 * This event is fired in {@link ItemStack#getTooltip(EntityPlayer, boolean)},
	 * which in turn is called from it's respective GUIContainer.
	 */
	public ItemTooltipEvent(ItemStack itemStack, EntityPlayer entityPlayer, List<String> toolTip,
