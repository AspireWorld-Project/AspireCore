 ...
 * PlayerControllerMP#onPlayerRightClick(EntityPlayer, World, ItemStack, int,
 * int, int, int, Vec3), PlayerControllerMP#sendUseItem(EntityPlayer, World,
 * ItemStack), EntityPlayer#destroyCurrentEquippedItem(),
 ...
 * int, int, int, int, float, float, float).<br>
 * <br>
 * {@link #original} contains the original ItemStack before the item was
 * destroyed. <br>
 * <br>
