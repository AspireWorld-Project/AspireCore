 ...
 * Canceling the event will prevent ALL drops from entering the world.
 */
@Cancelable
public class PlayerDropsEvent extends LivingDropsEvent {
	...
	/**
	 * Creates a new event containing all the items that will drop into the world
	 * when a player dies.
	 *
	 * @param entity
	 *            The dying player.
	...
	public PlayerDropsEvent(EntityPlayer entity, DamageSource source, ArrayList<EntityItem> drops,
		...
		super(entity, source, drops,
				source.getEntity() instanceof EntityPlayer
						? EnchantmentHelper.getLootingModifier((EntityPlayer) source.getEntity())
						: 0,
				recentlyHit, 0);
