...
public class PlayerEvent extends LivingEvent {
	 ...
	 * {@link ForgeEventFactory#doPlayerHarvestCheck(EntityPlayer, Block, boolean)}.<br>
	 * <br>
	 * {@link #block} contains the Block that is being checked for harvesting. <br>
	 * {@link #success} contains the boolean value for whether the Block will be
	 * successfully harvested. <br>
	 * <br>
	 ...
	 * <br>
	 * This event is fired via the
	 * {@link ForgeEventFactory#getBreakSpeed(EntityPlayer, Block, int, float, int, int, int)}.<br>
	 * <br>
	 ...
	 * <br>
	 * This event is fired via the
	 * {@link ForgeEventFactory#getPlayerDisplayName(EntityPlayer, String)}.<br>
	 * <br>
	 * {@link #username} contains the username of the player. {@link #displayname}
	 * contains the display name of the player. <br>
	 * This event is not {@link Cancelable}. <br>
	 * This event does not have a result. {@link HasResult} <br>
	 * This event is fired on the {@link MinecraftForge#EVENT_BUS}.
	 **/
	...
	/**
	 * Fired when the EntityPlayer is cloned, typically caused by the network
	 * sending a RESPAWN_PLAYER event. Either caused by death, or by traveling from
	...
	public static class Clone extends PlayerEvent {
		...
		/**
		 * True if this event was fired because the player died. False if it was fired
		 * because the entity switched dimensions.
		 */
	...
	/**
	 * Fired when an Entity is started to be "tracked" by this player (the player
	 * receives updates about this entity, e.g. motion).
	 *
	 */
	...
	/**
	 * Fired when an Entity is stopped to be "tracked" by this player (the player no
	 * longer receives updates about this entity, e.g. motion).
	 *
	 */
	...
	/**
	 * The player is being loaded from the world save. Note that the player won't
	 * have been added to the world yet. Intended to allow mods to load an
	 * additional file from the players directory containing additional mod related
	 * player data.
	 */
	public static class LoadFromFile extends PlayerEvent {
		/**
		 * The directory where player data is being stored. Use this to locate your mod
		 * additional file.
		 */
		public final File playerDirectory;
		/**
		 * The UUID is the standard for player related file storage. It is broken out
		 * here for convenience for quick file generation.
		 */
		public final String playerUUID;

		public LoadFromFile(EntityPlayer player, File originDirectory, String playerUUID) {
			super(player);
			playerDirectory = originDirectory;
	...
	/**
	 * The player is being saved to the world store. Note that the player may be in
	 * the process of logging out or otherwise departing from the world. Don't
