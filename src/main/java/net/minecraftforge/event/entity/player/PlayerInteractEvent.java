...
/**
 * PlayerInteractEvent is fired when a player interacts in some way. <br>
 ...
 * {@link ForgeEventFactory#onPlayerInteract(EntityPlayer, Action, int, int, int, int)}.
 * <br>
 * {@link #action} contains the Action the player performed durin this
 * interaction. <br>
