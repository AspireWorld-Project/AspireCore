 ...
 * {@link MinecraftForge#TERRAIN_GEN_BUS}.
 **/
public class BiomeEvent extends Event {
	 ...
	 * <br>
	 * {@link #originalBiomeDecorator} contains the original BiomeDecorator that
	 * would be used in vanilla. {@link #newBiomeDecorator} contains the new
	 * BiomeDecoration to be used by Minecraft. <br>
	 ...
	 *
	 * You can set the result to DENY to prevent the default block metadata
	 * selection.
	 */
	@HasResult
