...
public class ChunkProviderEvent extends Event {
	...
	public static class ReplaceBiomeBlocks extends ChunkProviderEvent {
		...
		public ReplaceBiomeBlocks(IChunkProvider chunkProvider, int chunkX, int chunkZ, Block[] blockArray,
		...
		@Deprecated // TODO: Remove in 1.8
		public ReplaceBiomeBlocks(IChunkProvider chunkProvider, int chunkX, int chunkZ, Block[] blockArray,
				byte[] metaArray, BiomeGenBase[] biomeArray) {
	...
	public static class InitNoiseField extends ChunkProviderEvent {
		...
		public InitNoiseField(IChunkProvider chunkProvider, double[] noisefield, int posX, int posY, int posZ,
