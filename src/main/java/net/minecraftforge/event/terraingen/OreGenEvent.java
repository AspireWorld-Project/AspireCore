 ...
 * event.<br>
 * {@link #worldX} contains the x-coordinate of the block position currently
 * being populated with ores.<br>
 * {@link #worldZ} contains the z-coordinate of the block position currently
 * being populated with ores.<br>
 * <br>
 * All children of this event are fired on the
 * {@link MinecraftForge#ORE_GEN_BUS}.<br>
 **/
public class OreGenEvent extends Event {
	 ...
	 * BiomeDecorator#generateOres().<br>
	 * <br>
	 * {@link #type} contains the enum value for the Ore attempting to be
	 * generated.<br>
	...
	public static class GenerateMinable extends OreGenEvent {
		public enum EventType {
			COAL, DIAMOND, DIRT, GOLD, GRAVEL, IRON, LAPIS, REDSTONE, QUARTZ, CUSTOM
		}

		public final EventType type;
		public final WorldGenerator generator;

		public GenerateMinable(World world, Random rand, WorldGenerator generator, int worldX, int worldZ,
				EventType type) {
			super(world, rand, worldX, worldZ);
