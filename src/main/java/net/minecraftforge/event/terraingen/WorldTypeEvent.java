 ...
 * <br>
 * {@link #worldType} contains the WorldType of the world this event is
 * occurring in.<br>
 * <br>
...
public class WorldTypeEvent extends Event {
	 ...
	 * {@link #newSize} the new size of the biome. Initially set to the
	 * {@link #originalSize}. <br>
	 * If {@link #newSize} is set to a new value, that value will be used for the
	 * Biome size. <br>
	 * <br>
	 ...
	 * {@link #originalBiomeGens} the array of GenLayers original intended for this
	 * Biome generation. <br>
	 * {@link #newBiomeGens} the array of GenLayers that will now be used for this
	 * Biome generation. <br>
	 * If {@link #newBiomeGens} is set to a new value, that value will be used for
	 * the Biome generator. <br>
	 * <br>
	 * This event is not {@link Cancelable}.<br>
	 * <br>
	 * This event does not have a result. {@link HasResult} <br>
