 ...
 * <br>
 * {@link #data} contains the NBTTagCompound containing the chunk data for this
 * event.<br>
 * <br>
...
public class ChunkDataEvent extends ChunkEvent {
	...
	/**
	 * ChunkDataEvent.Load is fired when vanilla Minecraft attempts to load Chunk
	 * data.<br>
	...
	/**
	 * ChunkDataEvent.Save is fired when vanilla Minecraft attempts to save Chunk
	 * data.<br>
	 * This event is fired during chunk saving in AnvilChunkLoader#saveChunk(World,
	 * Chunk). <br>
	 * <br>
	 * This event is not {@link Cancelable}.<br>
	 * <br>
