 ...
 * <br>
 * {@link #chunk} contains the ChunkCoordIntPair of the Chunk this event is
 * affecting.<br>
 * {@link #player} contains the EntityPlayer that is involved with this chunk
 * being watched. <br>
 * <br>
...
public class ChunkWatchEvent extends Event {
	 ...
	 * chunk.<br>
	 * This event is fired when a chunk is added to the watched chunks of an
	 * EntityPlayer in EntityPlayerMP#onUpdate(). <br>
	 * <br>
	 ...
	 * chunk.<br>
	 * This event is fired when a chunk is removed from the watched chunks of an
	 * EntityPlayer in PlayerInstance#removePlayer(EntityPlayerMP). <br>
	 * <br>
	 * This event is not {@link Cancelable}.<br>
	 * <br>
	 * This event does not have a result. {@link HasResult} <br>
