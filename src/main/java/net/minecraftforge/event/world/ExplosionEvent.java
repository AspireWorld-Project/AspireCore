 ...
 * ExplosionEvent.Detonate is fired once the explosion has a list of affected
 * blocks and entities.<br>
 * <br>
...
public class ExplosionEvent extends Event {
	...
	/**
	 * ExplosionEvent.Start is fired before the explosion actually occurs. Canceling
	 * this event will stop the explosion.<br>
	 * <br>
	...
	/**
	 * ExplosionEvent.Detonate is fired once the explosion has a list of affected
	 * blocks and entities. These lists can be modified to change the outcome.<br>
	 * <br>
