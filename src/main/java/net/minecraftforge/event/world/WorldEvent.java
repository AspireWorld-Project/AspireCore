...
public class WorldEvent extends Event {
	 ...
	 * ForgeInternalHandler#onDimensionLoad(Load). <br>
	 * <br>
	 ...
	 * MinecraftServer#deleteWorldAndStopServer(), MinecraftServer#stopServer(),
	 ...
	 * spawn at the specified location. Canceling the event will result in a empty
	 * list, meaning no entity will be spawned.
	 */
	@Cancelable
	 ...
	 * dimension. Canceling the event will prevent the vanilla code from running.
	 */
	@Cancelable
