...
public class FluidEvent extends Event {
	 ...
	 * {@link IFluidTank#fill(FluidStack, boolean)} their tank implementation.
	 * {@link FluidTank} does.
	 *
	 * @author cpw
	 *
	...
	/**
	 * Mods should fire this event when a fluid is
	 * {@link IFluidTank#drain(int, boolean)} from their tank.
	 *
	 * @author cpw
	 *
	 */
	...
	/**
	 * Mods should fire this event when a fluid "spills", for example, if a block
	 * containing fluid is broken.
	 *
	 * @author cpw
	 *
	 */
