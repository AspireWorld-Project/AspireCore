...
/**
 * Implement this interface on TileEntities which should handle fluids,
 * generally storing them in one or more internal {@link IFluidTank} objects.
 *
...
public interface IFluidHandler {
	 ...
	 * @param resource
	 *            FluidStack representing the Fluid and maximum amount of fluid to
	 *            be filled.
	 * @param doFill
	 ...
	 *
	 * More formally, this should return true if fluid is able to enter from the
	 * given direction.
	 */
	 ...
	 *
	 * More formally, this should return true if fluid is able to leave from the
	 * given direction.
	 */
	boolean canDrain(ForgeDirection from, Fluid fluid);

	/**
	 * Returns an array of objects which represent the internal tanks. These objects
	 * cannot be used to manipulate the internal tanks. See {@link FluidTankInfo}.
	 *
	 * @param from
