...
public interface IFluidTank {
	/**
	 * @return FluidStack representing the fluid in the tank, null if the tank is
	 *         empty.
	 */
	FluidStack getFluid();
	...
	/**
	 * Returns a wrapper object {@link FluidTankInfo } containing the capacity of
	 * the tank and the FluidStack it holds.
	 *
