...
public final class FireworkEffect implements ConfigurationSerializable {
	...
	public static final class Builder {
		...
		public Builder withFade(Color... colors) throws IllegalArgumentException {
			...
			ImmutableList.Builder<Color> list = fadeColors;
			if (list == null) {
				list = fadeColors = ImmutableList.builder();
			}
	...
	public boolean equals(Object obj) {
		...
		return flicker == that.flicker && trail == that.trail && type == that.type && colors.equals(that.colors)
				&& fadeColors.equals(that.fadeColors);
	}
}