...
public class Note {
	 ...
	 *
	 * @param note
	 *            Internal note id. {@link #getId()} always return this value. The
	 ...
	 * @param tone
	 *            The tone within the octave. If the octave is 2 the note has to be
	 *            F#.
	 * @param sharped
	...
	public Note(int octave, Tone tone, boolean sharped) {
		...
		note = (byte) (octave * Tone.TONES_COUNT + tone.getId(sharped));
	}
