...
public interface World extends PluginMessageRecipient, Metadatable {
	 ...
	 *            Type of the tree to create
	 * @param delegate
	 *            A class to call for each block changed as a result of this method
	 * @return true if the tree was created successfully, otherwise false
	 */
	 ...
	 *
	 * @param loc
	 *            The location to spawn the creature
	 * @param type
	 ...
	 *             if either parameter is null or the {@link Entity} requested
	 *             cannot be spawned
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             if {@link Location} or {@link Material} are null or
	 *             {@link Material} is not a block
	 * @deprecated Magic value
	 */
	@Deprecated
	 ...
	 * @throws IllegalArgumentException
	 *             if location is null, or blockId is invalid
	 ...
	 *
	 * @param location
	 *            the {@link Location} around which players must be to hear the
	 *            sound
	 * @param effect
	 *            the {@link Effect}
	 * @param data
	 ...
	 *            - if true, snapshot includes per-coordinate raw biome temperature
	 *            and rainfall
	 ...
	 *
	 * @param allowMonsters
	 *            - if true, monsters are allowed to spawn in this world.
	 * @param allowAnimals
	 ...
	 *
	 * @param keepLoaded
	 *            if true then the world's spawn area will be kept loaded into
	 *            memory.
	 */
	...
	public class Spigot {
		 ...
		 *
		 * @param location
		 *            the {@link Location} around which players must be to see the
		 *            effect
		 * @param effect
		 *            the {@link Effect}
		 * @throws IllegalArgumentException
		 *             if the location or effect is null. It also throws when the effect
		 *             requires a material or a material data
		 */
