...
public abstract class Command {
	 ...
	 * <p>
	 * If the command is currently registered the label change will only take effect
	 * after its been re-registered e.g. after a /reload
	 *
	 * @param name
	 *            The command's name
	 * @return returns true if the name change happened instantly or false if it was
	 *         scheduled for re-registration
	 */
	 ...
	 *            new permission message, null to indicate default message, or an
	 *            empty string to indicate no message
	 * @return this command object, for chaining
	 */
