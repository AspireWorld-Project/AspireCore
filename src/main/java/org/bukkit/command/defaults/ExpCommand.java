...
public class ExpCommand extends VanillaCommand {
	public ExpCommand() {
		super("xp");
		description = "Gives the specified player a certain amount of experience. Specify <amount>L to give levels instead, with a negative amount resulting in taking levels.";
		usageMessage = "/xp <amount> [player] OR /xp <amount>L [player]";
