...
public class ReloadCommand extends BukkitCommand {
	...
	public boolean execute(CommandSender sender, String currentAlias, String[] args) {
		 ...
		 *
		 * org.spigotmc.CustomTimingsHandler.reload(); // Spigot: TODO: Why is this
		 * here? Bukkit.reload(); Command.broadcastCommandMessage(sender,
		 * ChatColor.GREEN + "Reload complete.");
		 */
