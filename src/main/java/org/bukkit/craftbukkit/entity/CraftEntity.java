...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
	...
	public static CraftEntity getEntity(CraftServer server, net.minecraft.entity.Entity entity) {
		...
		if (entity instanceof net.minecraft.entity.EntityLivingBase) {
			...
			if (entity instanceof net.minecraft.entity.player.EntityPlayer) {
				if (entity instanceof net.minecraft.entity.player.EntityPlayerMP)
					return cPlayerCache.getOrCreate((net.minecraft.entity.player.EntityPlayerMP) entity);
				else
					return new CraftPlayer(server,
							FakePlayerFactory.get(DimensionManager.getWorld(entity.worldObj.provider.dimensionId),
				...
				if (entity instanceof net.minecraft.entity.passive.EntityAnimal) {
					if (entity instanceof net.minecraft.entity.passive.EntityChicken)
						...
						if (entity instanceof net.minecraft.entity.passive.EntityWolf)
							...
							return new CraftTameableAnimal(server,
		...
		throw new AssertionError("Unknown entity " + entity == null ? null : entity.getClass() + ": " + entity); // Cauldron
																													// -
																													// show
																													// the
																													// entity
	...
	// Cauldron start - copy of getEntity() but operates on classes instead of
	// instances, for EntityRegistry registerBukkitType
	public static Class<? extends org.bukkit.entity.Entity> getEntityClass(
			Class<? extends net.minecraft.entity.Entity> nmsClass) {
		/**
		 * Order is *EXTREMELY* important -- keep it right! =D
		 */
		// pbpaste|perl -pe's/entity instanceof
		// ([\w.]+)/$1.class.isAssignableFrom(nmsClass)/g'|perl -pe's/return new
		// (\w+)([^;\n]+)/return $1.class/g'
		if (net.minecraft.entity.EntityLivingBase.class.isAssignableFrom(nmsClass)) {
			 ...
			 * (net.minecraft.entity.boss.EntityDragonPart) entity; if (part.entityDragonObj
			 * instanceof net.minecraft.entity.boss.EntityDragon) { return
			 * CraftEnderDragonPart.class; } else { return CraftComplexPart.class; }
			 */
		...
		throw new AssertionError("Unknown entity class " + nmsClass == null ? null : nmsClass); // Cauldron - show the
																								// entity that caused
																								// exception
	}
	...
	public static void initMappings() {
		for (Map.Entry<Class<? extends Entity>, String> entry : EntityRegistry.instance().getEntityTypeMap()
				.entrySet()) {
	...
	private static int getEntityTypeIDfromClass(Class entityClass) {
		...
		Map<Class, Integer> classToIDMapping = cpw.mods.fml.relauncher.ReflectionHelper
				.getPrivateValue(net.minecraft.entity.EntityList.class, null, "field_75624_e", "classToIDMapping");
		if (classToIDMapping.containsKey(entityClass))
			return classToIDMapping.get(entityClass);

		Map<Integer, Class> IDtoClassMapping = cpw.mods.fml.relauncher.ReflectionHelper
				.getPrivateValue(net.minecraft.entity.EntityList.class, null, "field_75623_d", "IDtoClassMapping");
	...
	public Location getLocation() {
		return new Location(getWorld(), entity.posX, entity.posY, entity.posZ, entity.rotationYaw,
	...
	public boolean teleport(Location location, TeleportCause cause) {
		...
		// Spigot
		entity.setPositionAndRotation(location.getX(), location.getY(), location.getZ(), location.getYaw(),
				location.getPitch());
	...
	public List<org.bukkit.entity.Entity> getNearbyEntities(double x, double y, double z) {
		...
		List<net.minecraft.entity.Entity> notchEntityList = entity.worldObj.getEntitiesWithinAABBExcludingEntity(entity,
				entity.boundingBox.expand(x, y, z));
	...
	public void playEffect(EntityEffect type) {
		getHandle().worldObj.setEntityState(getHandle(), type.getData());
	}
