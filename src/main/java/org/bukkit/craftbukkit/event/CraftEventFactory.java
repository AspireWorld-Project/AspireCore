...
import org.ultramine.bukkit.util.ArmorPropertiesUM;
...
public class CraftEventFactory {
	public static final net.minecraft.util.DamageSource MELTING = CraftDamageSource
			.copyOf(net.minecraft.util.DamageSource.onFire);
	public static final net.minecraft.util.DamageSource POISON = CraftDamageSource
			.copyOf(net.minecraft.util.DamageSource.magic);
	 ...
	 */
	// Cauldron start
	public static BlockMultiPlaceEvent callBlockMultiPlaceEvent(net.minecraft.world.World world,
			net.minecraft.entity.player.EntityPlayer who, List<BlockState> blockStates, int clickedX, int clickedY,
			int clickedZ) {
	...
	public static BlockPlaceEvent callBlockPlaceEvent(net.minecraft.world.World world,
			net.minecraft.entity.player.EntityPlayer who, BlockState replacedBlockState, int clickedX, int clickedY,
			int clickedZ) {
		CraftWorld craftWorld = world.getWorld();
		CraftServer craftServer = world.getServer();
		...
		BlockPlaceEvent event = new BlockPlaceEvent(placedBlock, replacedBlockState, blockClicked, is, player,
				canBuild);
		craftServer.getPluginManager().callEvent(event);
	 ...
	 * Bucket methods
	 */
	public static PlayerBucketEmptyEvent callPlayerBucketEmptyEvent(net.minecraft.entity.player.EntityPlayer who,
			int clickedX, int clickedY, int clickedZ, int clickedFace, net.minecraft.item.ItemStack itemInHand) {
		return (PlayerBucketEmptyEvent) getPlayerBucketEvent(false, who, clickedX, clickedY, clickedZ, clickedFace,
				itemInHand, net.minecraft.init.Items.bucket);
	}

	public static PlayerBucketFillEvent callPlayerBucketFillEvent(net.minecraft.entity.player.EntityPlayer who,
			int clickedX, int clickedY, int clickedZ, int clickedFace, net.minecraft.item.ItemStack itemInHand,
			net.minecraft.item.Item bucket) {
		return (PlayerBucketFillEvent) getPlayerBucketEvent(true, who, clickedX, clickedY, clickedZ, clickedFace,
				itemInHand, bucket);
	}

	private static PlayerEvent getPlayerBucketEvent(boolean isFilling, net.minecraft.entity.player.EntityPlayer who,
			int clickedX, int clickedY, int clickedZ, int clickedFace, net.minecraft.item.ItemStack itemstack,
	...
	public static PlayerInteractEvent callPlayerInteractEvent(net.minecraft.entity.player.EntityPlayer who,
			Action action, net.minecraft.item.ItemStack itemstack) {
	 ...
	 * EntityShootBowEvent
	 */
	public static EntityShootBowEvent callEntityShootBowEvent(net.minecraft.entity.EntityLivingBase who,
			net.minecraft.item.ItemStack itemstack, net.minecraft.entity.projectile.EntityArrow entityArrow,
			float force) {
	 ...
	 * BlockDamageEvent
	 */
	public static BlockDamageEvent callBlockDamageEvent(net.minecraft.entity.player.EntityPlayer who, int x, int y,
			int z, net.minecraft.item.ItemStack itemstack, boolean instaBreak) {
		Player player = who == null ? null : (Player) who.getBukkitEntity();
		CraftItemStack itemInHand = CraftItemStack.asCraftMirror(itemstack);
	 ...
	 * CreatureSpawnEvent
	 */
	public static CreatureSpawnEvent callCreatureSpawnEvent(net.minecraft.entity.EntityLivingBase entityliving,
	 ...
	 * EntityTameEvent
	 */
	public static EntityTameEvent callEntityTameEvent(net.minecraft.entity.EntityLiving entity,
			net.minecraft.entity.player.EntityPlayer tamer) {
		org.bukkit.entity.Entity bukkitEntity = entity.getBukkitEntity();
		org.bukkit.entity.AnimalTamer bukkitTamer = (org.bukkit.entity.AnimalTamer) (tamer != null
				? tamer.getBukkitEntity()
				: null);
	 ...
	 * PotionSplashEvent
	 */
	public static PotionSplashEvent callPotionSplashEvent(net.minecraft.entity.projectile.EntityPotion potion,
	...
	public static EntityDeathEvent callEntityDeathEvent(net.minecraft.entity.EntityLivingBase victim,
		...
		victim.setExpToDrop(event.getDroppedExp());
		// Cauldron start - handle any drop changes from plugins
		victim.capturedDrops.clear();
		for (org.bukkit.inventory.ItemStack stack : event.getDrops()) {
			net.minecraft.entity.item.EntityItem entityitem = new net.minecraft.entity.item.EntityItem(victim.worldObj,
	...
	public static PlayerDeathEvent callPlayerDeathEvent(net.minecraft.entity.player.EntityPlayerMP victim,
		...
		victim.setKeepLevel(event.getKeepLevel());
		victim.setNewLevel(event.getNewLevel());
		victim.setNewTotalExp(event.getNewTotalExp());
		victim.setExpToDrop(event.getDroppedExp());
		victim.setNewExp(event.getNewExp());
		...
		for (org.bukkit.inventory.ItemStack stack : event.getDrops()) {
			...
			// world.dropItemNaturally(entity.getLocation(), stack); // handle world drop in
			// EntityPlayerMP
			if (victim.captureDrops) {
				net.minecraft.entity.item.EntityItem entityitem = new net.minecraft.entity.item.EntityItem(
						victim.worldObj, entity.getLocation().getX(), entity.getLocation().getY(),
						entity.getLocation().getZ(), CraftItemStack.asNMSCopy(stack));
				if (entityitem != null) {
					victim.capturedDrops.add(entityitem);
				}
			}
	...
	private static EntityDamageEvent handleEntityDamageEvent(Entity entity, DamageSource source,
		...
		if (source == DamageSource.inFire) {
			...
			return new EntityDamageEvent(entity.getBukkitEntity(), DamageCause.CUSTOM, modifiers, modifierFunctions); // use
																														// custom
	...
	public static EntityDamageEvent handleLivingEntityDamageEvent(final EntityLivingBase entity,
		...
		return CraftEventFactory.handleLivingEntityDamageEvent(entity, damagesource, originalDamage, hardHatModifier,
				blockingModifier, armorModifier, resistanceModifier, magicModifier, absorptionModifier, hardHat,
				blocking, armor, resistance, magic, absorption);
	}

	// Non-Living Entities such as EntityEnderCrystal, EntityItemFrame, and
	// EntityFireball need to call this
	...
	public static PlayerExpChangeEvent callPlayerExpChangeEvent(net.minecraft.entity.player.EntityPlayer entity,
			int expAmount) {
	...
	public static void handleBlockGrowEvent(net.minecraft.world.World world, int x, int y, int z,
			net.minecraft.block.Block type, int data) {
	...
	public static FoodLevelChangeEvent callFoodLevelChangeEvent(net.minecraft.entity.player.EntityPlayer entity,
			int level) {
	...
	public static PigZapEvent callPigZapEvent(net.minecraft.entity.Entity pig, net.minecraft.entity.Entity lightning,
			net.minecraft.entity.Entity pigzombie) {
	...
	public static EntityChangeBlockEvent callEntityChangeBlockEvent(net.minecraft.entity.Entity entity, Block block,
			Material material) {
		return callEntityChangeBlockEvent(entity.getBukkitEntity(), block, material, 0);
	}

	public static EntityChangeBlockEvent callEntityChangeBlockEvent(net.minecraft.entity.Entity entity, Block block,
			Material material, boolean cancelled) {
		return callEntityChangeBlockEvent(entity.getBukkitEntity(), block, material, 0, cancelled);
	}

	public static EntityChangeBlockEvent callEntityChangeBlockEvent(net.minecraft.entity.Entity entity, int x, int y,
			int z, net.minecraft.block.Block type, int data) {
	...
	public static CreeperPowerEvent callCreeperPowerEvent(net.minecraft.entity.Entity creeper,
			net.minecraft.entity.Entity lightning, CreeperPowerEvent.PowerCause cause) {
	...
	public static EntityTargetEvent callEntityTargetEvent(net.minecraft.entity.Entity entity,
			net.minecraft.entity.Entity target, EntityTargetEvent.TargetReason reason) {
	...
	public static EntityTargetLivingEntityEvent callEntityTargetLivingEvent(net.minecraft.entity.Entity entity,
			net.minecraft.entity.EntityLivingBase target, EntityTargetEvent.TargetReason reason) {
	...
	public static EntityBreakDoorEvent callEntityBreakDoorEvent(net.minecraft.entity.Entity entity, int x, int y,
			int z) {
	...
	public static net.minecraft.inventory.Container callInventoryOpenEvent(
			net.minecraft.entity.player.EntityPlayerMP player, net.minecraft.inventory.Container container) {
	...
	public static net.minecraft.inventory.Container callInventoryOpenEvent(
			net.minecraft.entity.player.EntityPlayerMP player, net.minecraft.inventory.Container container,
			boolean closeInv) {
		if (container.isOpened() || container.isClosedByEventCancelling())
			return container;
		if (player.openContainer != player.inventoryContainer && closeInv) { // fire INVENTORY_CLOSE if one already open
			...
			packetCloseWindow.setWindowId(player.openContainer.windowId);
		...
		if (event.isCancelled()) {
			...
			container.setClosedByEventCancelling(true);
	...
	// public static net.minecraft.item.ItemStack
	// callPreCraftEvent(net.minecraft.inventory.InventoryCrafting matrix,
	// net.minecraft.item.ItemStack result, InventoryView lastCraftView, boolean
	// isRepair) {
	// CraftInventoryCrafting inventory = new CraftInventoryCrafting(matrix,
	// matrix.resultInventory);
	// inventory.setResult(CraftItemStack.asCraftMirror(result));
	//
	// PrepareItemCraftEvent event = new PrepareItemCraftEvent(inventory,
	// lastCraftView, isRepair);
	// Bukkit.getPluginManager().callEvent(event);
	//
	...
	public static BlockRedstoneEvent callRedstoneChange(net.minecraft.world.World world, int x, int y, int z,
	...
	public static NotePlayEvent callNotePlayEvent(net.minecraft.world.World world, int x, int y, int z, byte instrument,
			byte note) {
	...
	public static void callPlayerItemBreakEvent(net.minecraft.entity.player.EntityPlayer human,
			net.minecraft.item.ItemStack brokenItem) {
		CraftItemStack item = CraftItemStack.asCraftMirror(brokenItem);
		PlayerItemBreakEvent event = new PlayerItemBreakEvent((Player) human.getBukkitEntity(), item);
		Bukkit.getPluginManager().callEvent(event);
	}

	public static BlockIgniteEvent callBlockIgniteEvent(net.minecraft.world.World world, int x, int y, int z,
			int igniterX, int igniterY, int igniterZ) {
	...
	public static BlockIgniteEvent callBlockIgniteEvent(net.minecraft.world.World world, int x, int y, int z,
			net.minecraft.entity.Entity igniter) {
		org.bukkit.World bukkitWorld = world.getWorld();
	...
	public static BlockIgniteEvent callBlockIgniteEvent(net.minecraft.world.World world, int x, int y, int z,
			IgniteCause cause, net.minecraft.entity.Entity igniter) {
	...
	public static void handleInventoryCloseEvent(net.minecraft.entity.player.EntityPlayer human) {
		InventoryView view = human.openContainer.getBukkitView();
		if (view != null) {
			if (human.openContainer == human.inventoryContainer) {
				IInventoryTransactionProvider topInventoryProvider = (IInventoryTransactionProvider) ((CraftInventory) view
						.getTopInventory()).getInventory();
	...
	public static PlayerEditBookEvent handleEditBookEvent(net.minecraft.entity.player.EntityPlayerMP player,
		...
		return editBookEvent;
	}

	public static void handleEditBookEvent(net.minecraft.entity.player.EntityPlayerMP player,
		...
		if (itemInHand != null && itemInHand.getItem() == net.minecraft.init.Items.writable_book) {
			...
			net.minecraft.inventory.Slot slot = player.openContainer.getSlotFromInventory(player.inventory,
					itemInHandIndex);
	...
	public static PlayerUnleashEntityEvent callPlayerUnleashEntityEvent(net.minecraft.entity.EntityLiving entity,
	...
	public static PlayerLeashEntityEvent callPlayerLeashEntityEvent(net.minecraft.entity.EntityLiving entity,
			net.minecraft.entity.Entity leashHolder, net.minecraft.entity.player.EntityPlayer player) {
	...
	public static Cancellable handleStatisticsIncrease(EntityPlayer entityHuman, net.minecraft.stats.StatBase statistic,
			int current, int incrementation) {
		...
		if (statistic instanceof net.minecraft.stats.Achievement) {
			...
			event = new PlayerAchievementAwardedEvent(player,
					CraftStatistic.getBukkitAchievement((net.minecraft.stats.Achievement) statistic));
		} else {
	...
	// Cauldron start
	public static BlockBreakEvent callBlockBreakEvent(net.minecraft.world.World world, int x, int y, int z,
		...
		if (!(playermp instanceof FakePlayer)) {
			if (!(playermp.theItemInWorldManager.getGameType().isAdventure()
					&& !playermp.isCurrentToolAdventureModeExempt(x, y, z))
					&& !(playermp.theItemInWorldManager.getGameType().isCreative() && playermp.getHeldItem() != null
							&& playermp.getHeldItem().getItem() instanceof ItemSword)) {
				int exp = 0;
				if (!(block == null || !player.canHarvestBlock(block) || // Handle empty block or player unable to break
																			// block scenario
						block.canSilkHarvest(world, player, x, y, z, blockMetadata)
								&& EnchantmentHelper.getSilkTouchModifier(player))) // If the block is being silk
																					// harvested, the exp dropped is 0
				{
