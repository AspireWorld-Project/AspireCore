...
public class CraftContainer extends net.minecraft.inventory.Container {
	...
	public boolean isPlayerNotUsingContainer(net.minecraft.entity.player.EntityPlayer entityhuman) {
		...
		if (view.getPlayer() instanceof CraftPlayer) {
			...
			int size = getSize();
			player.getHandle().playerNetServerHandler.sendPacket(
					new net.minecraft.network.play.server.S2DPacketOpenWindow(windowId, type, cachedTitle, size, true));
	...
	private void setupChest(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
		...
		for (row = 0; row < rows; ++row) {
			for (col = 0; col < 9; ++col) {
				addSlotToContainer(new net.minecraft.inventory.Slot(top, col + row * 9, 8 + col * 18, 18 + row * 18));
			}
		}
		...
		for (row = 0; row < 3; ++row) {
			for (col = 0; col < 9; ++col) {
				addSlotToContainer(
						new net.minecraft.inventory.Slot(bottom, col + row * 9 + 9, 8 + col * 18, 103 + row * 18 + i));
			}
		}

		for (col = 0; col < 9; ++col) {
			addSlotToContainer(new net.minecraft.inventory.Slot(bottom, col, 8 + col * 18, 161 + i));
		}
	...
	private void setupWorkbench(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
		...
		addSlotToContainer(new net.minecraft.inventory.Slot(top, 0, 124, 35));
		...
		for (row = 0; row < 3; ++row) {
			for (col = 0; col < 3; ++col) {
				addSlotToContainer(
						new net.minecraft.inventory.Slot(top, 1 + col + row * 3, 30 + col * 18, 17 + row * 18));
			}
		}
		...
		for (row = 0; row < 3; ++row) {
			for (col = 0; col < 9; ++col) {
				addSlotToContainer(
						new net.minecraft.inventory.Slot(bottom, col + row * 9 + 9, 8 + col * 18, 84 + row * 18));
			}
		}

		for (col = 0; col < 9; ++col) {
			addSlotToContainer(new net.minecraft.inventory.Slot(bottom, col, 8 + col * 18, 142));
		}
	...
	private void setupFurnace(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
		...
		addSlotToContainer(new net.minecraft.inventory.Slot(top, 0, 56, 17));
		addSlotToContainer(new net.minecraft.inventory.Slot(top, 1, 56, 53));
		addSlotToContainer(new net.minecraft.inventory.Slot(top, 2, 116, 35));
	...
	private void setupDispenser(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
		...
		for (row = 0; row < 3; ++row) {
			for (col = 0; col < 3; ++col) {
				addSlotToContainer(new net.minecraft.inventory.Slot(top, col + row * 3, 61 + col * 18, 17 + row * 18));
			}
		}
	...
	private void setupEnchanting(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
		...
		addSlotToContainer(new net.minecraft.inventory.Slot(top, 0, 25, 47));
		...
		for (row = 0; row < 3; ++row) {
			for (int i1 = 0; i1 < 9; ++i1) {
				addSlotToContainer(
						new net.minecraft.inventory.Slot(bottom, i1 + row * 9 + 9, 8 + i1 * 18, 84 + row * 18));
			}
		}

		for (row = 0; row < 9; ++row) {
			addSlotToContainer(new net.minecraft.inventory.Slot(bottom, row, 8 + row * 18, 142));
		}
	...
	private void setupBrewing(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
		...
		addSlotToContainer(new net.minecraft.inventory.Slot(top, 0, 56, 46));
		addSlotToContainer(new net.minecraft.inventory.Slot(top, 1, 79, 53));
		addSlotToContainer(new net.minecraft.inventory.Slot(top, 2, 102, 46));
		addSlotToContainer(new net.minecraft.inventory.Slot(top, 3, 79, 17));

		int i;

		for (i = 0; i < 3; ++i) {
			for (int j = 0; j < 9; ++j) {
				addSlotToContainer(new net.minecraft.inventory.Slot(bottom, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
			}
		}

		for (i = 0; i < 9; ++i) {
			addSlotToContainer(new net.minecraft.inventory.Slot(bottom, i, 8 + i * 18, 142));
		}
	...
	private void setupHopper(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
		...
		for (i = 0; i < top.getSizeInventory(); ++i) {
			addSlotToContainer(new net.minecraft.inventory.Slot(top, i, 44 + i * 18, 20));
		}

		for (i = 0; i < 3; ++i) {
			for (int j = 0; j < 9; ++j) {
				addSlotToContainer(new net.minecraft.inventory.Slot(bottom, j + i * 9 + 9, 8 + j * 18, i * 18 + b0));
			}
		}

		for (i = 0; i < 9; ++i) {
			addSlotToContainer(new net.minecraft.inventory.Slot(bottom, i, 8 + i * 18, 58 + b0));
		}
