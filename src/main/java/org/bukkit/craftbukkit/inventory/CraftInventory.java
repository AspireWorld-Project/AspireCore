...
public class CraftInventory implements Inventory {
	...
	public ItemStack[] getContents() {
		return BukkitUtil.getBukkitContents(getInventory());
	}

	@Override
	public void setContents(ItemStack[] items) {
		net.minecraft.inventory.IInventory inv = getInventory();
	...
	public void setItem(int index, ItemStack item) {
		getInventory().setInventorySlotContents(index,
	...
	public List<HumanEntity> getViewers() {
		if (inventory instanceof IInventoryTransactionProvider)
			return ((IInventoryTransactionProvider) inventory).getViewers();
		else
	...
	public InventoryType getType() {
		net.minecraft.inventory.IInventory inventory = getInventory();
		...
		// } else if (inventory instanceof
		// net.minecraft.inventory.ContainerEnchantTableInventory) { // TODO
		...
		// } else if (inventory instanceof
		// net.minecraft.inventory.ContainerRepairInventory) { // TODO
	...
	public InventoryHolder getHolder() {
		return BukkitUtil.getInventoryOwner(getInventory());
	}
	...
	public void setMaxStackSize(int size) {
		// inventory.setMaxStackSize(size); // TODO
	}
	...
	public boolean equals(final Object obj) {
		return obj instanceof CraftInventory && ((CraftInventory) obj).getInventory().equals(getInventory());
	}
}
