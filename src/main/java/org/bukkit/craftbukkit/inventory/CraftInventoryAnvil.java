...
public class CraftInventoryAnvil extends CraftInventory implements AnvilInventory {
	...
	public CraftInventoryAnvil(net.minecraft.inventory.IInventory inventory,
	...
	public ItemStack getItem(int slot) {
		if (slot < getIngredientsInventory().getSizeInventory()) {
			...
			net.minecraft.item.ItemStack item = getResultInventory()
					.getStackInSlot(slot - getIngredientsInventory().getSizeInventory());
			return item == null ? null : CraftItemStack.asCraftMirror(item);
		}
	}
	...
	public void setItem(int index, ItemStack item) {
		if (index < getIngredientsInventory().getSizeInventory()) {
			getIngredientsInventory().setInventorySlotContents(index,
					item == null ? null : CraftItemStack.asNMSCopy(item));
		} else {
			getResultInventory().setInventorySlotContents(index - getIngredientsInventory().getSizeInventory(),
					item == null ? null : CraftItemStack.asNMSCopy(item));
		}
	}
