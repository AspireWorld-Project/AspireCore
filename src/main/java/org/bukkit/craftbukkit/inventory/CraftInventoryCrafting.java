...
public class CraftInventoryCrafting extends CraftInventory implements CraftingInventory {
	...
	public CraftInventoryCrafting(net.minecraft.inventory.InventoryCrafting inventory,
			net.minecraft.inventory.IInventory resultInventory) {
		super(inventory);
	...
	public void setItem(int index, ItemStack item) {
		if (index < getResultInventory().getSizeInventory()) {
			...
			getMatrixInventory().setInventorySlotContents(index - getResultInventory().getSizeInventory(),
	...
	public Recipe getRecipe() {
		IRecipe recipe = ((net.minecraft.inventory.InventoryCrafting) getInventory()).getCurrentRecipe();
		if (recipe != null) {
			if (recipe instanceof ShapelessRecipes)
				return ((ShapelessRecipes) recipe).toBukkitRecipe();
			else if (recipe instanceof ShapedRecipes)
				return ((ShapedRecipes) recipe).toBukkitRecipe();
		}
