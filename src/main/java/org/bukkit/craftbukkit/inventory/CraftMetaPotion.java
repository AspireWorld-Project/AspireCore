...
class CraftMetaPotion extends CraftMetaItem implements PotionMeta {
	...
	CraftMetaPotion(CraftMetaItem meta) {
		...
		if (potionMeta.hasCustomEffects()) {
			customEffects = new ArrayList<>(potionMeta.customEffects);
		}
	}
	...
	public CraftMetaPotion clone() {
		...
		if (customEffects != null) {
			clone.customEffects = new ArrayList<>(customEffects);
		}
		return clone;
	}
	...
	public boolean equalsCommon(CraftMetaItem meta) {
		...
		if (meta instanceof CraftMetaPotion) {
			...
			return hasCustomEffects() ? that.hasCustomEffects() && customEffects.equals(that.customEffects)
	...
	Builder<String, Object> serialize(Builder<String, Object> builder) {
		...
		if (hasCustomEffects()) {
			builder.put(POTION_EFFECTS.BUKKIT, ImmutableList.copyOf(customEffects));
		}
