...
public class CraftBlockProjectileSource implements BlockProjectileSource {
	...
	public Block getBlock() {
		return dispenserBlock.getWorldObj().getWorld().getBlockAt(dispenserBlock.xCoord, dispenserBlock.yCoord,
				dispenserBlock.zCoord);
	}
	...
	public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity) {
		...
		net.minecraft.block.BlockSourceImpl isourceblock = new net.minecraft.block.BlockSourceImpl(
				dispenserBlock.getWorldObj(), dispenserBlock.xCoord, dispenserBlock.yCoord, dispenserBlock.zCoord);
		// Copied from DispenseBehaviorProjectile
		net.minecraft.dispenser.IPosition iposition = net.minecraft.block.BlockDispenser.func_149939_a(isourceblock);
		net.minecraft.util.EnumFacing enumfacing = net.minecraft.block.BlockDispenser
				.func_149937_b(isourceblock.getBlockMetadata());
		net.minecraft.world.World world = dispenserBlock.getWorldObj();
		net.minecraft.entity.Entity launch = null;

		if (Snowball.class.isAssignableFrom(projectile)) {
			launch = new net.minecraft.entity.projectile.EntitySnowball(world, iposition.getX(), iposition.getY(),
					iposition.getZ());
		} else if (Egg.class.isAssignableFrom(projectile)) {
			launch = new net.minecraft.entity.projectile.EntityEgg(world, iposition.getX(), iposition.getY(),
					iposition.getZ());
			...
			launch = new net.minecraft.entity.item.EntityExpBottle(world, iposition.getX(), iposition.getY(),
					iposition.getZ());
		} else if (ThrownPotion.class.isAssignableFrom(projectile)) {
			launch = new net.minecraft.entity.projectile.EntityPotion(world, iposition.getX(), iposition.getY(),
					iposition.getZ(), CraftItemStack.asNMSCopy(new ItemStack(Material.POTION, 1)));
		} else if (Arrow.class.isAssignableFrom(projectile)) {
			launch = new net.minecraft.entity.projectile.EntityArrow(world, iposition.getX(), iposition.getY(),
					iposition.getZ());
		...
		if (launch instanceof net.minecraft.entity.IProjectile) {
			...
			// Copied from DispenseBehaviorProjectile
			((net.minecraft.entity.IProjectile) launch).setThrowableHeading(enumfacing.getFrontOffsetX(),
					enumfacing.getFrontOffsetY() + 0.1F, enumfacing.getFrontOffsetZ(), b, a);
		}
