...
public final class CraftScoreboardManager implements ScoreboardManager {
	...
	public CraftScoreboardManager(net.minecraft.server.MinecraftServer minecraftserver,
			net.minecraft.scoreboard.Scoreboard scoreboardServer) {
	...
	public void setPlayerBoard(CraftPlayer player, org.bukkit.scoreboard.Scoreboard bukkitScoreboard)
		...
		HashSet<net.minecraft.scoreboard.ScoreObjective> removed = new HashSet<>();
		for (int i = 0; i < 3; ++i) {
			...
			if (scoreboardobjective != null && !removed.contains(scoreboardobjective)) {
				entityplayer.playerNetServerHandler.sendPacket(
						new net.minecraft.network.play.server.S3BPacketScoreboardObjective(scoreboardobjective, 1));
		...
		while (iterator.hasNext()) {
			net.minecraft.scoreboard.ScorePlayerTeam scoreboardteam = (net.minecraft.scoreboard.ScorePlayerTeam) iterator
					.next();
			entityplayer.playerNetServerHandler
					.sendPacket(new net.minecraft.network.play.server.S3EPacketTeams(scoreboardteam, 1));
		}

		// The above is the reverse of the below method.
		server.getConfigurationManager().sendScoreboard((net.minecraft.scoreboard.ServerScoreboard) newboard,
				player.getHandle());
	}
	...
	public Collection<net.minecraft.scoreboard.Score> getScoreboardScores(
			net.minecraft.scoreboard.IScoreObjectiveCriteria criteria, String name,
			Collection<net.minecraft.scoreboard.Score> collection) {
	...
	// CraftBukkit method
	public void updateAllScoresForList(net.minecraft.scoreboard.IScoreObjectiveCriteria criteria, String name,
			List<net.minecraft.entity.player.EntityPlayerMP> of) {
		for (net.minecraft.scoreboard.Score score : getScoreboardScores(criteria, name,
				new ArrayList<net.minecraft.scoreboard.Score>())) {
