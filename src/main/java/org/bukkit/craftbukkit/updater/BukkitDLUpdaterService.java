...
public class BukkitDLUpdaterService {
	...
	private String getUserAgent() {
		return "CraftBukkit/" + BukkitDLUpdaterService.class.getPackage().getImplementationVersion() + "/"
	...
	public ArtifactDetails fetchArtifact(String slug) throws IOException {
		...
		try {
			...
			Gson gson = new GsonBuilder().registerTypeAdapter(Date.class, dateDeserializer)
