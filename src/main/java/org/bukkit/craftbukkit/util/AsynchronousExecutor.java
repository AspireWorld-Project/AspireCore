 ...
 *
 * @param <P>
 *            The type of parameter you provide to make the object that will be
 *            created. It should implement {@link Object#hashCode()} and
 *            {@link Object#equals(Object)} if you want to get the value early.
 * @param <T>
 *            The type of object you provide. This is created in stage 1, and
 *            passed to stage 2, 3, and returned if get() is called.
 * @param <C>
 *            The type of callback you provide. You may register many of these
 *            to be passed to the provider in stage 3, one at a time.
 * @param <E>
 *            A type of exception you may throw and expect to be handled by the
 *            main thread
...
public final class AsynchronousExecutor<P, T, C, E extends Throwable> {
	...
	public static interface CallBackProvider<P, T, C, E extends Throwable> extends ThreadFactory {
		 ...
		 *            the previously created object
		 * @param callback
		 *            the current callback to execute
		 */
	 ...
	 *             if parameter is not in the queue anymore
	 * @throws IllegalStateException
	 *             if the callback was not specified for given parameter
	 */
	 ...
	 *
	 * @throws IllegalStateException
	 *             if the parameter is not in the queue anymore, or sometimes if
	 *             called from asynchronous thread
	 */
