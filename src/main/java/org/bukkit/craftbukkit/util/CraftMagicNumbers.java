...
public final class CraftMagicNumbers implements UnsafeValues {
	...
	public static net.minecraft.block.Block getBlock(Material material) {
		material = material == null ? Material.AIR : material; // Cauldron - this should not happen but just in case it
																// does
		// TODO: Don't use ID
	...
	public ItemStack modifyItemStack(ItemStack stack, String arguments) {
		...
		try {
			nmsStack.setTagCompound(
					(net.minecraft.nbt.NBTTagCompound) net.minecraft.nbt.JsonToNBT.func_150315_a(arguments));
