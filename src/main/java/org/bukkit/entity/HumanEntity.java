...
public interface HumanEntity extends LivingEntity, AnimalTamer, Permissible, InventoryHolder {
	 ...
	 *
	 * @param location
	 *            The location to attach it to. If null, the player's location is
	 *            used.
	 * @param force
	 *            If false, and there is no workbench block at the location, no
	 ...
	 *            used.
	 * @param force
	 *            If false, and there is no enchanting table at the location, no
	 *            inventory will be opened and null will be returned.
	 * @return The newly opened inventory view, or null if it could not be opened.
	 */
