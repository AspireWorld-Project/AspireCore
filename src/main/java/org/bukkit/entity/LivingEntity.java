...
public interface LivingEntity extends Entity, Damageable, ProjectileSource {
	 ...
	 *
	 * @param transparent
	 *            HashSet containing all transparent block IDs (set to null for only
	 *            air)
	 * @param maxDistance
	 *            this is the maximum distance to scan (may be limited by server by
	 *            at least 100 blocks, no less)
	 ...
	 *            air)
	 * @param maxDistance
	 *            this is the maximum distance to scan. This may be further limited
	 *            by the server, but never to less than 100 blocks
