...
public interface Player extends HumanEntity, Conversable, CommandSender, OfflinePlayer, PluginMessageRecipient {
	 ...
	 * @param sx
	 *            The x size of the cuboid
	 * @param sy
	 *            The y size of the cuboid
	 * @param sz
	 *            The z size of the cuboid
	 * @param data
	 *            The data to be sent
	 ...
	 *
	 * @param time
	 *            The current player's perceived time or the player's time offset
	 ...
	 *
	 * @param url
	 *            The URL from which the client will download the texture pack. The
	 ...
	 *
	 * @param url
	 *            The URL from which the client will download the resource pack. The
	 *            string must contain only US-ASCII characters and should be encoded
	 *            as per RFC 1738.
	 * @throws IllegalArgumentException
	 *             Thrown if the URL is null.
	 ...
	 *             {@link org.bukkit.scoreboard.ScoreboardManager scoreboard
	 *             manager}
