...
public class EntityDamageEvent extends EntityEvent implements Cancellable {
	...
	public EntityDamageEvent(final Entity damagee, final DamageCause cause, final Map<DamageModifier, Double> modifiers,
		...
		originals = new EnumMap<>(modifiers);
		this.cause = cause;
	 ...
	 *             if the caller does not support the particular DamageModifier, or
	 *             to rephrase, when {@link #isApplicable(DamageModifier)} returns
	 *             false
	 * @see #getFinalDamage()
	 */
