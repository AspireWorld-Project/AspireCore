 ...
 *
 * This event will fire from the main thread and allows the use of all of the
 * Bukkit API, unlike the {@link AsyncPlayerChatEvent}.
 * <p>
 * Listening to this event forces chat to wait for the main thread which causes
 * delays for chat. {@link AsyncPlayerChatEvent} is the encouraged alternative
...
public class PlayerChatEvent extends PlayerEvent implements Cancellable {
	...
	public PlayerChatEvent(final Player player, final String message) {
		...
		format = "<%1$s> %2$s";
		recipients = new HashSet<>(player.getServer().getOnlinePlayers());
	}
