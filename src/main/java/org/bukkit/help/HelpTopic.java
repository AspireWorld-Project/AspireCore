...
public abstract class HelpTopic {
	 ...
	 *            The permission node the server administrator wishes to apply to
	 *            this topic.
	 */
	 ...
	 *
	 * @param forWho
	 *            The player or console requesting the full text. Useful for further
	 *            security trimming the command's full text based on sub-permissions
