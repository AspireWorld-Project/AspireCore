...
public class ItemStack implements Cloneable, ConfigurationSerializable {
	 ...
	 *             if the specified stack is null or returns an item meta not
	...
	public void setTypeId(int type) {
		this.type = type;
		if (meta != null) {
			meta = Bukkit.getItemFactory().asMetaFor(meta, getType0());
		}
		createData((byte) 0);
	}
	...
	public MaterialData getData() {
		...
		if (data == null && mat != null && mat.getData() != null) {
			data = mat.getNewData((byte) getDurability());
		}
	 ...
	 * @throws IllegalArgumentException
	 *             if any specific enchantment or level is null. <b>Warning</b>:
	 *             Some enchantments may be added before this exception is thrown.
	 */
	@Utility
	...
	public ItemMeta getItemMeta() {
		return meta == null ? Bukkit.getItemFactory().getItemMeta(getType0()) : meta.clone();
	}
	 ...
	 * @throws IllegalArgumentException
	 *             if the item meta was not created by the {@link ItemFactory}
	 */
