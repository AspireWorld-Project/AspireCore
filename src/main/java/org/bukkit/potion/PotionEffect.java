...
public class PotionEffect implements ConfigurationSerializable {
	 ...
	 *            effect type
	 * @param duration
	 *            measured in ticks, see {@link PotionEffect#getDuration()}
	 * @param amplifier
	 *            the amplifier, see {@link PotionEffect#getAmplifier()}
	 * @param ambient
	 *            the ambient status, see {@link PotionEffect#isAmbient()}
	 */
	...
	public boolean equals(Object obj) {
		...
		return type.equals(that.type) && ambient == that.ambient && amplifier == that.amplifier
