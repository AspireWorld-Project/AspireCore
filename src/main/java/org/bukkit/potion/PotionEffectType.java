...
public abstract class PotionEffectType {
	...
	private static final Map<Integer, PotionEffectType> byId = new HashMap<>(); // Cauldron
																				// change
																				// underlying
																				// storage
																				// to map
	...
	public static void registerPotionEffectType(PotionEffectType type) {
		 ...
		 * byName.containsKey(type.getName().toLowerCase())) { throw new
		 * IllegalArgumentException("Cannot set already-set type"); } else if
		 * (!acceptingNew) { throw new IllegalStateException(
