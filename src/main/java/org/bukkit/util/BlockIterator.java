...
public class BlockIterator implements Iterator<Block> {
	 ...
	 * @param yOffset
	 *            The trace begins vertically offset from the start vector by this
	 *            value
	 * @param maxDistance
	 *            This is the maximum distance in blocks for the trace. Setting this
	 *            value above 140 may lead to problems with unloaded chunks. A value
