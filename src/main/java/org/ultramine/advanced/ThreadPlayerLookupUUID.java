...
public class ThreadPlayerLookupUUID extends Thread {
   ...
   public ThreadPlayerLookupUUID(NetHandlerLoginServer p_i45296_1_, String p_i45296_2_) {
        super(p_i45296_2_);
    ...
    public void run() {
        ...
        try {
            ...
            if (profile != null) {
                ...
                NetHandlerLoginServer.setLoginState(this.field_151292_a, NetHandlerLoginServer.LoginState.READY_TO_ACCEPT);
            } else {
            ...
            this.field_151292_a.func_147322_a("Failed to verify username!");
            UMBukkitImplMod.getServer().getLogger().log(java.util.logging.Level.WARNING, "Exception verifying " + NetHandlerLoginServer.getGameProfile(this.field_151292_a).getName(), exception);
            // CraftBukkit end
        }
    }
    ...
    private void fireLoginEvents() throws Exception {
        ...
        UMBukkitImplMod.getServer().getPluginManager().callEvent(asyncEvent);
