...
public class InjectedPluginClassLoader extends PluginClassLoader {
	...
	public InjectedPluginClassLoader(JavaPluginLoader loader, LaunchClassLoader parent, String pkg,
			PluginDescriptionFile description) throws InvalidPluginException {
