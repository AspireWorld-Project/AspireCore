...
import org.ultramine.bukkit.injected.internal.permissions.c2b.BukkitPermissionsServiceLoader;
...
public class InjectedUltramineCorePlugin extends JavaPlugin {
	...
	private static final ServiceManager services = (ServiceManager) ServiceBytecodeAdapter
			.provideService(ServiceManager.class);
	private static final EconomyRegistry economyRegistry = (EconomyRegistry) ServiceBytecodeAdapter
			.provideService(EconomyRegistry.class);
	...
	private boolean setupVaultEconomy() {
		...
		economyRegistry.registerCurrency("bukkit", economy.currencyNameSingular(), economy.currencyNamePlural(), "$",
				fractionalDigits, 100, new HoldingsFactory() {
					@Nonnull
					@Override
					public Holdings createHoldings(@Nonnull Account account, @Nonnull Currency currency)
						...
						return new VaultEconomyPlayerHoldings(economy, playerAccount,
