...
public class ClassGenUtils {
	...
	public static <T> Class<? extends T> makeOneArgMethodDelegate(Class<?> base, String name, Method method,
			Class<T> iface) {
			...
			if (!m.isDefault()) {
				if (frontMethod != null)
					throw new IllegalArgumentException(
							"iface should be a functional interface, i.e. contains only one abstract method");
				frontMethod = m;
			}
		}
		if (frontMethod == null)
