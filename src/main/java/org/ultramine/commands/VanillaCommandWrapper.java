...
public class VanillaCommandWrapper implements IExtendedCommand {
	...
	public VanillaCommandWrapper(ICommand wrappedCommand, String group) {
		...
		this.group = group;
		permission = "command." + group + "." + wrappedCommand.getCommandName();
		description = "command." + wrappedCommand.getCommandName().toLowerCase() + ".description";
	}
	...
	public boolean canCommandSenderUseCommand(ICommandSender var1) {
		return perms.useVanillaCommandPermissions() ? wrappedCommand.canCommandSenderUseCommand(var1)
				: perms.has(var1, permission) || !(var1 instanceof EntityPlayer);
	}
