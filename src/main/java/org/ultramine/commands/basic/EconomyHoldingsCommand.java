...
public class EconomyHoldingsCommand
{
    ...
    public static void money(CommandContext ctx)
    {
        ...
        ctx.finishAfter(holdings.asAsync().getBalance().thenAcceptAsync(balance -> ctx.sendMessage(DARK_GREEN, GREEN, "command.money.info", holdings.getAccount().getName(), cur.format(balance)), GlobalExecutors.syncServer()));
    }
