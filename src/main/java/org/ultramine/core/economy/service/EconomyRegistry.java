...
public interface EconomyRegistry {
	@Nonnull
	UndoableValue<Currency> registerCurrency(@Nonnull String id, @Nonnull String name, @Nonnull String pluralName,
			@Nonnull String sign, int fractionalDigits, int priority);

	@Nonnull
	UndoableValue<Currency> registerCurrency(@Nonnull String id, @Nonnull String name, @Nonnull String pluralName,
			@Nonnull String sign, int fractionalDigits, int priority, @Nonnull HoldingsFactory factory);
