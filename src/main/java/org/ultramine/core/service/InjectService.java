...
/**
 * For any annotated field bytecode transformation will be applied for the
 * corresponding service provider injection. The field should be declared as
 * static and non-final. After transformation field become final. Example:
 * <br />
 *
 * <pre>
 * <code>
