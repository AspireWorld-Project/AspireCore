...
public class UMBootstrap {
	...
	public static void handleFirstLine(String[] args) {
		setSysPropertyIfNotPresent("Log4jContextSelector",
				"org.apache.logging.log4j.core.async.AsyncLoggerContextSelector"); // always async logging
	...
	private static void setupTerminal(String[] args) {
		...
		String terminal = System.getProperty("org.ultramine.terminal", contains(args, "nojline") ? "default" : "jline")
				.toLowerCase();
	...
	private static void showGreeting() {
		...
		String reset_ansi = "\u001b\u005b\u006d";
		System.out.println((isColoredTerminal() ? isAnsiColors() ? yellow_ansi : "\u00A7e" : "")
				+ "================[ Starting UltraMine server ]================" + (isAnsiColors() ? reset_ansi : ""));
	}
