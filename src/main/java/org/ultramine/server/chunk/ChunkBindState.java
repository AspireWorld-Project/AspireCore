...
public enum ChunkBindState {
	 ...
	 * памяти до тех пор, пока не будет помечен к отгрузке вручную (например, в него
	 * зайдет и выйдет игрок). Но у нас чанк будет выгружен через некоторое время.
	 */
	LEAK,
	/**
	 * Чанк обнаружен в списке PersistentChunks, созданного форжей для всяких
	 * чанклоадеров. Не будет выгружен до тех пор, пока не исчезнет из этого списка.
	 */
	FORGE,
	/**
