...
public class ChunkSnapshot {
	...
	public static ChunkSnapshot of(Chunk chunk) {
		...
		return new ChunkSnapshot(chunk.xPosition, chunk.zPosition, chunk.worldObj.provider.hasNoSky, ebsNew,
	...
	public ChunkSnapshot copy() {
		...
		return new ChunkSnapshot(getX(), getZ(), isWorldHasNoSky(), ebsNew,
				Arrays.copyOf(biomeArray, biomeArray.length));
	}
