...
public class CurrencyImpl implements Currency {
	@Nullable
	private final HoldingsFactory factory;
	@Nonnull
	...
	public CurrencyImpl(@Nullable HoldingsFactory factory, @Nonnull String id, @Nonnull String name,
			@Nonnull String pluralName, @Nonnull String sign, int fractionalDigits) {
