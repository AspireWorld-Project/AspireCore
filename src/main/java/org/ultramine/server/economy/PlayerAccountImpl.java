...
public class PlayerAccountImpl implements PlayerAccount {
	...
	@InjectService
	private static DefaultHoldingsProvider defaultHoldings;
	@InjectService
	...
	@Nonnull
	@Override
	public Currency getSupportedCurrency(@Nonnull String id)
			throws CurrencyNotFoundException, CurrencyNotSupportedException {
