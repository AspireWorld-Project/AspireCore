...
public class SetBlockEvent extends Event {
	...
	public SetBlockEvent(WorldServer world, int x, int y, int z, Block newBlock, int newMeta,
			WorldUpdateObject initiator, boolean isNeighborChange, boolean isNeighborChangeItself) {
		this.world = world;
		this.x = x;
		this.y = y;
		this.z = z;
