...
public abstract class ImportChunkLoader extends AnvilChunkLoader {
	...
	protected DataOutputStream getChunkOutputStream(AnvilChunkLoader.PendingChunk pending) {
		return getRegion(pending.chunkCoordinate.chunkXPos, pending.chunkCoordinate.chunkZPos).getChunkDataOutputStream(
				pending.chunkCoordinate.chunkXPos & 31, pending.chunkCoordinate.chunkZPos & 31);
	}
