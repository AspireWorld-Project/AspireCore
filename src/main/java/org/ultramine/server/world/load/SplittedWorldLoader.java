...
public class SplittedWorldLoader extends AbstractWorldLoader {
	...
	public WorldServer doLoad() {
		...
		WorldServerMulti world = new WorldServerMulti(server, save, desc.getName(), desc.getDimension(),
				makeSettings(save.loadWorldInfo(), desc.getConfig()), mainWorld, server.theProfiler);
